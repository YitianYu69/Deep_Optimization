...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207, primals_208, primals_209, primals_210, primals_211, primals_212, primals_213, primals_214, primals_215, primals_216, primals_217, primals_218, primals_219, primals_220, primals_221, primals_222, primals_223, primals_224, primals_225, primals_226, primals_227, primals_228, primals_229, primals_230, primals_231, primals_232, primals_233, primals_234, primals_235, primals_236, primals_237, primals_238, primals_239, primals_240, primals_241, primals_242, primals_243, primals_244, primals_245, primals_246, primals_247, primals_248, primals_249, primals_250, primals_251, primals_252, primals_253, primals_254, primals_255, primals_256, primals_257, primals_258, primals_259, primals_260, primals_261, primals_262, primals_263, primals_264, primals_265, primals_266, primals_267, primals_268, primals_269, primals_270, primals_271, primals_272, primals_273, primals_274, primals_275, primals_276, primals_277, primals_278, primals_279, primals_280, primals_281, primals_282, primals_283, primals_284, primals_285, primals_286, primals_287, primals_288, primals_289, primals_290, primals_291, primals_292, primals_293, primals_294, primals_295, primals_296, primals_297, primals_298, primals_299, primals_300, primals_301, primals_302, primals_303, primals_304, primals_305, primals_306, primals_307, primals_308, primals_309, primals_310, primals_311, primals_312, primals_313, primals_314, primals_315, primals_316, primals_317, primals_318, primals_319, primals_320, primals_321):
        ...
        convolution = torch.ops.aten.convolution.default(convert_element_type_1, convert_element_type, None, [2, 2], [3, 3], [1, 1], False, [0, 0], 1)
        add = torch.ops.aten.add.Tensor(primals_3, 1)
        convert_element_type_2 = torch.ops.prims.convert_element_type.default(convolution, torch.float32)
        ...
        mul_3 = torch.ops.aten.mul.Tensor(squeeze_2, 1.0000001557019536);  squeeze_2 = None
        ...
        relu = torch.ops.aten.relu.default(convert_element_type_3);  convert_element_type_3 = None
        ...
        convert_element_type_4 = torch.ops.prims.convert_element_type.default(primals_8, torch.bfloat16);  primals_8 = None
        convolution_1 = torch.ops.aten.convolution.default(getitem_2, convert_element_type_4, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_5 = torch.ops.aten.add.Tensor(primals_9, 1)
        convert_element_type_5 = torch.ops.prims.convert_element_type.default(convolution_1, torch.float32)
        ...
        mul_10 = torch.ops.aten.mul.Tensor(squeeze_5, 1.0000006228081046);  squeeze_5 = None
        ...
        convert_element_type_6 = torch.ops.prims.convert_element_type.default(add_9, torch.bfloat16);  add_9 = None
        relu_1 = torch.ops.aten.relu.default(convert_element_type_6);  convert_element_type_6 = None
        convert_element_type_7 = torch.ops.prims.convert_element_type.default(primals_14, torch.bfloat16);  primals_14 = None
        convolution_2 = torch.ops.aten.convolution.default(relu_1, convert_element_type_7, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_10 = torch.ops.aten.add.Tensor(primals_15, 1)
        convert_element_type_8 = torch.ops.prims.convert_element_type.default(convolution_2, torch.float32)
        ...
        mul_17 = torch.ops.aten.mul.Tensor(squeeze_8, 1.0000006228081046);  squeeze_8 = None
        ...
        convert_element_type_9 = torch.ops.prims.convert_element_type.default(add_14, torch.bfloat16);  add_14 = None
        relu_2 = torch.ops.aten.relu.default(convert_element_type_9);  convert_element_type_9 = None
        convert_element_type_10 = torch.ops.prims.convert_element_type.default(primals_20, torch.bfloat16);  primals_20 = None
        convolution_3 = torch.ops.aten.convolution.default(relu_2, convert_element_type_10, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_15 = torch.ops.aten.add.Tensor(primals_21, 1)
        convert_element_type_11 = torch.ops.prims.convert_element_type.default(convolution_3, torch.float32)
        ...
        mul_24 = torch.ops.aten.mul.Tensor(squeeze_11, 1.0000006228081046);  squeeze_11 = None
        ...
        convert_element_type_12 = torch.ops.prims.convert_element_type.default(add_19, torch.bfloat16);  add_19 = None
        convert_element_type_13 = torch.ops.prims.convert_element_type.default(primals_26, torch.bfloat16);  primals_26 = None
        convolution_4 = torch.ops.aten.convolution.default(getitem_2, convert_element_type_13, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_20 = torch.ops.aten.add.Tensor(primals_27, 1)
        convert_element_type_14 = torch.ops.prims.convert_element_type.default(convolution_4, torch.float32)
        ...
        mul_31 = torch.ops.aten.mul.Tensor(squeeze_14, 1.0000006228081046);  squeeze_14 = None
        ...
        convert_element_type_15 = torch.ops.prims.convert_element_type.default(add_24, torch.bfloat16);  add_24 = None
        add_25 = torch.ops.aten.add.Tensor(convert_element_type_12, convert_element_type_15);  convert_element_type_12 = convert_element_type_15 = None
        relu_3 = torch.ops.aten.relu.default(add_25);  add_25 = None
        convert_element_type_16 = torch.ops.prims.convert_element_type.default(primals_32, torch.bfloat16);  primals_32 = None
        convolution_5 = torch.ops.aten.convolution.default(relu_3, convert_element_type_16, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_26 = torch.ops.aten.add.Tensor(primals_33, 1)
        convert_element_type_17 = torch.ops.prims.convert_element_type.default(convolution_5, torch.float32)
        ...
        mul_38 = torch.ops.aten.mul.Tensor(squeeze_17, 1.0000006228081046);  squeeze_17 = None
        ...
        convert_element_type_18 = torch.ops.prims.convert_element_type.default(add_30, torch.bfloat16);  add_30 = None
        relu_4 = torch.ops.aten.relu.default(convert_element_type_18);  convert_element_type_18 = None
        convert_element_type_19 = torch.ops.prims.convert_element_type.default(primals_38, torch.bfloat16);  primals_38 = None
        convolution_6 = torch.ops.aten.convolution.default(relu_4, convert_element_type_19, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_31 = torch.ops.aten.add.Tensor(primals_39, 1)
        convert_element_type_20 = torch.ops.prims.convert_element_type.default(convolution_6, torch.float32)
        ...
        mul_45 = torch.ops.aten.mul.Tensor(squeeze_20, 1.0000006228081046);  squeeze_20 = None
        ...
        convert_element_type_21 = torch.ops.prims.convert_element_type.default(add_35, torch.bfloat16);  add_35 = None
        relu_5 = torch.ops.aten.relu.default(convert_element_type_21);  convert_element_type_21 = None
        convert_element_type_22 = torch.ops.prims.convert_element_type.default(primals_44, torch.bfloat16);  primals_44 = None
        convolution_7 = torch.ops.aten.convolution.default(relu_5, convert_element_type_22, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_36 = torch.ops.aten.add.Tensor(primals_45, 1)
        convert_element_type_23 = torch.ops.prims.convert_element_type.default(convolution_7, torch.float32)
        ...
        mul_52 = torch.ops.aten.mul.Tensor(squeeze_23, 1.0000006228081046);  squeeze_23 = None
        ...
        convert_element_type_24 = torch.ops.prims.convert_element_type.default(add_40, torch.bfloat16);  add_40 = None
        add_41 = torch.ops.aten.add.Tensor(convert_element_type_24, relu_3);  convert_element_type_24 = None
        relu_6 = torch.ops.aten.relu.default(add_41);  add_41 = None
        convert_element_type_25 = torch.ops.prims.convert_element_type.default(primals_50, torch.bfloat16);  primals_50 = None
        convolution_8 = torch.ops.aten.convolution.default(relu_6, convert_element_type_25, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_42 = torch.ops.aten.add.Tensor(primals_51, 1)
        convert_element_type_26 = torch.ops.prims.convert_element_type.default(convolution_8, torch.float32)
        ...
        mul_59 = torch.ops.aten.mul.Tensor(squeeze_26, 1.0000006228081046);  squeeze_26 = None
        ...
        convert_element_type_27 = torch.ops.prims.convert_element_type.default(add_46, torch.bfloat16);  add_46 = None
        relu_7 = torch.ops.aten.relu.default(convert_element_type_27);  convert_element_type_27 = None
        convert_element_type_28 = torch.ops.prims.convert_element_type.default(primals_56, torch.bfloat16);  primals_56 = None
        convolution_9 = torch.ops.aten.convolution.default(relu_7, convert_element_type_28, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_47 = torch.ops.aten.add.Tensor(primals_57, 1)
        convert_element_type_29 = torch.ops.prims.convert_element_type.default(convolution_9, torch.float32)
        ...
        mul_66 = torch.ops.aten.mul.Tensor(squeeze_29, 1.0000006228081046);  squeeze_29 = None
        ...
        convert_element_type_30 = torch.ops.prims.convert_element_type.default(add_51, torch.bfloat16);  add_51 = None
        relu_8 = torch.ops.aten.relu.default(convert_element_type_30);  convert_element_type_30 = None
        convert_element_type_31 = torch.ops.prims.convert_element_type.default(primals_62, torch.bfloat16);  primals_62 = None
        convolution_10 = torch.ops.aten.convolution.default(relu_8, convert_element_type_31, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_52 = torch.ops.aten.add.Tensor(primals_63, 1)
        convert_element_type_32 = torch.ops.prims.convert_element_type.default(convolution_10, torch.float32)
        ...
        mul_73 = torch.ops.aten.mul.Tensor(squeeze_32, 1.0000006228081046);  squeeze_32 = None
        ...
        convert_element_type_33 = torch.ops.prims.convert_element_type.default(add_56, torch.bfloat16);  add_56 = None
        add_57 = torch.ops.aten.add.Tensor(convert_element_type_33, relu_6);  convert_element_type_33 = None
        relu_9 = torch.ops.aten.relu.default(add_57);  add_57 = None
        convert_element_type_34 = torch.ops.prims.convert_element_type.default(primals_68, torch.bfloat16);  primals_68 = None
        convolution_11 = torch.ops.aten.convolution.default(relu_9, convert_element_type_34, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_58 = torch.ops.aten.add.Tensor(primals_69, 1)
        convert_element_type_35 = torch.ops.prims.convert_element_type.default(convolution_11, torch.float32)
        ...
        mul_80 = torch.ops.aten.mul.Tensor(squeeze_35, 1.0000006228081046);  squeeze_35 = None
        ...
        convert_element_type_36 = torch.ops.prims.convert_element_type.default(add_62, torch.bfloat16);  add_62 = None
        relu_10 = torch.ops.aten.relu.default(convert_element_type_36);  convert_element_type_36 = None
        convert_element_type_37 = torch.ops.prims.convert_element_type.default(primals_74, torch.bfloat16);  primals_74 = None
        convolution_12 = torch.ops.aten.convolution.default(relu_10, convert_element_type_37, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1)
        add_63 = torch.ops.aten.add.Tensor(primals_75, 1)
        convert_element_type_38 = torch.ops.prims.convert_element_type.default(convolution_12, torch.float32)
        ...
        mul_87 = torch.ops.aten.mul.Tensor(squeeze_38, 1.0000024912370735);  squeeze_38 = None
        ...
        convert_element_type_39 = torch.ops.prims.convert_element_type.default(add_67, torch.bfloat16);  add_67 = None
        relu_11 = torch.ops.aten.relu.default(convert_element_type_39);  convert_element_type_39 = None
        convert_element_type_40 = torch.ops.prims.convert_element_type.default(primals_80, torch.bfloat16);  primals_80 = None
        convolution_13 = torch.ops.aten.convolution.default(relu_11, convert_element_type_40, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_68 = torch.ops.aten.add.Tensor(primals_81, 1)
        convert_element_type_41 = torch.ops.prims.convert_element_type.default(convolution_13, torch.float32)
        ...
        mul_94 = torch.ops.aten.mul.Tensor(squeeze_41, 1.0000024912370735);  squeeze_41 = None
        ...
        convert_element_type_42 = torch.ops.prims.convert_element_type.default(add_72, torch.bfloat16);  add_72 = None
        convert_element_type_43 = torch.ops.prims.convert_element_type.default(primals_86, torch.bfloat16);  primals_86 = None
        convolution_14 = torch.ops.aten.convolution.default(relu_9, convert_element_type_43, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1)
        add_73 = torch.ops.aten.add.Tensor(primals_87, 1)
        convert_element_type_44 = torch.ops.prims.convert_element_type.default(convolution_14, torch.float32)
        ...
        mul_101 = torch.ops.aten.mul.Tensor(squeeze_44, 1.0000024912370735);  squeeze_44 = None
        ...
        convert_element_type_45 = torch.ops.prims.convert_element_type.default(add_77, torch.bfloat16);  add_77 = None
        add_78 = torch.ops.aten.add.Tensor(convert_element_type_42, convert_element_type_45);  convert_element_type_42 = convert_element_type_45 = None
        relu_12 = torch.ops.aten.relu.default(add_78);  add_78 = None
        convert_element_type_46 = torch.ops.prims.convert_element_type.default(primals_92, torch.bfloat16);  primals_92 = None
        convolution_15 = torch.ops.aten.convolution.default(relu_12, convert_element_type_46, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_79 = torch.ops.aten.add.Tensor(primals_93, 1)
        convert_element_type_47 = torch.ops.prims.convert_element_type.default(convolution_15, torch.float32)
        ...
        mul_108 = torch.ops.aten.mul.Tensor(squeeze_47, 1.0000024912370735);  squeeze_47 = None
        ...
        convert_element_type_48 = torch.ops.prims.convert_element_type.default(add_83, torch.bfloat16);  add_83 = None
        relu_13 = torch.ops.aten.relu.default(convert_element_type_48);  convert_element_type_48 = None
        convert_element_type_49 = torch.ops.prims.convert_element_type.default(primals_98, torch.bfloat16);  primals_98 = None
        convolution_16 = torch.ops.aten.convolution.default(relu_13, convert_element_type_49, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_84 = torch.ops.aten.add.Tensor(primals_99, 1)
        convert_element_type_50 = torch.ops.prims.convert_element_type.default(convolution_16, torch.float32)
        ...
        mul_115 = torch.ops.aten.mul.Tensor(squeeze_50, 1.0000024912370735);  squeeze_50 = None
        ...
        convert_element_type_51 = torch.ops.prims.convert_element_type.default(add_88, torch.bfloat16);  add_88 = None
        relu_14 = torch.ops.aten.relu.default(convert_element_type_51);  convert_element_type_51 = None
        convert_element_type_52 = torch.ops.prims.convert_element_type.default(primals_104, torch.bfloat16);  primals_104 = None
        convolution_17 = torch.ops.aten.convolution.default(relu_14, convert_element_type_52, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_89 = torch.ops.aten.add.Tensor(primals_105, 1)
        convert_element_type_53 = torch.ops.prims.convert_element_type.default(convolution_17, torch.float32)
        ...
        mul_122 = torch.ops.aten.mul.Tensor(squeeze_53, 1.0000024912370735);  squeeze_53 = None
        ...
        convert_element_type_54 = torch.ops.prims.convert_element_type.default(add_93, torch.bfloat16);  add_93 = None
        add_94 = torch.ops.aten.add.Tensor(convert_element_type_54, relu_12);  convert_element_type_54 = None
        relu_15 = torch.ops.aten.relu.default(add_94);  add_94 = None
        convert_element_type_55 = torch.ops.prims.convert_element_type.default(primals_110, torch.bfloat16);  primals_110 = None
        convolution_18 = torch.ops.aten.convolution.default(relu_15, convert_element_type_55, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_95 = torch.ops.aten.add.Tensor(primals_111, 1)
        convert_element_type_56 = torch.ops.prims.convert_element_type.default(convolution_18, torch.float32)
        ...
        mul_129 = torch.ops.aten.mul.Tensor(squeeze_56, 1.0000024912370735);  squeeze_56 = None
        ...
        convert_element_type_57 = torch.ops.prims.convert_element_type.default(add_99, torch.bfloat16);  add_99 = None
        relu_16 = torch.ops.aten.relu.default(convert_element_type_57);  convert_element_type_57 = None
        convert_element_type_58 = torch.ops.prims.convert_element_type.default(primals_116, torch.bfloat16);  primals_116 = None
        convolution_19 = torch.ops.aten.convolution.default(relu_16, convert_element_type_58, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_100 = torch.ops.aten.add.Tensor(primals_117, 1)
        convert_element_type_59 = torch.ops.prims.convert_element_type.default(convolution_19, torch.float32)
        ...
        mul_136 = torch.ops.aten.mul.Tensor(squeeze_59, 1.0000024912370735);  squeeze_59 = None
        ...
        convert_element_type_60 = torch.ops.prims.convert_element_type.default(add_104, torch.bfloat16);  add_104 = None
        relu_17 = torch.ops.aten.relu.default(convert_element_type_60);  convert_element_type_60 = None
        convert_element_type_61 = torch.ops.prims.convert_element_type.default(primals_122, torch.bfloat16);  primals_122 = None
        convolution_20 = torch.ops.aten.convolution.default(relu_17, convert_element_type_61, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_105 = torch.ops.aten.add.Tensor(primals_123, 1)
        convert_element_type_62 = torch.ops.prims.convert_element_type.default(convolution_20, torch.float32)
        ...
        mul_142 = torch.ops.aten.mul.Tensor(primals_124, 0.9)
        ...
        mul_143 = torch.ops.aten.mul.Tensor(squeeze_62, 1.0000024912370735);  squeeze_62 = None
        mul_144 = torch.ops.aten.mul.Tensor(mul_143, 0.1);  mul_143 = None
        mul_145 = torch.ops.aten.mul.Tensor(primals_125, 0.9)
        add_108 = torch.ops.aten.add.Tensor(mul_144, mul_145);  mul_144 = mul_145 = None
        unsqueeze_80 = torch.ops.aten.unsqueeze.default(primals_126, -1)
        ...
        unsqueeze_82 = torch.ops.aten.unsqueeze.default(primals_127, -1);  primals_127 = None
        ...
        convert_element_type_63 = torch.ops.prims.convert_element_type.default(add_109, torch.bfloat16);  add_109 = None
        add_110 = torch.ops.aten.add.Tensor(convert_element_type_63, relu_15);  convert_element_type_63 = None
        relu_18 = torch.ops.aten.relu.default(add_110);  add_110 = None
        convert_element_type_64 = torch.ops.prims.convert_element_type.default(primals_128, torch.bfloat16);  primals_128 = None
        convolution_21 = torch.ops.aten.convolution.default(relu_18, convert_element_type_64, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_111 = torch.ops.aten.add.Tensor(primals_129, 1)
        convert_element_type_65 = torch.ops.prims.convert_element_type.default(convolution_21, torch.float32)
        ...
        mul_149 = torch.ops.aten.mul.Tensor(primals_130, 0.9)
        ...
        mul_150 = torch.ops.aten.mul.Tensor(squeeze_65, 1.0000024912370735);  squeeze_65 = None
        mul_151 = torch.ops.aten.mul.Tensor(mul_150, 0.1);  mul_150 = None
        mul_152 = torch.ops.aten.mul.Tensor(primals_131, 0.9)
        add_114 = torch.ops.aten.add.Tensor(mul_151, mul_152);  mul_151 = mul_152 = None
        unsqueeze_84 = torch.ops.aten.unsqueeze.default(primals_132, -1)
        ...
        unsqueeze_86 = torch.ops.aten.unsqueeze.default(primals_133, -1);  primals_133 = None
        ...
        convert_element_type_66 = torch.ops.prims.convert_element_type.default(add_115, torch.bfloat16);  add_115 = None
        relu_19 = torch.ops.aten.relu.default(convert_element_type_66);  convert_element_type_66 = None
        convert_element_type_67 = torch.ops.prims.convert_element_type.default(primals_134, torch.bfloat16);  primals_134 = None
        convolution_22 = torch.ops.aten.convolution.default(relu_19, convert_element_type_67, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_116 = torch.ops.aten.add.Tensor(primals_135, 1)
        convert_element_type_68 = torch.ops.prims.convert_element_type.default(convolution_22, torch.float32)
        ...
        mul_156 = torch.ops.aten.mul.Tensor(primals_136, 0.9)
        ...
        mul_157 = torch.ops.aten.mul.Tensor(squeeze_68, 1.0000024912370735);  squeeze_68 = None
        mul_158 = torch.ops.aten.mul.Tensor(mul_157, 0.1);  mul_157 = None
        mul_159 = torch.ops.aten.mul.Tensor(primals_137, 0.9)
        add_119 = torch.ops.aten.add.Tensor(mul_158, mul_159);  mul_158 = mul_159 = None
        unsqueeze_88 = torch.ops.aten.unsqueeze.default(primals_138, -1)
        ...
        unsqueeze_90 = torch.ops.aten.unsqueeze.default(primals_139, -1);  primals_139 = None
        ...
        convert_element_type_69 = torch.ops.prims.convert_element_type.default(add_120, torch.bfloat16);  add_120 = None
        relu_20 = torch.ops.aten.relu.default(convert_element_type_69);  convert_element_type_69 = None
        convert_element_type_70 = torch.ops.prims.convert_element_type.default(primals_140, torch.bfloat16);  primals_140 = None
        convolution_23 = torch.ops.aten.convolution.default(relu_20, convert_element_type_70, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_121 = torch.ops.aten.add.Tensor(primals_141, 1)
        convert_element_type_71 = torch.ops.prims.convert_element_type.default(convolution_23, torch.float32)
        ...
        mul_163 = torch.ops.aten.mul.Tensor(primals_142, 0.9)
        ...
        mul_164 = torch.ops.aten.mul.Tensor(squeeze_71, 1.0000024912370735);  squeeze_71 = None
        mul_165 = torch.ops.aten.mul.Tensor(mul_164, 0.1);  mul_164 = None
        mul_166 = torch.ops.aten.mul.Tensor(primals_143, 0.9)
        add_124 = torch.ops.aten.add.Tensor(mul_165, mul_166);  mul_165 = mul_166 = None
        unsqueeze_92 = torch.ops.aten.unsqueeze.default(primals_144, -1)
        ...
        unsqueeze_94 = torch.ops.aten.unsqueeze.default(primals_145, -1);  primals_145 = None
        ...
        convert_element_type_72 = torch.ops.prims.convert_element_type.default(add_125, torch.bfloat16);  add_125 = None
        add_126 = torch.ops.aten.add.Tensor(convert_element_type_72, relu_18);  convert_element_type_72 = None
        relu_21 = torch.ops.aten.relu.default(add_126);  add_126 = None
        convert_element_type_73 = torch.ops.prims.convert_element_type.default(primals_146, torch.bfloat16);  primals_146 = None
        convolution_24 = torch.ops.aten.convolution.default(relu_21, convert_element_type_73, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_127 = torch.ops.aten.add.Tensor(primals_147, 1)
        convert_element_type_74 = torch.ops.prims.convert_element_type.default(convolution_24, torch.float32)
        ...
        mul_170 = torch.ops.aten.mul.Tensor(primals_148, 0.9)
        ...
        mul_171 = torch.ops.aten.mul.Tensor(squeeze_74, 1.0000024912370735);  squeeze_74 = None
        mul_172 = torch.ops.aten.mul.Tensor(mul_171, 0.1);  mul_171 = None
        mul_173 = torch.ops.aten.mul.Tensor(primals_149, 0.9)
        add_130 = torch.ops.aten.add.Tensor(mul_172, mul_173);  mul_172 = mul_173 = None
        unsqueeze_96 = torch.ops.aten.unsqueeze.default(primals_150, -1)
        ...
        unsqueeze_98 = torch.ops.aten.unsqueeze.default(primals_151, -1);  primals_151 = None
        ...
        convert_element_type_75 = torch.ops.prims.convert_element_type.default(add_131, torch.bfloat16);  add_131 = None
        relu_22 = torch.ops.aten.relu.default(convert_element_type_75);  convert_element_type_75 = None
        convert_element_type_76 = torch.ops.prims.convert_element_type.default(primals_152, torch.bfloat16);  primals_152 = None
        convolution_25 = torch.ops.aten.convolution.default(relu_22, convert_element_type_76, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1)
        add_132 = torch.ops.aten.add.Tensor(primals_153, 1)
        convert_element_type_77 = torch.ops.prims.convert_element_type.default(convolution_25, torch.float32)
        ...
        mul_177 = torch.ops.aten.mul.Tensor(primals_154, 0.9)
        ...
        mul_178 = torch.ops.aten.mul.Tensor(squeeze_77, 1.00000996502277);  squeeze_77 = None
        mul_179 = torch.ops.aten.mul.Tensor(mul_178, 0.1);  mul_178 = None
        mul_180 = torch.ops.aten.mul.Tensor(primals_155, 0.9)
        add_135 = torch.ops.aten.add.Tensor(mul_179, mul_180);  mul_179 = mul_180 = None
        unsqueeze_100 = torch.ops.aten.unsqueeze.default(primals_156, -1)
        ...
        unsqueeze_102 = torch.ops.aten.unsqueeze.default(primals_157, -1);  primals_157 = None
        ...
        convert_element_type_78 = torch.ops.prims.convert_element_type.default(add_136, torch.bfloat16);  add_136 = None
        relu_23 = torch.ops.aten.relu.default(convert_element_type_78);  convert_element_type_78 = None
        convert_element_type_79 = torch.ops.prims.convert_element_type.default(primals_158, torch.bfloat16);  primals_158 = None
        convolution_26 = torch.ops.aten.convolution.default(relu_23, convert_element_type_79, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_137 = torch.ops.aten.add.Tensor(primals_159, 1)
        convert_element_type_80 = torch.ops.prims.convert_element_type.default(convolution_26, torch.float32)
        ...
        mul_184 = torch.ops.aten.mul.Tensor(primals_160, 0.9)
        ...
        mul_185 = torch.ops.aten.mul.Tensor(squeeze_80, 1.00000996502277);  squeeze_80 = None
        mul_186 = torch.ops.aten.mul.Tensor(mul_185, 0.1);  mul_185 = None
        mul_187 = torch.ops.aten.mul.Tensor(primals_161, 0.9)
        add_140 = torch.ops.aten.add.Tensor(mul_186, mul_187);  mul_186 = mul_187 = None
        unsqueeze_104 = torch.ops.aten.unsqueeze.default(primals_162, -1)
        ...
        unsqueeze_106 = torch.ops.aten.unsqueeze.default(primals_163, -1);  primals_163 = None
        ...
        convert_element_type_81 = torch.ops.prims.convert_element_type.default(add_141, torch.bfloat16);  add_141 = None
        convert_element_type_82 = torch.ops.prims.convert_element_type.default(primals_164, torch.bfloat16);  primals_164 = None
        convolution_27 = torch.ops.aten.convolution.default(relu_21, convert_element_type_82, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1)
        add_142 = torch.ops.aten.add.Tensor(primals_165, 1)
        convert_element_type_83 = torch.ops.prims.convert_element_type.default(convolution_27, torch.float32)
        ...
        mul_191 = torch.ops.aten.mul.Tensor(primals_166, 0.9)
        ...
        mul_192 = torch.ops.aten.mul.Tensor(squeeze_83, 1.00000996502277);  squeeze_83 = None
        mul_193 = torch.ops.aten.mul.Tensor(mul_192, 0.1);  mul_192 = None
        mul_194 = torch.ops.aten.mul.Tensor(primals_167, 0.9)
        add_145 = torch.ops.aten.add.Tensor(mul_193, mul_194);  mul_193 = mul_194 = None
        unsqueeze_108 = torch.ops.aten.unsqueeze.default(primals_168, -1)
        ...
        unsqueeze_110 = torch.ops.aten.unsqueeze.default(primals_169, -1);  primals_169 = None
        ...
        convert_element_type_84 = torch.ops.prims.convert_element_type.default(add_146, torch.bfloat16);  add_146 = None
        add_147 = torch.ops.aten.add.Tensor(convert_element_type_81, convert_element_type_84);  convert_element_type_81 = convert_element_type_84 = None
        relu_24 = torch.ops.aten.relu.default(add_147);  add_147 = None
        convert_element_type_85 = torch.ops.prims.convert_element_type.default(primals_170, torch.bfloat16);  primals_170 = None
        convolution_28 = torch.ops.aten.convolution.default(relu_24, convert_element_type_85, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_148 = torch.ops.aten.add.Tensor(primals_171, 1)
        convert_element_type_86 = torch.ops.prims.convert_element_type.default(convolution_28, torch.float32)
        ...
        mul_198 = torch.ops.aten.mul.Tensor(primals_172, 0.9)
        ...
        mul_199 = torch.ops.aten.mul.Tensor(squeeze_86, 1.00000996502277);  squeeze_86 = None
        mul_200 = torch.ops.aten.mul.Tensor(mul_199, 0.1);  mul_199 = None
        mul_201 = torch.ops.aten.mul.Tensor(primals_173, 0.9)
        add_151 = torch.ops.aten.add.Tensor(mul_200, mul_201);  mul_200 = mul_201 = None
        unsqueeze_112 = torch.ops.aten.unsqueeze.default(primals_174, -1)
        ...
        unsqueeze_114 = torch.ops.aten.unsqueeze.default(primals_175, -1);  primals_175 = None
        ...
        convert_element_type_87 = torch.ops.prims.convert_element_type.default(add_152, torch.bfloat16);  add_152 = None
        relu_25 = torch.ops.aten.relu.default(convert_element_type_87);  convert_element_type_87 = None
        convert_element_type_88 = torch.ops.prims.convert_element_type.default(primals_176, torch.bfloat16);  primals_176 = None
        convolution_29 = torch.ops.aten.convolution.default(relu_25, convert_element_type_88, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_153 = torch.ops.aten.add.Tensor(primals_177, 1)
        convert_element_type_89 = torch.ops.prims.convert_element_type.default(convolution_29, torch.float32)
        ...
        mul_205 = torch.ops.aten.mul.Tensor(primals_178, 0.9)
        ...
        mul_206 = torch.ops.aten.mul.Tensor(squeeze_89, 1.00000996502277);  squeeze_89 = None
        mul_207 = torch.ops.aten.mul.Tensor(mul_206, 0.1);  mul_206 = None
        mul_208 = torch.ops.aten.mul.Tensor(primals_179, 0.9)
        add_156 = torch.ops.aten.add.Tensor(mul_207, mul_208);  mul_207 = mul_208 = None
        unsqueeze_116 = torch.ops.aten.unsqueeze.default(primals_180, -1)
        ...
        unsqueeze_118 = torch.ops.aten.unsqueeze.default(primals_181, -1);  primals_181 = None
        ...
        convert_element_type_90 = torch.ops.prims.convert_element_type.default(add_157, torch.bfloat16);  add_157 = None
        relu_26 = torch.ops.aten.relu.default(convert_element_type_90);  convert_element_type_90 = None
        convert_element_type_91 = torch.ops.prims.convert_element_type.default(primals_182, torch.bfloat16);  primals_182 = None
        convolution_30 = torch.ops.aten.convolution.default(relu_26, convert_element_type_91, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_158 = torch.ops.aten.add.Tensor(primals_183, 1)
        convert_element_type_92 = torch.ops.prims.convert_element_type.default(convolution_30, torch.float32)
        ...
        mul_212 = torch.ops.aten.mul.Tensor(primals_184, 0.9)
        ...
        mul_213 = torch.ops.aten.mul.Tensor(squeeze_92, 1.00000996502277);  squeeze_92 = None
        mul_214 = torch.ops.aten.mul.Tensor(mul_213, 0.1);  mul_213 = None
        mul_215 = torch.ops.aten.mul.Tensor(primals_185, 0.9)
        add_161 = torch.ops.aten.add.Tensor(mul_214, mul_215);  mul_214 = mul_215 = None
        unsqueeze_120 = torch.ops.aten.unsqueeze.default(primals_186, -1)
        ...
        unsqueeze_122 = torch.ops.aten.unsqueeze.default(primals_187, -1);  primals_187 = None
        ...
        convert_element_type_93 = torch.ops.prims.convert_element_type.default(add_162, torch.bfloat16);  add_162 = None
        add_163 = torch.ops.aten.add.Tensor(convert_element_type_93, relu_24);  convert_element_type_93 = None
        relu_27 = torch.ops.aten.relu.default(add_163);  add_163 = None
        convert_element_type_94 = torch.ops.prims.convert_element_type.default(primals_188, torch.bfloat16);  primals_188 = None
        convolution_31 = torch.ops.aten.convolution.default(relu_27, convert_element_type_94, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_164 = torch.ops.aten.add.Tensor(primals_189, 1)
        convert_element_type_95 = torch.ops.prims.convert_element_type.default(convolution_31, torch.float32)
        ...
        mul_219 = torch.ops.aten.mul.Tensor(primals_190, 0.9)
        ...
        mul_220 = torch.ops.aten.mul.Tensor(squeeze_95, 1.00000996502277);  squeeze_95 = None
        mul_221 = torch.ops.aten.mul.Tensor(mul_220, 0.1);  mul_220 = None
        mul_222 = torch.ops.aten.mul.Tensor(primals_191, 0.9)
        add_167 = torch.ops.aten.add.Tensor(mul_221, mul_222);  mul_221 = mul_222 = None
        unsqueeze_124 = torch.ops.aten.unsqueeze.default(primals_192, -1)
        ...
        unsqueeze_126 = torch.ops.aten.unsqueeze.default(primals_193, -1);  primals_193 = None
        ...
        convert_element_type_96 = torch.ops.prims.convert_element_type.default(add_168, torch.bfloat16);  add_168 = None
        relu_28 = torch.ops.aten.relu.default(convert_element_type_96);  convert_element_type_96 = None
        convert_element_type_97 = torch.ops.prims.convert_element_type.default(primals_194, torch.bfloat16);  primals_194 = None
        convolution_32 = torch.ops.aten.convolution.default(relu_28, convert_element_type_97, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_169 = torch.ops.aten.add.Tensor(primals_195, 1)
        convert_element_type_98 = torch.ops.prims.convert_element_type.default(convolution_32, torch.float32)
        ...
        mul_226 = torch.ops.aten.mul.Tensor(primals_196, 0.9)
        ...
        mul_227 = torch.ops.aten.mul.Tensor(squeeze_98, 1.00000996502277);  squeeze_98 = None
        mul_228 = torch.ops.aten.mul.Tensor(mul_227, 0.1);  mul_227 = None
        mul_229 = torch.ops.aten.mul.Tensor(primals_197, 0.9)
        add_172 = torch.ops.aten.add.Tensor(mul_228, mul_229);  mul_228 = mul_229 = None
        unsqueeze_128 = torch.ops.aten.unsqueeze.default(primals_198, -1)
        ...
        unsqueeze_130 = torch.ops.aten.unsqueeze.default(primals_199, -1);  primals_199 = None
        ...
        convert_element_type_99 = torch.ops.prims.convert_element_type.default(add_173, torch.bfloat16);  add_173 = None
        relu_29 = torch.ops.aten.relu.default(convert_element_type_99);  convert_element_type_99 = None
        convert_element_type_100 = torch.ops.prims.convert_element_type.default(primals_200, torch.bfloat16);  primals_200 = None
        convolution_33 = torch.ops.aten.convolution.default(relu_29, convert_element_type_100, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_174 = torch.ops.aten.add.Tensor(primals_201, 1)
        convert_element_type_101 = torch.ops.prims.convert_element_type.default(convolution_33, torch.float32)
        ...
        mul_233 = torch.ops.aten.mul.Tensor(primals_202, 0.9)
        ...
        mul_234 = torch.ops.aten.mul.Tensor(squeeze_101, 1.00000996502277);  squeeze_101 = None
        mul_235 = torch.ops.aten.mul.Tensor(mul_234, 0.1);  mul_234 = None
        mul_236 = torch.ops.aten.mul.Tensor(primals_203, 0.9)
        add_177 = torch.ops.aten.add.Tensor(mul_235, mul_236);  mul_235 = mul_236 = None
        unsqueeze_132 = torch.ops.aten.unsqueeze.default(primals_204, -1)
        ...
        unsqueeze_134 = torch.ops.aten.unsqueeze.default(primals_205, -1);  primals_205 = None
        ...
        convert_element_type_102 = torch.ops.prims.convert_element_type.default(add_178, torch.bfloat16);  add_178 = None
        add_179 = torch.ops.aten.add.Tensor(convert_element_type_102, relu_27);  convert_element_type_102 = None
        relu_30 = torch.ops.aten.relu.default(add_179);  add_179 = None
        convert_element_type_103 = torch.ops.prims.convert_element_type.default(primals_206, torch.bfloat16);  primals_206 = None
        convolution_34 = torch.ops.aten.convolution.default(relu_30, convert_element_type_103, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_180 = torch.ops.aten.add.Tensor(primals_207, 1)
        convert_element_type_104 = torch.ops.prims.convert_element_type.default(convolution_34, torch.float32)
        ...
        mul_240 = torch.ops.aten.mul.Tensor(primals_208, 0.9)
        ...
        mul_241 = torch.ops.aten.mul.Tensor(squeeze_104, 1.00000996502277);  squeeze_104 = None
        mul_242 = torch.ops.aten.mul.Tensor(mul_241, 0.1);  mul_241 = None
        mul_243 = torch.ops.aten.mul.Tensor(primals_209, 0.9)
        add_183 = torch.ops.aten.add.Tensor(mul_242, mul_243);  mul_242 = mul_243 = None
        unsqueeze_136 = torch.ops.aten.unsqueeze.default(primals_210, -1)
        ...
        unsqueeze_138 = torch.ops.aten.unsqueeze.default(primals_211, -1);  primals_211 = None
        ...
        convert_element_type_105 = torch.ops.prims.convert_element_type.default(add_184, torch.bfloat16);  add_184 = None
        relu_31 = torch.ops.aten.relu.default(convert_element_type_105);  convert_element_type_105 = None
        convert_element_type_106 = torch.ops.prims.convert_element_type.default(primals_212, torch.bfloat16);  primals_212 = None
        convolution_35 = torch.ops.aten.convolution.default(relu_31, convert_element_type_106, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_185 = torch.ops.aten.add.Tensor(primals_213, 1)
        convert_element_type_107 = torch.ops.prims.convert_element_type.default(convolution_35, torch.float32)
        ...
        mul_247 = torch.ops.aten.mul.Tensor(primals_214, 0.9)
        ...
        mul_248 = torch.ops.aten.mul.Tensor(squeeze_107, 1.00000996502277);  squeeze_107 = None
        mul_249 = torch.ops.aten.mul.Tensor(mul_248, 0.1);  mul_248 = None
        mul_250 = torch.ops.aten.mul.Tensor(primals_215, 0.9)
        add_188 = torch.ops.aten.add.Tensor(mul_249, mul_250);  mul_249 = mul_250 = None
        unsqueeze_140 = torch.ops.aten.unsqueeze.default(primals_216, -1)
        ...
        unsqueeze_142 = torch.ops.aten.unsqueeze.default(primals_217, -1);  primals_217 = None
        ...
        convert_element_type_108 = torch.ops.prims.convert_element_type.default(add_189, torch.bfloat16);  add_189 = None
        relu_32 = torch.ops.aten.relu.default(convert_element_type_108);  convert_element_type_108 = None
        convert_element_type_109 = torch.ops.prims.convert_element_type.default(primals_218, torch.bfloat16);  primals_218 = None
        convolution_36 = torch.ops.aten.convolution.default(relu_32, convert_element_type_109, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_190 = torch.ops.aten.add.Tensor(primals_219, 1)
        convert_element_type_110 = torch.ops.prims.convert_element_type.default(convolution_36, torch.float32)
        ...
        mul_254 = torch.ops.aten.mul.Tensor(primals_220, 0.9)
        ...
        mul_255 = torch.ops.aten.mul.Tensor(squeeze_110, 1.00000996502277);  squeeze_110 = None
        mul_256 = torch.ops.aten.mul.Tensor(mul_255, 0.1);  mul_255 = None
        mul_257 = torch.ops.aten.mul.Tensor(primals_221, 0.9)
        add_193 = torch.ops.aten.add.Tensor(mul_256, mul_257);  mul_256 = mul_257 = None
        unsqueeze_144 = torch.ops.aten.unsqueeze.default(primals_222, -1)
        ...
        unsqueeze_146 = torch.ops.aten.unsqueeze.default(primals_223, -1);  primals_223 = None
        ...
        convert_element_type_111 = torch.ops.prims.convert_element_type.default(add_194, torch.bfloat16);  add_194 = None
        add_195 = torch.ops.aten.add.Tensor(convert_element_type_111, relu_30);  convert_element_type_111 = None
        relu_33 = torch.ops.aten.relu.default(add_195);  add_195 = None
        convert_element_type_112 = torch.ops.prims.convert_element_type.default(primals_224, torch.bfloat16);  primals_224 = None
        convolution_37 = torch.ops.aten.convolution.default(relu_33, convert_element_type_112, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_196 = torch.ops.aten.add.Tensor(primals_225, 1)
        convert_element_type_113 = torch.ops.prims.convert_element_type.default(convolution_37, torch.float32)
        ...
        mul_261 = torch.ops.aten.mul.Tensor(primals_226, 0.9)
        ...
        mul_262 = torch.ops.aten.mul.Tensor(squeeze_113, 1.00000996502277);  squeeze_113 = None
        mul_263 = torch.ops.aten.mul.Tensor(mul_262, 0.1);  mul_262 = None
        mul_264 = torch.ops.aten.mul.Tensor(primals_227, 0.9)
        add_199 = torch.ops.aten.add.Tensor(mul_263, mul_264);  mul_263 = mul_264 = None
        unsqueeze_148 = torch.ops.aten.unsqueeze.default(primals_228, -1)
        ...
        unsqueeze_150 = torch.ops.aten.unsqueeze.default(primals_229, -1);  primals_229 = None
        ...
        convert_element_type_114 = torch.ops.prims.convert_element_type.default(add_200, torch.bfloat16);  add_200 = None
        relu_34 = torch.ops.aten.relu.default(convert_element_type_114);  convert_element_type_114 = None
        convert_element_type_115 = torch.ops.prims.convert_element_type.default(primals_230, torch.bfloat16);  primals_230 = None
        convolution_38 = torch.ops.aten.convolution.default(relu_34, convert_element_type_115, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_201 = torch.ops.aten.add.Tensor(primals_231, 1)
        convert_element_type_116 = torch.ops.prims.convert_element_type.default(convolution_38, torch.float32)
        ...
        mul_268 = torch.ops.aten.mul.Tensor(primals_232, 0.9)
        ...
        mul_269 = torch.ops.aten.mul.Tensor(squeeze_116, 1.00000996502277);  squeeze_116 = None
        mul_270 = torch.ops.aten.mul.Tensor(mul_269, 0.1);  mul_269 = None
        mul_271 = torch.ops.aten.mul.Tensor(primals_233, 0.9)
        add_204 = torch.ops.aten.add.Tensor(mul_270, mul_271);  mul_270 = mul_271 = None
        unsqueeze_152 = torch.ops.aten.unsqueeze.default(primals_234, -1)
        ...
        unsqueeze_154 = torch.ops.aten.unsqueeze.default(primals_235, -1);  primals_235 = None
        ...
        convert_element_type_117 = torch.ops.prims.convert_element_type.default(add_205, torch.bfloat16);  add_205 = None
        relu_35 = torch.ops.aten.relu.default(convert_element_type_117);  convert_element_type_117 = None
        convert_element_type_118 = torch.ops.prims.convert_element_type.default(primals_236, torch.bfloat16);  primals_236 = None
        convolution_39 = torch.ops.aten.convolution.default(relu_35, convert_element_type_118, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_206 = torch.ops.aten.add.Tensor(primals_237, 1)
        convert_element_type_119 = torch.ops.prims.convert_element_type.default(convolution_39, torch.float32)
        ...
        mul_275 = torch.ops.aten.mul.Tensor(primals_238, 0.9)
        ...
        mul_276 = torch.ops.aten.mul.Tensor(squeeze_119, 1.00000996502277);  squeeze_119 = None
        mul_277 = torch.ops.aten.mul.Tensor(mul_276, 0.1);  mul_276 = None
        mul_278 = torch.ops.aten.mul.Tensor(primals_239, 0.9)
        add_209 = torch.ops.aten.add.Tensor(mul_277, mul_278);  mul_277 = mul_278 = None
        unsqueeze_156 = torch.ops.aten.unsqueeze.default(primals_240, -1)
        ...
        unsqueeze_158 = torch.ops.aten.unsqueeze.default(primals_241, -1);  primals_241 = None
        ...
        convert_element_type_120 = torch.ops.prims.convert_element_type.default(add_210, torch.bfloat16);  add_210 = None
        add_211 = torch.ops.aten.add.Tensor(convert_element_type_120, relu_33);  convert_element_type_120 = None
        relu_36 = torch.ops.aten.relu.default(add_211);  add_211 = None
        convert_element_type_121 = torch.ops.prims.convert_element_type.default(primals_242, torch.bfloat16);  primals_242 = None
        convolution_40 = torch.ops.aten.convolution.default(relu_36, convert_element_type_121, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_212 = torch.ops.aten.add.Tensor(primals_243, 1)
        convert_element_type_122 = torch.ops.prims.convert_element_type.default(convolution_40, torch.float32)
        ...
        mul_282 = torch.ops.aten.mul.Tensor(primals_244, 0.9)
        ...
        mul_283 = torch.ops.aten.mul.Tensor(squeeze_122, 1.00000996502277);  squeeze_122 = None
        mul_284 = torch.ops.aten.mul.Tensor(mul_283, 0.1);  mul_283 = None
        mul_285 = torch.ops.aten.mul.Tensor(primals_245, 0.9)
        add_215 = torch.ops.aten.add.Tensor(mul_284, mul_285);  mul_284 = mul_285 = None
        unsqueeze_160 = torch.ops.aten.unsqueeze.default(primals_246, -1)
        ...
        unsqueeze_162 = torch.ops.aten.unsqueeze.default(primals_247, -1);  primals_247 = None
        ...
        convert_element_type_123 = torch.ops.prims.convert_element_type.default(add_216, torch.bfloat16);  add_216 = None
        relu_37 = torch.ops.aten.relu.default(convert_element_type_123);  convert_element_type_123 = None
        convert_element_type_124 = torch.ops.prims.convert_element_type.default(primals_248, torch.bfloat16);  primals_248 = None
        convolution_41 = torch.ops.aten.convolution.default(relu_37, convert_element_type_124, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_217 = torch.ops.aten.add.Tensor(primals_249, 1)
        convert_element_type_125 = torch.ops.prims.convert_element_type.default(convolution_41, torch.float32)
        ...
        mul_289 = torch.ops.aten.mul.Tensor(primals_250, 0.9)
        ...
        mul_290 = torch.ops.aten.mul.Tensor(squeeze_125, 1.00000996502277);  squeeze_125 = None
        mul_291 = torch.ops.aten.mul.Tensor(mul_290, 0.1);  mul_290 = None
        mul_292 = torch.ops.aten.mul.Tensor(primals_251, 0.9)
        add_220 = torch.ops.aten.add.Tensor(mul_291, mul_292);  mul_291 = mul_292 = None
        unsqueeze_164 = torch.ops.aten.unsqueeze.default(primals_252, -1)
        ...
        unsqueeze_166 = torch.ops.aten.unsqueeze.default(primals_253, -1);  primals_253 = None
        ...
        convert_element_type_126 = torch.ops.prims.convert_element_type.default(add_221, torch.bfloat16);  add_221 = None
        relu_38 = torch.ops.aten.relu.default(convert_element_type_126);  convert_element_type_126 = None
        convert_element_type_127 = torch.ops.prims.convert_element_type.default(primals_254, torch.bfloat16);  primals_254 = None
        convolution_42 = torch.ops.aten.convolution.default(relu_38, convert_element_type_127, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_222 = torch.ops.aten.add.Tensor(primals_255, 1)
        convert_element_type_128 = torch.ops.prims.convert_element_type.default(convolution_42, torch.float32)
        ...
        mul_296 = torch.ops.aten.mul.Tensor(primals_256, 0.9)
        ...
        mul_297 = torch.ops.aten.mul.Tensor(squeeze_128, 1.00000996502277);  squeeze_128 = None
        mul_298 = torch.ops.aten.mul.Tensor(mul_297, 0.1);  mul_297 = None
        mul_299 = torch.ops.aten.mul.Tensor(primals_257, 0.9)
        add_225 = torch.ops.aten.add.Tensor(mul_298, mul_299);  mul_298 = mul_299 = None
        unsqueeze_168 = torch.ops.aten.unsqueeze.default(primals_258, -1)
        ...
        unsqueeze_170 = torch.ops.aten.unsqueeze.default(primals_259, -1);  primals_259 = None
        ...
        convert_element_type_129 = torch.ops.prims.convert_element_type.default(add_226, torch.bfloat16);  add_226 = None
        add_227 = torch.ops.aten.add.Tensor(convert_element_type_129, relu_36);  convert_element_type_129 = None
        relu_39 = torch.ops.aten.relu.default(add_227);  add_227 = None
        convert_element_type_130 = torch.ops.prims.convert_element_type.default(primals_260, torch.bfloat16);  primals_260 = None
        convolution_43 = torch.ops.aten.convolution.default(relu_39, convert_element_type_130, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_228 = torch.ops.aten.add.Tensor(primals_261, 1)
        convert_element_type_131 = torch.ops.prims.convert_element_type.default(convolution_43, torch.float32)
        ...
        mul_303 = torch.ops.aten.mul.Tensor(primals_262, 0.9)
        ...
        mul_304 = torch.ops.aten.mul.Tensor(squeeze_131, 1.00000996502277);  squeeze_131 = None
        mul_305 = torch.ops.aten.mul.Tensor(mul_304, 0.1);  mul_304 = None
        mul_306 = torch.ops.aten.mul.Tensor(primals_263, 0.9)
        add_231 = torch.ops.aten.add.Tensor(mul_305, mul_306);  mul_305 = mul_306 = None
        unsqueeze_172 = torch.ops.aten.unsqueeze.default(primals_264, -1)
        ...
        unsqueeze_174 = torch.ops.aten.unsqueeze.default(primals_265, -1);  primals_265 = None
        ...
        convert_element_type_132 = torch.ops.prims.convert_element_type.default(add_232, torch.bfloat16);  add_232 = None
        relu_40 = torch.ops.aten.relu.default(convert_element_type_132);  convert_element_type_132 = None
        convert_element_type_133 = torch.ops.prims.convert_element_type.default(primals_266, torch.bfloat16);  primals_266 = None
        convolution_44 = torch.ops.aten.convolution.default(relu_40, convert_element_type_133, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1)
        add_233 = torch.ops.aten.add.Tensor(primals_267, 1)
        convert_element_type_134 = torch.ops.prims.convert_element_type.default(convolution_44, torch.float32)
        ...
        mul_310 = torch.ops.aten.mul.Tensor(primals_268, 0.9)
        ...
        mul_311 = torch.ops.aten.mul.Tensor(squeeze_134, 1.0000398612827361);  squeeze_134 = None
        mul_312 = torch.ops.aten.mul.Tensor(mul_311, 0.1);  mul_311 = None
        mul_313 = torch.ops.aten.mul.Tensor(primals_269, 0.9)
        add_236 = torch.ops.aten.add.Tensor(mul_312, mul_313);  mul_312 = mul_313 = None
        unsqueeze_176 = torch.ops.aten.unsqueeze.default(primals_270, -1)
        ...
        unsqueeze_178 = torch.ops.aten.unsqueeze.default(primals_271, -1);  primals_271 = None
        ...
        convert_element_type_135 = torch.ops.prims.convert_element_type.default(add_237, torch.bfloat16);  add_237 = None
        relu_41 = torch.ops.aten.relu.default(convert_element_type_135);  convert_element_type_135 = None
        convert_element_type_136 = torch.ops.prims.convert_element_type.default(primals_272, torch.bfloat16);  primals_272 = None
        convolution_45 = torch.ops.aten.convolution.default(relu_41, convert_element_type_136, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_238 = torch.ops.aten.add.Tensor(primals_273, 1)
        convert_element_type_137 = torch.ops.prims.convert_element_type.default(convolution_45, torch.float32)
        ...
        mul_317 = torch.ops.aten.mul.Tensor(primals_274, 0.9)
        ...
        mul_318 = torch.ops.aten.mul.Tensor(squeeze_137, 1.0000398612827361);  squeeze_137 = None
        mul_319 = torch.ops.aten.mul.Tensor(mul_318, 0.1);  mul_318 = None
        mul_320 = torch.ops.aten.mul.Tensor(primals_275, 0.9)
        add_241 = torch.ops.aten.add.Tensor(mul_319, mul_320);  mul_319 = mul_320 = None
        unsqueeze_180 = torch.ops.aten.unsqueeze.default(primals_276, -1)
        ...
        unsqueeze_182 = torch.ops.aten.unsqueeze.default(primals_277, -1);  primals_277 = None
        ...
        convert_element_type_138 = torch.ops.prims.convert_element_type.default(add_242, torch.bfloat16);  add_242 = None
        convert_element_type_139 = torch.ops.prims.convert_element_type.default(primals_278, torch.bfloat16);  primals_278 = None
        convolution_46 = torch.ops.aten.convolution.default(relu_39, convert_element_type_139, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1)
        add_243 = torch.ops.aten.add.Tensor(primals_279, 1)
        convert_element_type_140 = torch.ops.prims.convert_element_type.default(convolution_46, torch.float32)
        ...
        mul_324 = torch.ops.aten.mul.Tensor(primals_280, 0.9)
        ...
        mul_325 = torch.ops.aten.mul.Tensor(squeeze_140, 1.0000398612827361);  squeeze_140 = None
        mul_326 = torch.ops.aten.mul.Tensor(mul_325, 0.1);  mul_325 = None
        mul_327 = torch.ops.aten.mul.Tensor(primals_281, 0.9)
        add_246 = torch.ops.aten.add.Tensor(mul_326, mul_327);  mul_326 = mul_327 = None
        unsqueeze_184 = torch.ops.aten.unsqueeze.default(primals_282, -1)
        ...
        unsqueeze_186 = torch.ops.aten.unsqueeze.default(primals_283, -1);  primals_283 = None
        ...
        convert_element_type_141 = torch.ops.prims.convert_element_type.default(add_247, torch.bfloat16);  add_247 = None
        add_248 = torch.ops.aten.add.Tensor(convert_element_type_138, convert_element_type_141);  convert_element_type_138 = convert_element_type_141 = None
        relu_42 = torch.ops.aten.relu.default(add_248);  add_248 = None
        convert_element_type_142 = torch.ops.prims.convert_element_type.default(primals_284, torch.bfloat16);  primals_284 = None
        convolution_47 = torch.ops.aten.convolution.default(relu_42, convert_element_type_142, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_249 = torch.ops.aten.add.Tensor(primals_285, 1)
        convert_element_type_143 = torch.ops.prims.convert_element_type.default(convolution_47, torch.float32)
        ...
        mul_331 = torch.ops.aten.mul.Tensor(primals_286, 0.9)
        ...
        mul_332 = torch.ops.aten.mul.Tensor(squeeze_143, 1.0000398612827361);  squeeze_143 = None
        mul_333 = torch.ops.aten.mul.Tensor(mul_332, 0.1);  mul_332 = None
        mul_334 = torch.ops.aten.mul.Tensor(primals_287, 0.9)
        add_252 = torch.ops.aten.add.Tensor(mul_333, mul_334);  mul_333 = mul_334 = None
        unsqueeze_188 = torch.ops.aten.unsqueeze.default(primals_288, -1)
        ...
        unsqueeze_190 = torch.ops.aten.unsqueeze.default(primals_289, -1);  primals_289 = None
        ...
        convert_element_type_144 = torch.ops.prims.convert_element_type.default(add_253, torch.bfloat16);  add_253 = None
        relu_43 = torch.ops.aten.relu.default(convert_element_type_144);  convert_element_type_144 = None
        convert_element_type_145 = torch.ops.prims.convert_element_type.default(primals_290, torch.bfloat16);  primals_290 = None
        convolution_48 = torch.ops.aten.convolution.default(relu_43, convert_element_type_145, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_254 = torch.ops.aten.add.Tensor(primals_291, 1)
        convert_element_type_146 = torch.ops.prims.convert_element_type.default(convolution_48, torch.float32)
        ...
        mul_338 = torch.ops.aten.mul.Tensor(primals_292, 0.9)
        ...
        mul_339 = torch.ops.aten.mul.Tensor(squeeze_146, 1.0000398612827361);  squeeze_146 = None
        mul_340 = torch.ops.aten.mul.Tensor(mul_339, 0.1);  mul_339 = None
        mul_341 = torch.ops.aten.mul.Tensor(primals_293, 0.9)
        add_257 = torch.ops.aten.add.Tensor(mul_340, mul_341);  mul_340 = mul_341 = None
        unsqueeze_192 = torch.ops.aten.unsqueeze.default(primals_294, -1)
        ...
        unsqueeze_194 = torch.ops.aten.unsqueeze.default(primals_295, -1);  primals_295 = None
        ...
        convert_element_type_147 = torch.ops.prims.convert_element_type.default(add_258, torch.bfloat16);  add_258 = None
        relu_44 = torch.ops.aten.relu.default(convert_element_type_147);  convert_element_type_147 = None
        convert_element_type_148 = torch.ops.prims.convert_element_type.default(primals_296, torch.bfloat16);  primals_296 = None
        convolution_49 = torch.ops.aten.convolution.default(relu_44, convert_element_type_148, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_259 = torch.ops.aten.add.Tensor(primals_297, 1)
        convert_element_type_149 = torch.ops.prims.convert_element_type.default(convolution_49, torch.float32)
        ...
        mul_345 = torch.ops.aten.mul.Tensor(primals_298, 0.9)
        ...
        mul_346 = torch.ops.aten.mul.Tensor(squeeze_149, 1.0000398612827361);  squeeze_149 = None
        mul_347 = torch.ops.aten.mul.Tensor(mul_346, 0.1);  mul_346 = None
        mul_348 = torch.ops.aten.mul.Tensor(primals_299, 0.9)
        add_262 = torch.ops.aten.add.Tensor(mul_347, mul_348);  mul_347 = mul_348 = None
        unsqueeze_196 = torch.ops.aten.unsqueeze.default(primals_300, -1)
        ...
        unsqueeze_198 = torch.ops.aten.unsqueeze.default(primals_301, -1);  primals_301 = None
        ...
        convert_element_type_150 = torch.ops.prims.convert_element_type.default(add_263, torch.bfloat16);  add_263 = None
        add_264 = torch.ops.aten.add.Tensor(convert_element_type_150, relu_42);  convert_element_type_150 = None
        relu_45 = torch.ops.aten.relu.default(add_264);  add_264 = None
        convert_element_type_151 = torch.ops.prims.convert_element_type.default(primals_302, torch.bfloat16);  primals_302 = None
        convolution_50 = torch.ops.aten.convolution.default(relu_45, convert_element_type_151, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_265 = torch.ops.aten.add.Tensor(primals_303, 1)
        convert_element_type_152 = torch.ops.prims.convert_element_type.default(convolution_50, torch.float32)
        ...
        mul_352 = torch.ops.aten.mul.Tensor(primals_304, 0.9)
        ...
        mul_353 = torch.ops.aten.mul.Tensor(squeeze_152, 1.0000398612827361);  squeeze_152 = None
        mul_354 = torch.ops.aten.mul.Tensor(mul_353, 0.1);  mul_353 = None
        mul_355 = torch.ops.aten.mul.Tensor(primals_305, 0.9)
        add_268 = torch.ops.aten.add.Tensor(mul_354, mul_355);  mul_354 = mul_355 = None
        unsqueeze_200 = torch.ops.aten.unsqueeze.default(primals_306, -1)
        ...
        unsqueeze_202 = torch.ops.aten.unsqueeze.default(primals_307, -1);  primals_307 = None
        ...
        convert_element_type_153 = torch.ops.prims.convert_element_type.default(add_269, torch.bfloat16);  add_269 = None
        relu_46 = torch.ops.aten.relu.default(convert_element_type_153);  convert_element_type_153 = None
        convert_element_type_154 = torch.ops.prims.convert_element_type.default(primals_308, torch.bfloat16);  primals_308 = None
        convolution_51 = torch.ops.aten.convolution.default(relu_46, convert_element_type_154, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1)
        add_270 = torch.ops.aten.add.Tensor(primals_309, 1)
        convert_element_type_155 = torch.ops.prims.convert_element_type.default(convolution_51, torch.float32)
        ...
        mul_359 = torch.ops.aten.mul.Tensor(primals_310, 0.9)
        ...
        mul_360 = torch.ops.aten.mul.Tensor(squeeze_155, 1.0000398612827361);  squeeze_155 = None
        mul_361 = torch.ops.aten.mul.Tensor(mul_360, 0.1);  mul_360 = None
        mul_362 = torch.ops.aten.mul.Tensor(primals_311, 0.9)
        add_273 = torch.ops.aten.add.Tensor(mul_361, mul_362);  mul_361 = mul_362 = None
        unsqueeze_204 = torch.ops.aten.unsqueeze.default(primals_312, -1)
        ...
        unsqueeze_206 = torch.ops.aten.unsqueeze.default(primals_313, -1);  primals_313 = None
        ...
        convert_element_type_156 = torch.ops.prims.convert_element_type.default(add_274, torch.bfloat16);  add_274 = None
        relu_47 = torch.ops.aten.relu.default(convert_element_type_156);  convert_element_type_156 = None
        convert_element_type_157 = torch.ops.prims.convert_element_type.default(primals_314, torch.bfloat16);  primals_314 = None
        convolution_52 = torch.ops.aten.convolution.default(relu_47, convert_element_type_157, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_275 = torch.ops.aten.add.Tensor(primals_315, 1)
        convert_element_type_158 = torch.ops.prims.convert_element_type.default(convolution_52, torch.float32)
        ...
        mul_366 = torch.ops.aten.mul.Tensor(primals_316, 0.9)
        ...
        mul_367 = torch.ops.aten.mul.Tensor(squeeze_158, 1.0000398612827361);  squeeze_158 = None
        mul_368 = torch.ops.aten.mul.Tensor(mul_367, 0.1);  mul_367 = None
        mul_369 = torch.ops.aten.mul.Tensor(primals_317, 0.9)
        add_278 = torch.ops.aten.add.Tensor(mul_368, mul_369);  mul_368 = mul_369 = None
        unsqueeze_208 = torch.ops.aten.unsqueeze.default(primals_318, -1)
        ...
        unsqueeze_210 = torch.ops.aten.unsqueeze.default(primals_319, -1);  primals_319 = None
        ...
        convert_element_type_159 = torch.ops.prims.convert_element_type.default(add_279, torch.bfloat16);  add_279 = None
        add_280 = torch.ops.aten.add.Tensor(convert_element_type_159, relu_45);  convert_element_type_159 = None
        relu_48 = torch.ops.aten.relu.default(add_280);  add_280 = None
        mean = torch.ops.aten.mean.dim(relu_48, [-1, -2], True)
        view = torch.ops.aten.view.default(mean, [512, 2048]);  mean = None
        convert_element_type_160 = torch.ops.prims.convert_element_type.default(primals_321, torch.bfloat16);  primals_321 = None
        convert_element_type_161 = torch.ops.prims.convert_element_type.default(primals_320, torch.bfloat16);  primals_320 = None
        permute = torch.ops.aten.permute.default(convert_element_type_161, [1, 0]);  convert_element_type_161 = None
        addmm = torch.ops.aten.addmm.default(convert_element_type_160, view, permute);  convert_element_type_160 = None
        ...
        copy__9 = torch.ops.aten.copy_.default(primals_21, add_15);  primals_21 = add_15 = copy__9 = None
        copy__10 = torch.ops.aten.copy_.default(primals_22, add_17);  primals_22 = add_17 = copy__10 = None
        copy__11 = torch.ops.aten.copy_.default(primals_23, add_18);  primals_23 = add_18 = copy__11 = None
        copy__12 = torch.ops.aten.copy_.default(primals_27, add_20);  primals_27 = add_20 = copy__12 = None
        copy__13 = torch.ops.aten.copy_.default(primals_28, add_22);  primals_28 = add_22 = copy__13 = None
        copy__14 = torch.ops.aten.copy_.default(primals_29, add_23);  primals_29 = add_23 = copy__14 = None
        copy__15 = torch.ops.aten.copy_.default(primals_33, add_26);  primals_33 = add_26 = copy__15 = None
        copy__16 = torch.ops.aten.copy_.default(primals_34, add_28);  primals_34 = add_28 = copy__16 = None
        copy__17 = torch.ops.aten.copy_.default(primals_35, add_29);  primals_35 = add_29 = copy__17 = None
        copy__18 = torch.ops.aten.copy_.default(primals_39, add_31);  primals_39 = add_31 = copy__18 = None
        copy__19 = torch.ops.aten.copy_.default(primals_40, add_33);  primals_40 = add_33 = copy__19 = None
        copy__20 = torch.ops.aten.copy_.default(primals_41, add_34);  primals_41 = add_34 = copy__20 = None
        copy__21 = torch.ops.aten.copy_.default(primals_45, add_36);  primals_45 = add_36 = copy__21 = None
        copy__22 = torch.ops.aten.copy_.default(primals_46, add_38);  primals_46 = add_38 = copy__22 = None
        copy__23 = torch.ops.aten.copy_.default(primals_47, add_39);  primals_47 = add_39 = copy__23 = None
        copy__24 = torch.ops.aten.copy_.default(primals_51, add_42);  primals_51 = add_42 = copy__24 = None
        copy__25 = torch.ops.aten.copy_.default(primals_52, add_44);  primals_52 = add_44 = copy__25 = None
        copy__26 = torch.ops.aten.copy_.default(primals_53, add_45);  primals_53 = add_45 = copy__26 = None
        copy__27 = torch.ops.aten.copy_.default(primals_57, add_47);  primals_57 = add_47 = copy__27 = None
        copy__28 = torch.ops.aten.copy_.default(primals_58, add_49);  primals_58 = add_49 = copy__28 = None
        copy__29 = torch.ops.aten.copy_.default(primals_59, add_50);  primals_59 = add_50 = copy__29 = None
        copy__30 = torch.ops.aten.copy_.default(primals_63, add_52);  primals_63 = add_52 = copy__30 = None
        copy__31 = torch.ops.aten.copy_.default(primals_64, add_54);  primals_64 = add_54 = copy__31 = None
        copy__32 = torch.ops.aten.copy_.default(primals_65, add_55);  primals_65 = add_55 = copy__32 = None
        copy__33 = torch.ops.aten.copy_.default(primals_69, add_58);  primals_69 = add_58 = copy__33 = None
        copy__34 = torch.ops.aten.copy_.default(primals_70, add_60);  primals_70 = add_60 = copy__34 = None
        copy__35 = torch.ops.aten.copy_.default(primals_71, add_61);  primals_71 = add_61 = copy__35 = None
        copy__36 = torch.ops.aten.copy_.default(primals_75, add_63);  primals_75 = add_63 = copy__36 = None
        copy__37 = torch.ops.aten.copy_.default(primals_76, add_65);  primals_76 = add_65 = copy__37 = None
        copy__38 = torch.ops.aten.copy_.default(primals_77, add_66);  primals_77 = add_66 = copy__38 = None
        copy__39 = torch.ops.aten.copy_.default(primals_81, add_68);  primals_81 = add_68 = copy__39 = None
        copy__40 = torch.ops.aten.copy_.default(primals_82, add_70);  primals_82 = add_70 = copy__40 = None
        copy__41 = torch.ops.aten.copy_.default(primals_83, add_71);  primals_83 = add_71 = copy__41 = None
        copy__42 = torch.ops.aten.copy_.default(primals_87, add_73);  primals_87 = add_73 = copy__42 = None
        copy__43 = torch.ops.aten.copy_.default(primals_88, add_75);  primals_88 = add_75 = copy__43 = None
        copy__44 = torch.ops.aten.copy_.default(primals_89, add_76);  primals_89 = add_76 = copy__44 = None
        copy__45 = torch.ops.aten.copy_.default(primals_93, add_79);  primals_93 = add_79 = copy__45 = None
        copy__46 = torch.ops.aten.copy_.default(primals_94, add_81);  primals_94 = add_81 = copy__46 = None
        copy__47 = torch.ops.aten.copy_.default(primals_95, add_82);  primals_95 = add_82 = copy__47 = None
        copy__48 = torch.ops.aten.copy_.default(primals_99, add_84);  primals_99 = add_84 = copy__48 = None
        copy__49 = torch.ops.aten.copy_.default(primals_100, add_86);  primals_100 = add_86 = copy__49 = None
        copy__50 = torch.ops.aten.copy_.default(primals_101, add_87);  primals_101 = add_87 = copy__50 = None
        copy__51 = torch.ops.aten.copy_.default(primals_105, add_89);  primals_105 = add_89 = copy__51 = None
        copy__52 = torch.ops.aten.copy_.default(primals_106, add_91);  primals_106 = add_91 = copy__52 = None
        copy__53 = torch.ops.aten.copy_.default(primals_107, add_92);  primals_107 = add_92 = copy__53 = None
        copy__54 = torch.ops.aten.copy_.default(primals_111, add_95);  primals_111 = add_95 = copy__54 = None
        copy__55 = torch.ops.aten.copy_.default(primals_112, add_97);  primals_112 = add_97 = copy__55 = None
        copy__56 = torch.ops.aten.copy_.default(primals_113, add_98);  primals_113 = add_98 = copy__56 = None
        copy__57 = torch.ops.aten.copy_.default(primals_117, add_100);  primals_117 = add_100 = copy__57 = None
        copy__58 = torch.ops.aten.copy_.default(primals_118, add_102);  primals_118 = add_102 = copy__58 = None
        copy__59 = torch.ops.aten.copy_.default(primals_119, add_103);  primals_119 = add_103 = copy__59 = None
        copy__60 = torch.ops.aten.copy_.default(primals_123, add_105);  primals_123 = add_105 = copy__60 = None
        copy__61 = torch.ops.aten.copy_.default(primals_124, add_107);  primals_124 = add_107 = copy__61 = None
        copy__62 = torch.ops.aten.copy_.default(primals_125, add_108);  primals_125 = add_108 = copy__62 = None
        copy__63 = torch.ops.aten.copy_.default(primals_129, add_111);  primals_129 = add_111 = copy__63 = None
        copy__64 = torch.ops.aten.copy_.default(primals_130, add_113);  primals_130 = add_113 = copy__64 = None
        copy__65 = torch.ops.aten.copy_.default(primals_131, add_114);  primals_131 = add_114 = copy__65 = None
        copy__66 = torch.ops.aten.copy_.default(primals_135, add_116);  primals_135 = add_116 = copy__66 = None
        copy__67 = torch.ops.aten.copy_.default(primals_136, add_118);  primals_136 = add_118 = copy__67 = None
        copy__68 = torch.ops.aten.copy_.default(primals_137, add_119);  primals_137 = add_119 = copy__68 = None
        copy__69 = torch.ops.aten.copy_.default(primals_141, add_121);  primals_141 = add_121 = copy__69 = None
        copy__70 = torch.ops.aten.copy_.default(primals_142, add_123);  primals_142 = add_123 = copy__70 = None
        copy__71 = torch.ops.aten.copy_.default(primals_143, add_124);  primals_143 = add_124 = copy__71 = None
        copy__72 = torch.ops.aten.copy_.default(primals_147, add_127);  primals_147 = add_127 = copy__72 = None
        copy__73 = torch.ops.aten.copy_.default(primals_148, add_129);  primals_148 = add_129 = copy__73 = None
        copy__74 = torch.ops.aten.copy_.default(primals_149, add_130);  primals_149 = add_130 = copy__74 = None
        copy__75 = torch.ops.aten.copy_.default(primals_153, add_132);  primals_153 = add_132 = copy__75 = None
        copy__76 = torch.ops.aten.copy_.default(primals_154, add_134);  primals_154 = add_134 = copy__76 = None
        copy__77 = torch.ops.aten.copy_.default(primals_155, add_135);  primals_155 = add_135 = copy__77 = None
        copy__78 = torch.ops.aten.copy_.default(primals_159, add_137);  primals_159 = add_137 = copy__78 = None
        copy__79 = torch.ops.aten.copy_.default(primals_160, add_139);  primals_160 = add_139 = copy__79 = None
        copy__80 = torch.ops.aten.copy_.default(primals_161, add_140);  primals_161 = add_140 = copy__80 = None
        copy__81 = torch.ops.aten.copy_.default(primals_165, add_142);  primals_165 = add_142 = copy__81 = None
        copy__82 = torch.ops.aten.copy_.default(primals_166, add_144);  primals_166 = add_144 = copy__82 = None
        copy__83 = torch.ops.aten.copy_.default(primals_167, add_145);  primals_167 = add_145 = copy__83 = None
        copy__84 = torch.ops.aten.copy_.default(primals_171, add_148);  primals_171 = add_148 = copy__84 = None
        copy__85 = torch.ops.aten.copy_.default(primals_172, add_150);  primals_172 = add_150 = copy__85 = None
        copy__86 = torch.ops.aten.copy_.default(primals_173, add_151);  primals_173 = add_151 = copy__86 = None
        copy__87 = torch.ops.aten.copy_.default(primals_177, add_153);  primals_177 = add_153 = copy__87 = None
        copy__88 = torch.ops.aten.copy_.default(primals_178, add_155);  primals_178 = add_155 = copy__88 = None
        copy__89 = torch.ops.aten.copy_.default(primals_179, add_156);  primals_179 = add_156 = copy__89 = None
        copy__90 = torch.ops.aten.copy_.default(primals_183, add_158);  primals_183 = add_158 = copy__90 = None
        copy__91 = torch.ops.aten.copy_.default(primals_184, add_160);  primals_184 = add_160 = copy__91 = None
        copy__92 = torch.ops.aten.copy_.default(primals_185, add_161);  primals_185 = add_161 = copy__92 = None
        copy__93 = torch.ops.aten.copy_.default(primals_189, add_164);  primals_189 = add_164 = copy__93 = None
        copy__94 = torch.ops.aten.copy_.default(primals_190, add_166);  primals_190 = add_166 = copy__94 = None
        copy__95 = torch.ops.aten.copy_.default(primals_191, add_167);  primals_191 = add_167 = copy__95 = None
        copy__96 = torch.ops.aten.copy_.default(primals_195, add_169);  primals_195 = add_169 = copy__96 = None
        copy__97 = torch.ops.aten.copy_.default(primals_196, add_171);  primals_196 = add_171 = copy__97 = None
        copy__98 = torch.ops.aten.copy_.default(primals_197, add_172);  primals_197 = add_172 = copy__98 = None
        copy__99 = torch.ops.aten.copy_.default(primals_201, add_174);  primals_201 = add_174 = copy__99 = None
        copy__100 = torch.ops.aten.copy_.default(primals_202, add_176);  primals_202 = add_176 = copy__100 = None
        copy__101 = torch.ops.aten.copy_.default(primals_203, add_177);  primals_203 = add_177 = copy__101 = None
        copy__102 = torch.ops.aten.copy_.default(primals_207, add_180);  primals_207 = add_180 = copy__102 = None
        copy__103 = torch.ops.aten.copy_.default(primals_208, add_182);  primals_208 = add_182 = copy__103 = None
        copy__104 = torch.ops.aten.copy_.default(primals_209, add_183);  primals_209 = add_183 = copy__104 = None
        copy__105 = torch.ops.aten.copy_.default(primals_213, add_185);  primals_213 = add_185 = copy__105 = None
        copy__106 = torch.ops.aten.copy_.default(primals_214, add_187);  primals_214 = add_187 = copy__106 = None
        copy__107 = torch.ops.aten.copy_.default(primals_215, add_188);  primals_215 = add_188 = copy__107 = None
        copy__108 = torch.ops.aten.copy_.default(primals_219, add_190);  primals_219 = add_190 = copy__108 = None
        copy__109 = torch.ops.aten.copy_.default(primals_220, add_192);  primals_220 = add_192 = copy__109 = None
        copy__110 = torch.ops.aten.copy_.default(primals_221, add_193);  primals_221 = add_193 = copy__110 = None
        copy__111 = torch.ops.aten.copy_.default(primals_225, add_196);  primals_225 = add_196 = copy__111 = None
        copy__112 = torch.ops.aten.copy_.default(primals_226, add_198);  primals_226 = add_198 = copy__112 = None
        copy__113 = torch.ops.aten.copy_.default(primals_227, add_199);  primals_227 = add_199 = copy__113 = None
        copy__114 = torch.ops.aten.copy_.default(primals_231, add_201);  primals_231 = add_201 = copy__114 = None
        copy__115 = torch.ops.aten.copy_.default(primals_232, add_203);  primals_232 = add_203 = copy__115 = None
        copy__116 = torch.ops.aten.copy_.default(primals_233, add_204);  primals_233 = add_204 = copy__116 = None
        copy__117 = torch.ops.aten.copy_.default(primals_237, add_206);  primals_237 = add_206 = copy__117 = None
        copy__118 = torch.ops.aten.copy_.default(primals_238, add_208);  primals_238 = add_208 = copy__118 = None
        copy__119 = torch.ops.aten.copy_.default(primals_239, add_209);  primals_239 = add_209 = copy__119 = None
        copy__120 = torch.ops.aten.copy_.default(primals_243, add_212);  primals_243 = add_212 = copy__120 = None
        copy__121 = torch.ops.aten.copy_.default(primals_244, add_214);  primals_244 = add_214 = copy__121 = None
        copy__122 = torch.ops.aten.copy_.default(primals_245, add_215);  primals_245 = add_215 = copy__122 = None
        copy__123 = torch.ops.aten.copy_.default(primals_249, add_217);  primals_249 = add_217 = copy__123 = None
        copy__124 = torch.ops.aten.copy_.default(primals_250, add_219);  primals_250 = add_219 = copy__124 = None
        copy__125 = torch.ops.aten.copy_.default(primals_251, add_220);  primals_251 = add_220 = copy__125 = None
        copy__126 = torch.ops.aten.copy_.default(primals_255, add_222);  primals_255 = add_222 = copy__126 = None
        copy__127 = torch.ops.aten.copy_.default(primals_256, add_224);  primals_256 = add_224 = copy__127 = None
        copy__128 = torch.ops.aten.copy_.default(primals_257, add_225);  primals_257 = add_225 = copy__128 = None
        copy__129 = torch.ops.aten.copy_.default(primals_261, add_228);  primals_261 = add_228 = copy__129 = None
        copy__130 = torch.ops.aten.copy_.default(primals_262, add_230);  primals_262 = add_230 = copy__130 = None
        copy__131 = torch.ops.aten.copy_.default(primals_263, add_231);  primals_263 = add_231 = copy__131 = None
        copy__132 = torch.ops.aten.copy_.default(primals_267, add_233);  primals_267 = add_233 = copy__132 = None
        copy__133 = torch.ops.aten.copy_.default(primals_268, add_235);  primals_268 = add_235 = copy__133 = None
        copy__134 = torch.ops.aten.copy_.default(primals_269, add_236);  primals_269 = add_236 = copy__134 = None
        copy__135 = torch.ops.aten.copy_.default(primals_273, add_238);  primals_273 = add_238 = copy__135 = None
        copy__136 = torch.ops.aten.copy_.default(primals_274, add_240);  primals_274 = add_240 = copy__136 = None
        copy__137 = torch.ops.aten.copy_.default(primals_275, add_241);  primals_275 = add_241 = copy__137 = None
        copy__138 = torch.ops.aten.copy_.default(primals_279, add_243);  primals_279 = add_243 = copy__138 = None
        copy__139 = torch.ops.aten.copy_.default(primals_280, add_245);  primals_280 = add_245 = copy__139 = None
        copy__140 = torch.ops.aten.copy_.default(primals_281, add_246);  primals_281 = add_246 = copy__140 = None
        copy__141 = torch.ops.aten.copy_.default(primals_285, add_249);  primals_285 = add_249 = copy__141 = None
        copy__142 = torch.ops.aten.copy_.default(primals_286, add_251);  primals_286 = add_251 = copy__142 = None
        copy__143 = torch.ops.aten.copy_.default(primals_287, add_252);  primals_287 = add_252 = copy__143 = None
        copy__144 = torch.ops.aten.copy_.default(primals_291, add_254);  primals_291 = add_254 = copy__144 = None
        copy__145 = torch.ops.aten.copy_.default(primals_292, add_256);  primals_292 = add_256 = copy__145 = None
        copy__146 = torch.ops.aten.copy_.default(primals_293, add_257);  primals_293 = add_257 = copy__146 = None
        copy__147 = torch.ops.aten.copy_.default(primals_297, add_259);  primals_297 = add_259 = copy__147 = None
        copy__148 = torch.ops.aten.copy_.default(primals_298, add_261);  primals_298 = add_261 = copy__148 = None
        copy__149 = torch.ops.aten.copy_.default(primals_299, add_262);  primals_299 = add_262 = copy__149 = None
        copy__150 = torch.ops.aten.copy_.default(primals_303, add_265);  primals_303 = add_265 = copy__150 = None
        copy__151 = torch.ops.aten.copy_.default(primals_304, add_267);  primals_304 = add_267 = copy__151 = None
        copy__152 = torch.ops.aten.copy_.default(primals_305, add_268);  primals_305 = add_268 = copy__152 = None
        copy__153 = torch.ops.aten.copy_.default(primals_309, add_270);  primals_309 = add_270 = copy__153 = None
        copy__154 = torch.ops.aten.copy_.default(primals_310, add_272);  primals_310 = add_272 = copy__154 = None
        copy__155 = torch.ops.aten.copy_.default(primals_311, add_273);  primals_311 = add_273 = copy__155 = None
        copy__156 = torch.ops.aten.copy_.default(primals_315, add_275);  primals_315 = add_275 = copy__156 = None
        copy__157 = torch.ops.aten.copy_.default(primals_316, add_277);  primals_316 = add_277 = copy__157 = None
        copy__158 = torch.ops.aten.copy_.default(primals_317, add_278);  primals_317 = add_278 = copy__158 = None
...
def load_args(reader):
    ...
    buf320 = reader.storage(None, 400, device=device(type='cuda', index=0))
    reader.tensor(buf320, (100,), is_leaf=True)  # primals_321
