...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207, primals_208, primals_209, primals_210, primals_211, primals_212, primals_213, primals_214, primals_215, primals_216, primals_217, primals_218, primals_219, primals_220, primals_221, primals_222, primals_223, primals_224, primals_225, primals_226, primals_227, primals_228, primals_229, primals_230, primals_231, primals_232, primals_233, primals_234, primals_235, primals_236, primals_237, primals_238, primals_239, primals_240, primals_241, primals_242, primals_243, primals_244, primals_245, primals_246, primals_247, primals_248, primals_249, primals_250, primals_251, primals_252, primals_253, primals_254, primals_255, primals_256, primals_257, primals_258, primals_259, primals_260, primals_261, primals_262, primals_263, primals_264, primals_265, primals_266, primals_267, primals_268, primals_269, primals_270, primals_271, primals_272, primals_273, primals_274, primals_275, primals_276, primals_277, primals_278, primals_279, primals_280, primals_281, primals_282, primals_283, primals_284, primals_285, primals_286, primals_287, primals_288, primals_289, primals_290, primals_291, primals_292, primals_293, primals_294, primals_295, primals_296, primals_297, primals_298, primals_299, primals_300, primals_301, primals_302, primals_303, primals_304, primals_305, primals_306, primals_307, primals_308, primals_309, primals_310, primals_311, primals_312, primals_313, primals_314, primals_315, primals_316, primals_317, primals_318, primals_319, primals_320):
        ...
        view = torch.ops.aten.view.default(convert_element_type, [512, -1, 512])
        view_1 = torch.ops.aten.view.default(view, [150528, 512]);  view = None
        empty = torch.ops.aten.empty.memory_format([150528, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_1 = torch.ops.aten.empty.memory_format([150528], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_2 = torch.ops.aten.empty.memory_format([150528], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 218, constant_args_idx = 311, grid = [(150528, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1, 'P_ptr': empty, 'S_ptr': empty_1, 'M_ptr': empty_2, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1 = empty = empty_1 = empty_2 = None
        ...
        view_7 = torch.ops.aten.view.default(convolution, [512, 64, 12544]);  convolution = None
        ...
        full_default_2 = torch.ops.aten.full.default([], 6422528.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_3 = torch.ops.aten.full.default([], 1.0000001192092896, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        mul_2 = torch.ops.aten.mul.Tensor(clamp_min, full_default_3);  clamp_min = full_default_3 = None
        ...
        mul_6 = torch.ops.aten.mul.Tensor(mul_2, 0.1);  mul_2 = None
        add_3 = torch.ops.aten.add.Tensor(mul_5, mul_6);  mul_5 = mul_6 = None
        empty_3 = torch.ops.aten.empty.memory_format([512, 64, 12544], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute = torch.ops.aten.permute.default(empty_3, [0, 1, 2]);  empty_3 = None
        empty_4 = torch.ops.aten.empty.memory_format([512, 64, 12544], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_1 = torch.ops.aten.permute.default(empty_4, [0, 1, 2]);  empty_4 = None
        triton_kernel_wrapper_functional_proxy_2 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 220, constant_args_idx = 313, grid = [(64, 6272, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_7, 'MEAN': div, 'INVSTD': rsqrt, 'GAMMA': primals_4, 'BETA': primals_5, 'Y': permute, 'X_hat': permute_1, 'M': 6422528, 'HW': 12544, 'stride_n': 802816, 'stride_c': 12544, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_7 = div = primals_5 = permute = permute_1 = None
        ...
        empty_5 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_6 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_7 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_11 = torch.ops.aten.view.default(getitem_6, [512, -1, 512]);  getitem_6 = None
        view_12 = torch.ops.aten.view.default(view_11, [802816, 512]);  view_11 = None
        triton_kernel_wrapper_functional_proxy_3 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 221, constant_args_idx = 314, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_12, 'P_ptr': empty_5, 'S_ptr': empty_6, 'M_ptr': empty_7, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_12 = empty_5 = empty_6 = empty_7 = None
        ...
        full_default_4 = torch.ops.aten.full.default([512, 64, 112, 112], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_18 = torch.ops.aten.view.default(getitem_5, [512, 64, 112, 112]);  getitem_5 = None
        empty_8 = torch.ops.aten.empty.memory_format([512, 64, 112, 112], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_2 = torch.ops.aten.permute.default(empty_8, [0, 1, 2, 3]);  empty_8 = None
        triton_kernel_wrapper_functional_proxy_4 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 315, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_18, 'Y_ptr': permute_2, 'Mask_prt': full_default_4, 'n_elts': 411041792, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_18 = permute_2 = full_default_4 = None
        ...
        full_default_5 = torch.ops.aten.full.default([802816, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_21 = torch.ops.aten.view.default(getitem_11, [512, -1, 512]);  getitem_11 = None
        view_22 = torch.ops.aten.view.default(view_21, [802816, 512]);  view_21 = None
        triton_kernel_wrapper_functional_proxy_5 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 316, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_22, 'P_ptr': full_default_5, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_22 = None
        ...
        convert_element_type_2 = torch.ops.prims.convert_element_type.default(primals_8, torch.bfloat16);  primals_8 = None
        view_23 = torch.ops.aten.view.default(getitem_13, [512, -1, 512])
        view_24 = torch.ops.aten.view.default(view_23, [200704, 512]);  view_23 = None
        empty_9 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_10 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_11 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_8 = torch.ops.aten.full.default([], 1605632.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_9 = torch.ops.aten.full.default([], 1.0000005960464478, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_12 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_3 = torch.ops.aten.permute.default(empty_12, [0, 1, 2]);  empty_12 = None
        empty_13 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_14 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_15 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_16 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_34 = torch.ops.aten.view.default(getitem_21, [512, -1, 512]);  getitem_21 = None
        view_35 = torch.ops.aten.view.default(view_34, [200704, 512]);  view_34 = None
        triton_kernel_wrapper_functional_proxy_9 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 225, constant_args_idx = 320, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_35, 'P_ptr': empty_14, 'S_ptr': empty_15, 'M_ptr': empty_16, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_35 = empty_14 = empty_15 = empty_16 = None
        ...
        full_default_10 = torch.ops.aten.full.default([512, 64, 56, 56], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_41 = torch.ops.aten.view.default(getitem_20, [512, 64, 56, 56]);  getitem_20 = None
        empty_17 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_5 = torch.ops.aten.permute.default(empty_17, [0, 1, 2, 3]);  empty_17 = None
        triton_kernel_wrapper_functional_proxy_10 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 321, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_41, 'Y_ptr': permute_5, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_41 = permute_5 = None
        ...
        full_default_11 = torch.ops.aten.full.default([200704, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_44 = torch.ops.aten.view.default(getitem_26, [512, -1, 512]);  getitem_26 = None
        view_45 = torch.ops.aten.view.default(view_44, [200704, 512]);  view_44 = None
        triton_kernel_wrapper_functional_proxy_11 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 322, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_45, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_45 = None
        getitem_27 = triton_kernel_wrapper_functional_proxy_11['P_ptr'];  triton_kernel_wrapper_functional_proxy_11 = None
        convert_element_type_3 = torch.ops.prims.convert_element_type.default(primals_14, torch.bfloat16);  primals_14 = None
        empty_18 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_19 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_20 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_48 = torch.ops.aten.view.default(getitem_25, [512, -1, 512])
        view_49 = torch.ops.aten.view.default(view_48, [200704, 512]);  view_48 = None
        triton_kernel_wrapper_functional_proxy_12 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 226, constant_args_idx = 323, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_49, 'P_ptr': empty_18, 'S_ptr': empty_19, 'M_ptr': empty_20, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_49 = empty_18 = empty_19 = empty_20 = None
        ...
        convolution_2 = torch.ops.aten.convolution.default(getitem_25, convert_element_type_3, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_25 = None
        add_8 = torch.ops.aten.add.Tensor(primals_15, 1)
        view_55 = torch.ops.aten.view.default(convolution_2, [512, 64, 3136]);  convolution_2 = None
        triton_kernel_wrapper_functional_proxy_13 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 227, constant_args_idx = 324, grid = [(64, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_55, 'SUM': full_default, 'SUMSQ': full_default, 'M': 1605632, 'HW': 3136, 'stride_n': 200704, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_21 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_6 = torch.ops.aten.permute.default(empty_21, [0, 1, 2]);  empty_21 = None
        empty_22 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_23 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_24 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_25 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_59 = torch.ops.aten.view.default(getitem_34, [512, -1, 512]);  getitem_34 = None
        view_60 = torch.ops.aten.view.default(view_59, [200704, 512]);  view_59 = None
        triton_kernel_wrapper_functional_proxy_15 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 229, constant_args_idx = 326, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_60, 'P_ptr': empty_23, 'S_ptr': empty_24, 'M_ptr': empty_25, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_60 = empty_23 = empty_24 = empty_25 = None
        ...
        view_66 = torch.ops.aten.view.default(getitem_33, [512, 64, 56, 56]);  getitem_33 = None
        empty_26 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_8 = torch.ops.aten.permute.default(empty_26, [0, 1, 2, 3]);  empty_26 = None
        triton_kernel_wrapper_functional_proxy_16 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 327, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_66, 'Y_ptr': permute_8, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_66 = permute_8 = None
        ...
        view_69 = torch.ops.aten.view.default(getitem_39, [512, -1, 512]);  getitem_39 = None
        view_70 = torch.ops.aten.view.default(view_69, [200704, 512]);  view_69 = None
        triton_kernel_wrapper_functional_proxy_17 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 328, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_70, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_70 = None
        getitem_40 = triton_kernel_wrapper_functional_proxy_17['P_ptr'];  triton_kernel_wrapper_functional_proxy_17 = None
        convert_element_type_4 = torch.ops.prims.convert_element_type.default(primals_20, torch.bfloat16);  primals_20 = None
        empty_27 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_28 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_29 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_73 = torch.ops.aten.view.default(getitem_38, [512, -1, 512])
        view_74 = torch.ops.aten.view.default(view_73, [200704, 512]);  view_73 = None
        ...
        convolution_3 = torch.ops.aten.convolution.default(getitem_38, convert_element_type_4, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_38 = None
        add_12 = torch.ops.aten.add.Tensor(primals_21, 1)
        view_80 = torch.ops.aten.view.default(convolution_3, [512, 256, 3136]);  convolution_3 = None
        ...
        empty_30 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_9 = torch.ops.aten.permute.default(empty_30, [0, 1, 2]);  empty_30 = None
        empty_31 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_32 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_33 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_34 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_84 = torch.ops.aten.view.default(getitem_47, [512, -1, 512]);  getitem_47 = None
        view_85 = torch.ops.aten.view.default(view_84, [802816, 512]);  view_84 = None
        triton_kernel_wrapper_functional_proxy_21 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 233, constant_args_idx = 332, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_85, 'P_ptr': empty_32, 'S_ptr': empty_33, 'M_ptr': empty_34, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_85 = empty_32 = empty_33 = empty_34 = None
        ...
        convert_element_type_5 = torch.ops.prims.convert_element_type.default(primals_26, torch.bfloat16);  primals_26 = None
        empty_35 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_36 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_37 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy_22 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 234, constant_args_idx = 333, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_24, 'P_ptr': empty_35, 'S_ptr': empty_36, 'M_ptr': empty_37, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_24 = empty_35 = empty_36 = empty_37 = None
        ...
        convolution_4 = torch.ops.aten.convolution.default(getitem_13, convert_element_type_5, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_13 = None
        add_16 = torch.ops.aten.add.Tensor(primals_27, 1)
        view_98 = torch.ops.aten.view.default(convolution_4, [512, 256, 3136]);  convolution_4 = None
        triton_kernel_wrapper_functional_proxy_23 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 235, constant_args_idx = 334, grid = [(256, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_98, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 1605632, 'HW': 3136, 'stride_n': 802816, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_38 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_11 = torch.ops.aten.permute.default(empty_38, [0, 1, 2]);  empty_38 = None
        empty_39 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_40 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_41 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_42 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_102 = torch.ops.aten.view.default(getitem_57, [512, -1, 512]);  getitem_57 = None
        view_103 = torch.ops.aten.view.default(view_102, [802816, 512]);  view_102 = None
        triton_kernel_wrapper_functional_proxy_25 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 237, constant_args_idx = 336, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_103, 'P_ptr': empty_40, 'S_ptr': empty_41, 'M_ptr': empty_42, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_103 = empty_40 = empty_41 = empty_42 = None
        ...
        view_109 = torch.ops.aten.view.default(getitem_46, [512, 256, 56, 56]);  getitem_46 = None
        view_110 = torch.ops.aten.view.default(getitem_56, [512, 256, 56, 56]);  getitem_56 = None
        add_20 = torch.ops.aten.add.Tensor(view_109, view_110);  view_109 = view_110 = None
        full_default_26 = torch.ops.aten.full.default([512, 256, 56, 56], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        empty_43 = torch.ops.aten.empty.memory_format([512, 256, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_113 = torch.ops.aten.view.default(getitem_62, [512, -1, 512]);  getitem_62 = None
        view_114 = torch.ops.aten.view.default(view_113, [802816, 512]);  view_113 = None
        triton_kernel_wrapper_functional_proxy_27 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 338, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_114, 'P_ptr': full_default_5, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_114 = None
        getitem_63 = triton_kernel_wrapper_functional_proxy_27['P_ptr'];  triton_kernel_wrapper_functional_proxy_27 = None
        convert_element_type_6 = torch.ops.prims.convert_element_type.default(primals_32, torch.bfloat16);  primals_32 = None
        empty_44 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_45 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_46 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_117 = torch.ops.aten.view.default(getitem_61, [512, -1, 512])
        view_118 = torch.ops.aten.view.default(view_117, [802816, 512]);  view_117 = None
        triton_kernel_wrapper_functional_proxy_28 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 238, constant_args_idx = 339, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_118, 'P_ptr': empty_44, 'S_ptr': empty_45, 'M_ptr': empty_46, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_118 = empty_44 = empty_45 = empty_46 = None
        ...
        convolution_5 = torch.ops.aten.convolution.default(getitem_61, convert_element_type_6, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_21 = torch.ops.aten.add.Tensor(primals_33, 1)
        view_124 = torch.ops.aten.view.default(convolution_5, [512, 64, 3136]);  convolution_5 = None
        triton_kernel_wrapper_functional_proxy_29 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 239, constant_args_idx = 340, grid = [(64, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_124, 'SUM': full_default, 'SUMSQ': full_default, 'M': 1605632, 'HW': 3136, 'stride_n': 200704, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_47 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_14 = torch.ops.aten.permute.default(empty_47, [0, 1, 2]);  empty_47 = None
        empty_48 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_49 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_50 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_51 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_128 = torch.ops.aten.view.default(getitem_70, [512, -1, 512]);  getitem_70 = None
        view_129 = torch.ops.aten.view.default(view_128, [200704, 512]);  view_128 = None
        ...
        view_135 = torch.ops.aten.view.default(getitem_69, [512, 64, 56, 56]);  getitem_69 = None
        empty_52 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_16 = torch.ops.aten.permute.default(empty_52, [0, 1, 2, 3]);  empty_52 = None
        triton_kernel_wrapper_functional_proxy_32 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 343, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_135, 'Y_ptr': permute_16, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_135 = permute_16 = None
        ...
        view_138 = torch.ops.aten.view.default(getitem_75, [512, -1, 512]);  getitem_75 = None
        view_139 = torch.ops.aten.view.default(view_138, [200704, 512]);  view_138 = None
        triton_kernel_wrapper_functional_proxy_33 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 344, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_139, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_139 = None
        getitem_76 = triton_kernel_wrapper_functional_proxy_33['P_ptr'];  triton_kernel_wrapper_functional_proxy_33 = None
        convert_element_type_7 = torch.ops.prims.convert_element_type.default(primals_38, torch.bfloat16);  primals_38 = None
        empty_53 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_54 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_55 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_142 = torch.ops.aten.view.default(getitem_74, [512, -1, 512])
        view_143 = torch.ops.aten.view.default(view_142, [200704, 512]);  view_142 = None
        triton_kernel_wrapper_functional_proxy_34 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 242, constant_args_idx = 345, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_143, 'P_ptr': empty_53, 'S_ptr': empty_54, 'M_ptr': empty_55, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_143 = empty_53 = empty_54 = empty_55 = None
        ...
        convolution_6 = torch.ops.aten.convolution.default(getitem_74, convert_element_type_7, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_74 = None
        add_25 = torch.ops.aten.add.Tensor(primals_39, 1)
        view_149 = torch.ops.aten.view.default(convolution_6, [512, 64, 3136]);  convolution_6 = None
        ...
        empty_56 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_17 = torch.ops.aten.permute.default(empty_56, [0, 1, 2]);  empty_56 = None
        empty_57 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_58 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_59 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_60 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_153 = torch.ops.aten.view.default(getitem_83, [512, -1, 512]);  getitem_83 = None
        view_154 = torch.ops.aten.view.default(view_153, [200704, 512]);  view_153 = None
        triton_kernel_wrapper_functional_proxy_37 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 245, constant_args_idx = 348, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_154, 'P_ptr': empty_58, 'S_ptr': empty_59, 'M_ptr': empty_60, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_154 = empty_58 = empty_59 = empty_60 = None
        ...
        view_160 = torch.ops.aten.view.default(getitem_82, [512, 64, 56, 56]);  getitem_82 = None
        empty_61 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_19 = torch.ops.aten.permute.default(empty_61, [0, 1, 2, 3]);  empty_61 = None
        triton_kernel_wrapper_functional_proxy_38 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 349, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_160, 'Y_ptr': permute_19, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_160 = permute_19 = None
        ...
        view_163 = torch.ops.aten.view.default(getitem_88, [512, -1, 512]);  getitem_88 = None
        view_164 = torch.ops.aten.view.default(view_163, [200704, 512]);  view_163 = None
        triton_kernel_wrapper_functional_proxy_39 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 350, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_164, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_164 = None
        getitem_89 = triton_kernel_wrapper_functional_proxy_39['P_ptr'];  triton_kernel_wrapper_functional_proxy_39 = None
        convert_element_type_8 = torch.ops.prims.convert_element_type.default(primals_44, torch.bfloat16);  primals_44 = None
        empty_62 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_63 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_64 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_167 = torch.ops.aten.view.default(getitem_87, [512, -1, 512])
        view_168 = torch.ops.aten.view.default(view_167, [200704, 512]);  view_167 = None
        triton_kernel_wrapper_functional_proxy_40 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 246, constant_args_idx = 351, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_168, 'P_ptr': empty_62, 'S_ptr': empty_63, 'M_ptr': empty_64, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_168 = empty_62 = empty_63 = empty_64 = None
        ...
        convolution_7 = torch.ops.aten.convolution.default(getitem_87, convert_element_type_8, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_87 = None
        add_29 = torch.ops.aten.add.Tensor(primals_45, 1)
        view_174 = torch.ops.aten.view.default(convolution_7, [512, 256, 3136]);  convolution_7 = None
        triton_kernel_wrapper_functional_proxy_41 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 247, constant_args_idx = 352, grid = [(256, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_174, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 1605632, 'HW': 3136, 'stride_n': 802816, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_65 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_20 = torch.ops.aten.permute.default(empty_65, [0, 1, 2]);  empty_65 = None
        empty_66 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_67 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_68 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_69 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_178 = torch.ops.aten.view.default(getitem_96, [512, -1, 512]);  getitem_96 = None
        view_179 = torch.ops.aten.view.default(view_178, [802816, 512]);  view_178 = None
        triton_kernel_wrapper_functional_proxy_43 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 249, constant_args_idx = 354, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_179, 'P_ptr': empty_67, 'S_ptr': empty_68, 'M_ptr': empty_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_179 = empty_67 = empty_68 = empty_69 = None
        ...
        view_185 = torch.ops.aten.view.default(getitem_95, [512, 256, 56, 56]);  getitem_95 = None
        add_33 = torch.ops.aten.add.Tensor(view_185, getitem_61);  view_185 = getitem_61 = None
        empty_70 = torch.ops.aten.empty.memory_format([512, 256, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_188 = torch.ops.aten.view.default(getitem_101, [512, -1, 512]);  getitem_101 = None
        view_189 = torch.ops.aten.view.default(view_188, [802816, 512]);  view_188 = None
        triton_kernel_wrapper_functional_proxy_45 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 356, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_189, 'P_ptr': full_default_5, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_189 = None
        getitem_102 = triton_kernel_wrapper_functional_proxy_45['P_ptr'];  triton_kernel_wrapper_functional_proxy_45 = None
        convert_element_type_9 = torch.ops.prims.convert_element_type.default(primals_50, torch.bfloat16);  primals_50 = None
        empty_71 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_72 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_73 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_192 = torch.ops.aten.view.default(getitem_100, [512, -1, 512])
        view_193 = torch.ops.aten.view.default(view_192, [802816, 512]);  view_192 = None
        triton_kernel_wrapper_functional_proxy_46 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 250, constant_args_idx = 357, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_193, 'P_ptr': empty_71, 'S_ptr': empty_72, 'M_ptr': empty_73, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_193 = empty_71 = empty_72 = empty_73 = None
        ...
        convolution_8 = torch.ops.aten.convolution.default(getitem_100, convert_element_type_9, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_34 = torch.ops.aten.add.Tensor(primals_51, 1)
        view_199 = torch.ops.aten.view.default(convolution_8, [512, 64, 3136]);  convolution_8 = None
        triton_kernel_wrapper_functional_proxy_47 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 251, constant_args_idx = 358, grid = [(64, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_199, 'SUM': full_default, 'SUMSQ': full_default, 'M': 1605632, 'HW': 3136, 'stride_n': 200704, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_74 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_23 = torch.ops.aten.permute.default(empty_74, [0, 1, 2]);  empty_74 = None
        empty_75 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_76 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_77 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_78 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_203 = torch.ops.aten.view.default(getitem_109, [512, -1, 512]);  getitem_109 = None
        view_204 = torch.ops.aten.view.default(view_203, [200704, 512]);  view_203 = None
        ...
        view_210 = torch.ops.aten.view.default(getitem_108, [512, 64, 56, 56]);  getitem_108 = None
        empty_79 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_25 = torch.ops.aten.permute.default(empty_79, [0, 1, 2, 3]);  empty_79 = None
        triton_kernel_wrapper_functional_proxy_50 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 361, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_210, 'Y_ptr': permute_25, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_210 = permute_25 = None
        ...
        view_213 = torch.ops.aten.view.default(getitem_114, [512, -1, 512]);  getitem_114 = None
        view_214 = torch.ops.aten.view.default(view_213, [200704, 512]);  view_213 = None
        triton_kernel_wrapper_functional_proxy_51 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 362, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_214, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_214 = None
        getitem_115 = triton_kernel_wrapper_functional_proxy_51['P_ptr'];  triton_kernel_wrapper_functional_proxy_51 = None
        convert_element_type_10 = torch.ops.prims.convert_element_type.default(primals_56, torch.bfloat16);  primals_56 = None
        empty_80 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_81 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_82 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_217 = torch.ops.aten.view.default(getitem_113, [512, -1, 512])
        view_218 = torch.ops.aten.view.default(view_217, [200704, 512]);  view_217 = None
        triton_kernel_wrapper_functional_proxy_52 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 254, constant_args_idx = 363, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_218, 'P_ptr': empty_80, 'S_ptr': empty_81, 'M_ptr': empty_82, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_218 = empty_80 = empty_81 = empty_82 = None
        ...
        empty_83 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_26 = torch.ops.aten.permute.default(empty_83, [0, 1, 2]);  empty_83 = None
        empty_84 = torch.ops.aten.empty.memory_format([512, 64, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_85 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_86 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_87 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_228 = torch.ops.aten.view.default(getitem_122, [512, -1, 512]);  getitem_122 = None
        view_229 = torch.ops.aten.view.default(view_228, [200704, 512]);  view_228 = None
        triton_kernel_wrapper_functional_proxy_55 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 257, constant_args_idx = 366, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_229, 'P_ptr': empty_85, 'S_ptr': empty_86, 'M_ptr': empty_87, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_229 = empty_85 = empty_86 = empty_87 = None
        ...
        view_235 = torch.ops.aten.view.default(getitem_121, [512, 64, 56, 56]);  getitem_121 = None
        empty_88 = torch.ops.aten.empty.memory_format([512, 64, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_28 = torch.ops.aten.permute.default(empty_88, [0, 1, 2, 3]);  empty_88 = None
        triton_kernel_wrapper_functional_proxy_56 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 367, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_235, 'Y_ptr': permute_28, 'Mask_prt': full_default_10, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_235 = permute_28 = full_default_10 = None
        ...
        view_238 = torch.ops.aten.view.default(getitem_127, [512, -1, 512]);  getitem_127 = None
        view_239 = torch.ops.aten.view.default(view_238, [200704, 512]);  view_238 = None
        triton_kernel_wrapper_functional_proxy_57 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 368, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_239, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_239 = None
        getitem_128 = triton_kernel_wrapper_functional_proxy_57['P_ptr'];  triton_kernel_wrapper_functional_proxy_57 = None
        convert_element_type_11 = torch.ops.prims.convert_element_type.default(primals_62, torch.bfloat16);  primals_62 = None
        empty_89 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_90 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_91 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_242 = torch.ops.aten.view.default(getitem_126, [512, -1, 512])
        view_243 = torch.ops.aten.view.default(view_242, [200704, 512]);  view_242 = None
        triton_kernel_wrapper_functional_proxy_58 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 258, constant_args_idx = 369, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_243, 'P_ptr': empty_89, 'S_ptr': empty_90, 'M_ptr': empty_91, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_243 = empty_89 = empty_90 = empty_91 = None
        ...
        convolution_10 = torch.ops.aten.convolution.default(getitem_126, convert_element_type_11, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_126 = None
        add_42 = torch.ops.aten.add.Tensor(primals_63, 1)
        view_249 = torch.ops.aten.view.default(convolution_10, [512, 256, 3136]);  convolution_10 = None
        triton_kernel_wrapper_functional_proxy_59 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 259, constant_args_idx = 370, grid = [(256, 1568, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_249, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 1605632, 'HW': 3136, 'stride_n': 802816, 'stride_c': 3136, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_92 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_29 = torch.ops.aten.permute.default(empty_92, [0, 1, 2]);  empty_92 = None
        empty_93 = torch.ops.aten.empty.memory_format([512, 256, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_94 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_95 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_96 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_253 = torch.ops.aten.view.default(getitem_135, [512, -1, 512]);  getitem_135 = None
        view_254 = torch.ops.aten.view.default(view_253, [802816, 512]);  view_253 = None
        triton_kernel_wrapper_functional_proxy_61 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 261, constant_args_idx = 372, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_254, 'P_ptr': empty_94, 'S_ptr': empty_95, 'M_ptr': empty_96, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_254 = empty_94 = empty_95 = empty_96 = None
        ...
        view_260 = torch.ops.aten.view.default(getitem_134, [512, 256, 56, 56]);  getitem_134 = None
        add_46 = torch.ops.aten.add.Tensor(view_260, getitem_100);  view_260 = getitem_100 = None
        empty_97 = torch.ops.aten.empty.memory_format([512, 256, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_263 = torch.ops.aten.view.default(getitem_140, [512, -1, 512]);  getitem_140 = None
        view_264 = torch.ops.aten.view.default(view_263, [802816, 512]);  view_263 = None
        triton_kernel_wrapper_functional_proxy_63 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 374, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_264, 'P_ptr': full_default_5, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_264 = full_default_5 = None
        getitem_141 = triton_kernel_wrapper_functional_proxy_63['P_ptr'];  triton_kernel_wrapper_functional_proxy_63 = None
        convert_element_type_12 = torch.ops.prims.convert_element_type.default(primals_68, torch.bfloat16);  primals_68 = None
        empty_98 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_99 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_100 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_267 = torch.ops.aten.view.default(getitem_139, [512, -1, 512])
        view_268 = torch.ops.aten.view.default(view_267, [802816, 512]);  view_267 = None
        triton_kernel_wrapper_functional_proxy_64 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 262, constant_args_idx = 375, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_268, 'P_ptr': empty_98, 'S_ptr': empty_99, 'M_ptr': empty_100, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  empty_98 = empty_99 = empty_100 = None
        ...
        convolution_11 = torch.ops.aten.convolution.default(getitem_139, convert_element_type_12, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_47 = torch.ops.aten.add.Tensor(primals_69, 1)
        view_274 = torch.ops.aten.view.default(convolution_11, [512, 128, 3136]);  convolution_11 = None
        ...
        empty_101 = torch.ops.aten.empty.memory_format([512, 128, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_32 = torch.ops.aten.permute.default(empty_101, [0, 1, 2]);  empty_101 = None
        empty_102 = torch.ops.aten.empty.memory_format([512, 128, 3136], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_103 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_104 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_105 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_278 = torch.ops.aten.view.default(getitem_148, [512, -1, 512]);  getitem_148 = None
        view_279 = torch.ops.aten.view.default(view_278, [401408, 512]);  view_278 = None
        ...
        full_default_68 = torch.ops.aten.full.default([512, 128, 56, 56], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_285 = torch.ops.aten.view.default(getitem_147, [512, 128, 56, 56]);  getitem_147 = None
        empty_106 = torch.ops.aten.empty.memory_format([512, 128, 56, 56], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_34 = torch.ops.aten.permute.default(empty_106, [0, 1, 2, 3]);  empty_106 = None
        triton_kernel_wrapper_functional_proxy_68 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 379, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_285, 'Y_ptr': permute_34, 'Mask_prt': full_default_68, 'n_elts': 205520896, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_285 = permute_34 = full_default_68 = None
        ...
        full_default_69 = torch.ops.aten.full.default([401408, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_288 = torch.ops.aten.view.default(getitem_153, [512, -1, 512]);  getitem_153 = None
        view_289 = torch.ops.aten.view.default(view_288, [401408, 512]);  view_288 = None
        triton_kernel_wrapper_functional_proxy_69 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 380, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_289, 'P_ptr': full_default_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_289 = None
        getitem_154 = triton_kernel_wrapper_functional_proxy_69['P_ptr'];  triton_kernel_wrapper_functional_proxy_69 = None
        convert_element_type_13 = torch.ops.prims.convert_element_type.default(primals_74, torch.bfloat16);  primals_74 = None
        empty_107 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_108 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_109 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_292 = torch.ops.aten.view.default(getitem_152, [512, -1, 512])
        view_293 = torch.ops.aten.view.default(view_292, [401408, 512]);  view_292 = None
        triton_kernel_wrapper_functional_proxy_70 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 266, constant_args_idx = 381, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_293, 'P_ptr': empty_107, 'S_ptr': empty_108, 'M_ptr': empty_109, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_293 = empty_107 = empty_108 = empty_109 = None
        ...
        convolution_12 = torch.ops.aten.convolution.default(getitem_152, convert_element_type_13, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1);  getitem_152 = None
        add_51 = torch.ops.aten.add.Tensor(primals_75, 1)
        view_299 = torch.ops.aten.view.default(convolution_12, [512, 128, 784]);  convolution_12 = None
        triton_kernel_wrapper_functional_proxy_71 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 267, constant_args_idx = 382, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_299, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        full_default_72 = torch.ops.aten.full.default([], 401408.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_73 = torch.ops.aten.full.default([], 1.0000025033950806, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_110 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_35 = torch.ops.aten.permute.default(empty_110, [0, 1, 2]);  empty_110 = None
        empty_111 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_36 = torch.ops.aten.permute.default(empty_111, [0, 1, 2]);  empty_111 = None
        triton_kernel_wrapper_functional_proxy_72 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 268, constant_args_idx = 383, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_299, 'MEAN': div_36, 'INVSTD': rsqrt_12, 'GAMMA': primals_76, 'BETA': primals_77, 'Y': permute_35, 'X_hat': permute_36, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_299 = div_36 = primals_77 = permute_35 = permute_36 = None
        ...
        empty_112 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_113 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_114 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_303 = torch.ops.aten.view.default(getitem_161, [512, -1, 512]);  getitem_161 = None
        view_304 = torch.ops.aten.view.default(view_303, [100352, 512]);  view_303 = None
        triton_kernel_wrapper_functional_proxy_73 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 269, constant_args_idx = 384, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_304, 'P_ptr': empty_112, 'S_ptr': empty_113, 'M_ptr': empty_114, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_304 = empty_112 = empty_113 = empty_114 = None
        ...
        full_default_74 = torch.ops.aten.full.default([512, 128, 28, 28], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_310 = torch.ops.aten.view.default(getitem_160, [512, 128, 28, 28]);  getitem_160 = None
        empty_115 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_37 = torch.ops.aten.permute.default(empty_115, [0, 1, 2, 3]);  empty_115 = None
        triton_kernel_wrapper_functional_proxy_74 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 385, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_310, 'Y_ptr': permute_37, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_310 = permute_37 = None
        ...
        full_default_75 = torch.ops.aten.full.default([100352, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_313 = torch.ops.aten.view.default(getitem_166, [512, -1, 512]);  getitem_166 = None
        view_314 = torch.ops.aten.view.default(view_313, [100352, 512]);  view_313 = None
        triton_kernel_wrapper_functional_proxy_75 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 386, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_314, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_314 = None
        getitem_167 = triton_kernel_wrapper_functional_proxy_75['P_ptr'];  triton_kernel_wrapper_functional_proxy_75 = None
        convert_element_type_14 = torch.ops.prims.convert_element_type.default(primals_80, torch.bfloat16);  primals_80 = None
        empty_116 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_117 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_118 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_317 = torch.ops.aten.view.default(getitem_165, [512, -1, 512])
        view_318 = torch.ops.aten.view.default(view_317, [100352, 512]);  view_317 = None
        triton_kernel_wrapper_functional_proxy_76 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 270, constant_args_idx = 387, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_318, 'P_ptr': empty_116, 'S_ptr': empty_117, 'M_ptr': empty_118, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_318 = empty_116 = empty_117 = empty_118 = None
        ...
        convolution_13 = torch.ops.aten.convolution.default(getitem_165, convert_element_type_14, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_165 = None
        add_55 = torch.ops.aten.add.Tensor(primals_81, 1)
        view_324 = torch.ops.aten.view.default(convolution_13, [512, 512, 784]);  convolution_13 = None
        ...
        empty_119 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_38 = torch.ops.aten.permute.default(empty_119, [0, 1, 2]);  empty_119 = None
        empty_120 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_39 = torch.ops.aten.permute.default(empty_120, [0, 1, 2]);  empty_120 = None
        triton_kernel_wrapper_functional_proxy_78 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 272, constant_args_idx = 389, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_324, 'MEAN': div_39, 'INVSTD': rsqrt_13, 'GAMMA': primals_82, 'BETA': primals_83, 'Y': permute_38, 'X_hat': permute_39, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_324 = div_39 = primals_83 = permute_38 = permute_39 = None
        ...
        empty_121 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_122 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_123 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_328 = torch.ops.aten.view.default(getitem_174, [512, -1, 512]);  getitem_174 = None
        view_329 = torch.ops.aten.view.default(view_328, [401408, 512]);  view_328 = None
        triton_kernel_wrapper_functional_proxy_79 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 273, constant_args_idx = 390, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_329, 'P_ptr': empty_121, 'S_ptr': empty_122, 'M_ptr': empty_123, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_329 = empty_121 = empty_122 = empty_123 = None
        ...
        convert_element_type_15 = torch.ops.prims.convert_element_type.default(primals_86, torch.bfloat16);  primals_86 = None
        empty_124 = torch.ops.aten.empty.memory_format([802816, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_125 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_126 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy_80 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 274, constant_args_idx = 391, grid = [(802816, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_268, 'P_ptr': empty_124, 'S_ptr': empty_125, 'M_ptr': empty_126, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_268 = empty_124 = empty_125 = empty_126 = None
        ...
        convolution_14 = torch.ops.aten.convolution.default(getitem_139, convert_element_type_15, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1);  getitem_139 = None
        add_59 = torch.ops.aten.add.Tensor(primals_87, 1)
        view_344 = torch.ops.aten.view.default(convolution_14, [512, 512, 784]);  convolution_14 = None
        triton_kernel_wrapper_functional_proxy_81 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 275, constant_args_idx = 392, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_344, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_129 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_130 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_131 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_348 = torch.ops.aten.view.default(getitem_184, [512, -1, 512]);  getitem_184 = None
        view_349 = torch.ops.aten.view.default(view_348, [401408, 512]);  view_348 = None
        ...
        view_355 = torch.ops.aten.view.default(getitem_173, [512, 512, 28, 28]);  getitem_173 = None
        view_356 = torch.ops.aten.view.default(getitem_183, [512, 512, 28, 28]);  getitem_183 = None
        add_63 = torch.ops.aten.add.Tensor(view_355, view_356);  view_355 = view_356 = None
        full_default_84 = torch.ops.aten.full.default([512, 512, 28, 28], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        empty_132 = torch.ops.aten.empty.memory_format([512, 512, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_359 = torch.ops.aten.view.default(getitem_189, [512, -1, 512]);  getitem_189 = None
        view_360 = torch.ops.aten.view.default(view_359, [401408, 512]);  view_359 = None
        triton_kernel_wrapper_functional_proxy_85 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 396, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_360, 'P_ptr': full_default_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_360 = None
        getitem_190 = triton_kernel_wrapper_functional_proxy_85['P_ptr'];  triton_kernel_wrapper_functional_proxy_85 = None
        convert_element_type_16 = torch.ops.prims.convert_element_type.default(primals_92, torch.bfloat16);  primals_92 = None
        empty_133 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_134 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_135 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_363 = torch.ops.aten.view.default(getitem_188, [512, -1, 512])
        view_364 = torch.ops.aten.view.default(view_363, [401408, 512]);  view_363 = None
        ...
        convolution_15 = torch.ops.aten.convolution.default(getitem_188, convert_element_type_16, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_64 = torch.ops.aten.add.Tensor(primals_93, 1)
        view_370 = torch.ops.aten.view.default(convolution_15, [512, 128, 784]);  convolution_15 = None
        triton_kernel_wrapper_functional_proxy_87 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 279, constant_args_idx = 398, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_370, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_136 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_43 = torch.ops.aten.permute.default(empty_136, [0, 1, 2]);  empty_136 = None
        empty_137 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_44 = torch.ops.aten.permute.default(empty_137, [0, 1, 2]);  empty_137 = None
        triton_kernel_wrapper_functional_proxy_88 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 280, constant_args_idx = 399, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_370, 'MEAN': div_45, 'INVSTD': rsqrt_15, 'GAMMA': primals_94, 'BETA': primals_95, 'Y': permute_43, 'X_hat': permute_44, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_370 = div_45 = primals_95 = permute_43 = permute_44 = None
        ...
        empty_138 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_139 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_140 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_374 = torch.ops.aten.view.default(getitem_197, [512, -1, 512]);  getitem_197 = None
        view_375 = torch.ops.aten.view.default(view_374, [100352, 512]);  view_374 = None
        triton_kernel_wrapper_functional_proxy_89 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 281, constant_args_idx = 400, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_375, 'P_ptr': empty_138, 'S_ptr': empty_139, 'M_ptr': empty_140, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_375 = empty_138 = empty_139 = empty_140 = None
        ...
        view_381 = torch.ops.aten.view.default(getitem_196, [512, 128, 28, 28]);  getitem_196 = None
        empty_141 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_45 = torch.ops.aten.permute.default(empty_141, [0, 1, 2, 3]);  empty_141 = None
        triton_kernel_wrapper_functional_proxy_90 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 401, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_381, 'Y_ptr': permute_45, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_381 = permute_45 = None
        ...
        view_384 = torch.ops.aten.view.default(getitem_202, [512, -1, 512]);  getitem_202 = None
        view_385 = torch.ops.aten.view.default(view_384, [100352, 512]);  view_384 = None
        triton_kernel_wrapper_functional_proxy_91 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 402, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_385, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_385 = None
        getitem_203 = triton_kernel_wrapper_functional_proxy_91['P_ptr'];  triton_kernel_wrapper_functional_proxy_91 = None
        convert_element_type_17 = torch.ops.prims.convert_element_type.default(primals_98, torch.bfloat16);  primals_98 = None
        empty_142 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_143 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_144 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_388 = torch.ops.aten.view.default(getitem_201, [512, -1, 512])
        view_389 = torch.ops.aten.view.default(view_388, [100352, 512]);  view_388 = None
        triton_kernel_wrapper_functional_proxy_92 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 282, constant_args_idx = 403, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_389, 'P_ptr': empty_142, 'S_ptr': empty_143, 'M_ptr': empty_144, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_389 = empty_142 = empty_143 = empty_144 = None
        ...
        convolution_16 = torch.ops.aten.convolution.default(getitem_201, convert_element_type_17, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_201 = None
        add_68 = torch.ops.aten.add.Tensor(primals_99, 1)
        view_395 = torch.ops.aten.view.default(convolution_16, [512, 128, 784]);  convolution_16 = None
        triton_kernel_wrapper_functional_proxy_93 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 283, constant_args_idx = 404, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_395, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_145 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_46 = torch.ops.aten.permute.default(empty_145, [0, 1, 2]);  empty_145 = None
        empty_146 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_47 = torch.ops.aten.permute.default(empty_146, [0, 1, 2]);  empty_146 = None
        triton_kernel_wrapper_functional_proxy_94 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 284, constant_args_idx = 405, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_395, 'MEAN': div_48, 'INVSTD': rsqrt_16, 'GAMMA': primals_100, 'BETA': primals_101, 'Y': permute_46, 'X_hat': permute_47, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_395 = div_48 = primals_101 = permute_46 = permute_47 = None
        ...
        empty_147 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_148 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_149 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_399 = torch.ops.aten.view.default(getitem_210, [512, -1, 512]);  getitem_210 = None
        view_400 = torch.ops.aten.view.default(view_399, [100352, 512]);  view_399 = None
        triton_kernel_wrapper_functional_proxy_95 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 285, constant_args_idx = 406, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_400, 'P_ptr': empty_147, 'S_ptr': empty_148, 'M_ptr': empty_149, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_400 = empty_147 = empty_148 = empty_149 = None
        ...
        view_406 = torch.ops.aten.view.default(getitem_209, [512, 128, 28, 28]);  getitem_209 = None
        empty_150 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_48 = torch.ops.aten.permute.default(empty_150, [0, 1, 2, 3]);  empty_150 = None
        triton_kernel_wrapper_functional_proxy_96 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 407, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_406, 'Y_ptr': permute_48, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_406 = permute_48 = None
        ...
        view_409 = torch.ops.aten.view.default(getitem_215, [512, -1, 512]);  getitem_215 = None
        view_410 = torch.ops.aten.view.default(view_409, [100352, 512]);  view_409 = None
        triton_kernel_wrapper_functional_proxy_97 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 408, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_410, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_410 = None
        getitem_216 = triton_kernel_wrapper_functional_proxy_97['P_ptr'];  triton_kernel_wrapper_functional_proxy_97 = None
        convert_element_type_18 = torch.ops.prims.convert_element_type.default(primals_104, torch.bfloat16);  primals_104 = None
        empty_151 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_152 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_153 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_413 = torch.ops.aten.view.default(getitem_214, [512, -1, 512])
        view_414 = torch.ops.aten.view.default(view_413, [100352, 512]);  view_413 = None
        triton_kernel_wrapper_functional_proxy_98 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 286, constant_args_idx = 409, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_414, 'P_ptr': empty_151, 'S_ptr': empty_152, 'M_ptr': empty_153, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_414 = empty_151 = empty_152 = empty_153 = None
        ...
        convolution_17 = torch.ops.aten.convolution.default(getitem_214, convert_element_type_18, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_214 = None
        add_72 = torch.ops.aten.add.Tensor(primals_105, 1)
        view_420 = torch.ops.aten.view.default(convolution_17, [512, 512, 784]);  convolution_17 = None
        triton_kernel_wrapper_functional_proxy_99 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 287, constant_args_idx = 410, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_420, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_154 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_49 = torch.ops.aten.permute.default(empty_154, [0, 1, 2]);  empty_154 = None
        empty_155 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_50 = torch.ops.aten.permute.default(empty_155, [0, 1, 2]);  empty_155 = None
        triton_kernel_wrapper_functional_proxy_100 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 288, constant_args_idx = 411, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_420, 'MEAN': div_51, 'INVSTD': rsqrt_17, 'GAMMA': primals_106, 'BETA': primals_107, 'Y': permute_49, 'X_hat': permute_50, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_420 = div_51 = primals_107 = permute_49 = permute_50 = None
        ...
        empty_156 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_157 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_158 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_424 = torch.ops.aten.view.default(getitem_223, [512, -1, 512]);  getitem_223 = None
        view_425 = torch.ops.aten.view.default(view_424, [401408, 512]);  view_424 = None
        triton_kernel_wrapper_functional_proxy_101 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 289, constant_args_idx = 412, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_425, 'P_ptr': empty_156, 'S_ptr': empty_157, 'M_ptr': empty_158, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_425 = empty_156 = empty_157 = empty_158 = None
        ...
        view_431 = torch.ops.aten.view.default(getitem_222, [512, 512, 28, 28]);  getitem_222 = None
        add_76 = torch.ops.aten.add.Tensor(view_431, getitem_188);  view_431 = getitem_188 = None
        empty_159 = torch.ops.aten.empty.memory_format([512, 512, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_434 = torch.ops.aten.view.default(getitem_228, [512, -1, 512]);  getitem_228 = None
        view_435 = torch.ops.aten.view.default(view_434, [401408, 512]);  view_434 = None
        triton_kernel_wrapper_functional_proxy_103 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 414, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_435, 'P_ptr': full_default_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_435 = None
        getitem_229 = triton_kernel_wrapper_functional_proxy_103['P_ptr'];  triton_kernel_wrapper_functional_proxy_103 = None
        convert_element_type_19 = torch.ops.prims.convert_element_type.default(primals_110, torch.bfloat16);  primals_110 = None
        empty_160 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_161 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_162 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_438 = torch.ops.aten.view.default(getitem_227, [512, -1, 512])
        view_439 = torch.ops.aten.view.default(view_438, [401408, 512]);  view_438 = None
        ...
        convolution_18 = torch.ops.aten.convolution.default(getitem_227, convert_element_type_19, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_77 = torch.ops.aten.add.Tensor(primals_111, 1)
        view_445 = torch.ops.aten.view.default(convolution_18, [512, 128, 784]);  convolution_18 = None
        triton_kernel_wrapper_functional_proxy_105 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 291, constant_args_idx = 416, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_445, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_163 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_52 = torch.ops.aten.permute.default(empty_163, [0, 1, 2]);  empty_163 = None
        empty_164 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_53 = torch.ops.aten.permute.default(empty_164, [0, 1, 2]);  empty_164 = None
        triton_kernel_wrapper_functional_proxy_106 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 292, constant_args_idx = 417, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_445, 'MEAN': div_54, 'INVSTD': rsqrt_18, 'GAMMA': primals_112, 'BETA': primals_113, 'Y': permute_52, 'X_hat': permute_53, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_445 = div_54 = primals_113 = permute_52 = permute_53 = None
        ...
        empty_165 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_166 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_167 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_449 = torch.ops.aten.view.default(getitem_236, [512, -1, 512]);  getitem_236 = None
        view_450 = torch.ops.aten.view.default(view_449, [100352, 512]);  view_449 = None
        triton_kernel_wrapper_functional_proxy_107 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 293, constant_args_idx = 418, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_450, 'P_ptr': empty_165, 'S_ptr': empty_166, 'M_ptr': empty_167, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_450 = empty_165 = empty_166 = empty_167 = None
        ...
        view_456 = torch.ops.aten.view.default(getitem_235, [512, 128, 28, 28]);  getitem_235 = None
        empty_168 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_54 = torch.ops.aten.permute.default(empty_168, [0, 1, 2, 3]);  empty_168 = None
        triton_kernel_wrapper_functional_proxy_108 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 419, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_456, 'Y_ptr': permute_54, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_456 = permute_54 = None
        ...
        view_459 = torch.ops.aten.view.default(getitem_241, [512, -1, 512]);  getitem_241 = None
        view_460 = torch.ops.aten.view.default(view_459, [100352, 512]);  view_459 = None
        triton_kernel_wrapper_functional_proxy_109 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 420, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_460, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_460 = None
        getitem_242 = triton_kernel_wrapper_functional_proxy_109['P_ptr'];  triton_kernel_wrapper_functional_proxy_109 = None
        convert_element_type_20 = torch.ops.prims.convert_element_type.default(primals_116, torch.bfloat16);  primals_116 = None
        empty_169 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_170 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_171 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_463 = torch.ops.aten.view.default(getitem_240, [512, -1, 512])
        view_464 = torch.ops.aten.view.default(view_463, [100352, 512]);  view_463 = None
        triton_kernel_wrapper_functional_proxy_110 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 294, constant_args_idx = 421, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_464, 'P_ptr': empty_169, 'S_ptr': empty_170, 'M_ptr': empty_171, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_464 = empty_169 = empty_170 = empty_171 = None
        ...
        convolution_19 = torch.ops.aten.convolution.default(getitem_240, convert_element_type_20, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_240 = None
        add_81 = torch.ops.aten.add.Tensor(primals_117, 1)
        view_470 = torch.ops.aten.view.default(convolution_19, [512, 128, 784]);  convolution_19 = None
        triton_kernel_wrapper_functional_proxy_111 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 295, constant_args_idx = 422, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_470, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_172 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_55 = torch.ops.aten.permute.default(empty_172, [0, 1, 2]);  empty_172 = None
        empty_173 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_56 = torch.ops.aten.permute.default(empty_173, [0, 1, 2]);  empty_173 = None
        triton_kernel_wrapper_functional_proxy_112 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 296, constant_args_idx = 423, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_470, 'MEAN': div_57, 'INVSTD': rsqrt_19, 'GAMMA': primals_118, 'BETA': primals_119, 'Y': permute_55, 'X_hat': permute_56, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_470 = div_57 = primals_119 = permute_55 = permute_56 = None
        ...
        empty_174 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_175 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_176 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_474 = torch.ops.aten.view.default(getitem_249, [512, -1, 512]);  getitem_249 = None
        view_475 = torch.ops.aten.view.default(view_474, [100352, 512]);  view_474 = None
        triton_kernel_wrapper_functional_proxy_113 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 297, constant_args_idx = 424, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_475, 'P_ptr': empty_174, 'S_ptr': empty_175, 'M_ptr': empty_176, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_475 = empty_174 = empty_175 = empty_176 = None
        ...
        view_481 = torch.ops.aten.view.default(getitem_248, [512, 128, 28, 28]);  getitem_248 = None
        empty_177 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_57 = torch.ops.aten.permute.default(empty_177, [0, 1, 2, 3]);  empty_177 = None
        triton_kernel_wrapper_functional_proxy_114 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 425, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_481, 'Y_ptr': permute_57, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_481 = permute_57 = None
        ...
        view_484 = torch.ops.aten.view.default(getitem_254, [512, -1, 512]);  getitem_254 = None
        view_485 = torch.ops.aten.view.default(view_484, [100352, 512]);  view_484 = None
        triton_kernel_wrapper_functional_proxy_115 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 426, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_485, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_485 = None
        getitem_255 = triton_kernel_wrapper_functional_proxy_115['P_ptr'];  triton_kernel_wrapper_functional_proxy_115 = None
        convert_element_type_21 = torch.ops.prims.convert_element_type.default(primals_122, torch.bfloat16);  primals_122 = None
        empty_178 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_179 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_180 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_488 = torch.ops.aten.view.default(getitem_253, [512, -1, 512])
        view_489 = torch.ops.aten.view.default(view_488, [100352, 512]);  view_488 = None
        triton_kernel_wrapper_functional_proxy_116 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 298, constant_args_idx = 427, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_489, 'P_ptr': empty_178, 'S_ptr': empty_179, 'M_ptr': empty_180, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_489 = empty_178 = empty_179 = empty_180 = None
        ...
        convolution_20 = torch.ops.aten.convolution.default(getitem_253, convert_element_type_21, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_253 = None
        add_85 = torch.ops.aten.add.Tensor(primals_123, 1)
        view_495 = torch.ops.aten.view.default(convolution_20, [512, 512, 784]);  convolution_20 = None
        triton_kernel_wrapper_functional_proxy_117 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 299, constant_args_idx = 428, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_495, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_181 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_58 = torch.ops.aten.permute.default(empty_181, [0, 1, 2]);  empty_181 = None
        empty_182 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_59 = torch.ops.aten.permute.default(empty_182, [0, 1, 2]);  empty_182 = None
        triton_kernel_wrapper_functional_proxy_118 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 300, constant_args_idx = 429, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_495, 'MEAN': div_60, 'INVSTD': rsqrt_20, 'GAMMA': primals_124, 'BETA': primals_125, 'Y': permute_58, 'X_hat': permute_59, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_495 = div_60 = primals_125 = permute_58 = permute_59 = None
        ...
        empty_183 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_184 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_185 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_499 = torch.ops.aten.view.default(getitem_262, [512, -1, 512]);  getitem_262 = None
        view_500 = torch.ops.aten.view.default(view_499, [401408, 512]);  view_499 = None
        ...
        view_506 = torch.ops.aten.view.default(getitem_261, [512, 512, 28, 28]);  getitem_261 = None
        add_89 = torch.ops.aten.add.Tensor(view_506, getitem_227);  view_506 = getitem_227 = None
        empty_186 = torch.ops.aten.empty.memory_format([512, 512, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_509 = torch.ops.aten.view.default(getitem_267, [512, -1, 512]);  getitem_267 = None
        view_510 = torch.ops.aten.view.default(view_509, [401408, 512]);  view_509 = None
        triton_kernel_wrapper_functional_proxy_121 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 432, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_510, 'P_ptr': full_default_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_510 = None
        getitem_268 = triton_kernel_wrapper_functional_proxy_121['P_ptr'];  triton_kernel_wrapper_functional_proxy_121 = None
        convert_element_type_22 = torch.ops.prims.convert_element_type.default(primals_128, torch.bfloat16);  primals_128 = None
        empty_187 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_188 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_189 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_513 = torch.ops.aten.view.default(getitem_266, [512, -1, 512])
        view_514 = torch.ops.aten.view.default(view_513, [401408, 512]);  view_513 = None
        triton_kernel_wrapper_functional_proxy_122 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 302, constant_args_idx = 433, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_514, 'P_ptr': empty_187, 'S_ptr': empty_188, 'M_ptr': empty_189, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_514 = empty_187 = empty_188 = empty_189 = None
        ...
        convolution_21 = torch.ops.aten.convolution.default(getitem_266, convert_element_type_22, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_90 = torch.ops.aten.add.Tensor(primals_129, 1)
        view_520 = torch.ops.aten.view.default(convolution_21, [512, 128, 784]);  convolution_21 = None
        triton_kernel_wrapper_functional_proxy_123 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 303, constant_args_idx = 434, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_520, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_190 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_61 = torch.ops.aten.permute.default(empty_190, [0, 1, 2]);  empty_190 = None
        empty_191 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_62 = torch.ops.aten.permute.default(empty_191, [0, 1, 2]);  empty_191 = None
        triton_kernel_wrapper_functional_proxy_124 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 304, constant_args_idx = 435, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_520, 'MEAN': div_63, 'INVSTD': rsqrt_21, 'GAMMA': primals_130, 'BETA': primals_131, 'Y': permute_61, 'X_hat': permute_62, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_520 = div_63 = primals_131 = permute_61 = permute_62 = None
        ...
        empty_192 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_193 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_194 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_524 = torch.ops.aten.view.default(getitem_275, [512, -1, 512]);  getitem_275 = None
        view_525 = torch.ops.aten.view.default(view_524, [100352, 512]);  view_524 = None
        triton_kernel_wrapper_functional_proxy_125 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 305, constant_args_idx = 436, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_525, 'P_ptr': empty_192, 'S_ptr': empty_193, 'M_ptr': empty_194, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_525 = empty_192 = empty_193 = empty_194 = None
        ...
        view_531 = torch.ops.aten.view.default(getitem_274, [512, 128, 28, 28]);  getitem_274 = None
        empty_195 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_63 = torch.ops.aten.permute.default(empty_195, [0, 1, 2, 3]);  empty_195 = None
        triton_kernel_wrapper_functional_proxy_126 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 437, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_531, 'Y_ptr': permute_63, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_531 = permute_63 = None
        ...
        view_534 = torch.ops.aten.view.default(getitem_280, [512, -1, 512]);  getitem_280 = None
        view_535 = torch.ops.aten.view.default(view_534, [100352, 512]);  view_534 = None
        triton_kernel_wrapper_functional_proxy_127 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 438, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_535, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_535 = None
        getitem_281 = triton_kernel_wrapper_functional_proxy_127['P_ptr'];  triton_kernel_wrapper_functional_proxy_127 = None
        convert_element_type_23 = torch.ops.prims.convert_element_type.default(primals_134, torch.bfloat16);  primals_134 = None
        empty_196 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_197 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_198 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_538 = torch.ops.aten.view.default(getitem_279, [512, -1, 512])
        view_539 = torch.ops.aten.view.default(view_538, [100352, 512]);  view_538 = None
        triton_kernel_wrapper_functional_proxy_128 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 306, constant_args_idx = 439, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_539, 'P_ptr': empty_196, 'S_ptr': empty_197, 'M_ptr': empty_198, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_539 = empty_196 = empty_197 = empty_198 = None
        ...
        convolution_22 = torch.ops.aten.convolution.default(getitem_279, convert_element_type_23, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_279 = None
        add_94 = torch.ops.aten.add.Tensor(primals_135, 1)
        view_545 = torch.ops.aten.view.default(convolution_22, [512, 128, 784]);  convolution_22 = None
        triton_kernel_wrapper_functional_proxy_129 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 307, constant_args_idx = 440, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_545, 'SUM': full_default_64, 'SUMSQ': full_default_64, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ']);  full_default_64 = None
        ...
        empty_199 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_64 = torch.ops.aten.permute.default(empty_199, [0, 1, 2]);  empty_199 = None
        empty_200 = torch.ops.aten.empty.memory_format([512, 128, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_65 = torch.ops.aten.permute.default(empty_200, [0, 1, 2]);  empty_200 = None
        triton_kernel_wrapper_functional_proxy_130 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 308, constant_args_idx = 441, grid = [(128, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_545, 'MEAN': div_66, 'INVSTD': rsqrt_22, 'GAMMA': primals_136, 'BETA': primals_137, 'Y': permute_64, 'X_hat': permute_65, 'M': 401408, 'HW': 784, 'stride_n': 100352, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_545 = div_66 = primals_137 = permute_64 = permute_65 = None
        ...
        empty_201 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_202 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_203 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_549 = torch.ops.aten.view.default(getitem_288, [512, -1, 512]);  getitem_288 = None
        view_550 = torch.ops.aten.view.default(view_549, [100352, 512]);  view_549 = None
        triton_kernel_wrapper_functional_proxy_131 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 309, constant_args_idx = 442, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_550, 'P_ptr': empty_201, 'S_ptr': empty_202, 'M_ptr': empty_203, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_550 = empty_201 = empty_202 = empty_203 = None
        ...
        view_556 = torch.ops.aten.view.default(getitem_287, [512, 128, 28, 28]);  getitem_287 = None
        empty_204 = torch.ops.aten.empty.memory_format([512, 128, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_66 = torch.ops.aten.permute.default(empty_204, [0, 1, 2, 3]);  empty_204 = None
        triton_kernel_wrapper_functional_proxy_132 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 443, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_556, 'Y_ptr': permute_66, 'Mask_prt': full_default_74, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_556 = permute_66 = full_default_74 = None
        ...
        view_559 = torch.ops.aten.view.default(getitem_293, [512, -1, 512]);  getitem_293 = None
        view_560 = torch.ops.aten.view.default(view_559, [100352, 512]);  view_559 = None
        triton_kernel_wrapper_functional_proxy_133 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 444, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_560, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_560 = None
        getitem_294 = triton_kernel_wrapper_functional_proxy_133['P_ptr'];  triton_kernel_wrapper_functional_proxy_133 = None
        convert_element_type_24 = torch.ops.prims.convert_element_type.default(primals_140, torch.bfloat16);  primals_140 = None
        empty_205 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_206 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_207 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_563 = torch.ops.aten.view.default(getitem_292, [512, -1, 512])
        view_564 = torch.ops.aten.view.default(view_563, [100352, 512]);  view_563 = None
        triton_kernel_wrapper_functional_proxy_134 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 310, constant_args_idx = 445, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_564, 'P_ptr': empty_205, 'S_ptr': empty_206, 'M_ptr': empty_207, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_564 = empty_205 = empty_206 = empty_207 = None
        ...
        convolution_23 = torch.ops.aten.convolution.default(getitem_292, convert_element_type_24, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_292 = None
        add_98 = torch.ops.aten.add.Tensor(primals_141, 1)
        view_570 = torch.ops.aten.view.default(convolution_23, [512, 512, 784]);  convolution_23 = None
        triton_kernel_wrapper_functional_proxy_135 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 311, constant_args_idx = 446, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_570, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_208 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_67 = torch.ops.aten.permute.default(empty_208, [0, 1, 2]);  empty_208 = None
        empty_209 = torch.ops.aten.empty.memory_format([512, 512, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_68 = torch.ops.aten.permute.default(empty_209, [0, 1, 2]);  empty_209 = None
        triton_kernel_wrapper_functional_proxy_136 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 312, constant_args_idx = 447, grid = [(512, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_570, 'MEAN': div_69, 'INVSTD': rsqrt_23, 'GAMMA': primals_142, 'BETA': primals_143, 'Y': permute_67, 'X_hat': permute_68, 'M': 401408, 'HW': 784, 'stride_n': 401408, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_570 = div_69 = primals_143 = permute_67 = permute_68 = None
        ...
        empty_210 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_211 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_212 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_574 = torch.ops.aten.view.default(getitem_301, [512, -1, 512]);  getitem_301 = None
        view_575 = torch.ops.aten.view.default(view_574, [401408, 512]);  view_574 = None
        ...
        view_581 = torch.ops.aten.view.default(getitem_300, [512, 512, 28, 28]);  getitem_300 = None
        add_102 = torch.ops.aten.add.Tensor(view_581, getitem_266);  view_581 = getitem_266 = None
        empty_213 = torch.ops.aten.empty.memory_format([512, 512, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_584 = torch.ops.aten.view.default(getitem_306, [512, -1, 512]);  getitem_306 = None
        view_585 = torch.ops.aten.view.default(view_584, [401408, 512]);  view_584 = None
        triton_kernel_wrapper_functional_proxy_139 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 450, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_585, 'P_ptr': full_default_69, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_585 = full_default_69 = None
        getitem_307 = triton_kernel_wrapper_functional_proxy_139['P_ptr'];  triton_kernel_wrapper_functional_proxy_139 = None
        convert_element_type_25 = torch.ops.prims.convert_element_type.default(primals_146, torch.bfloat16);  primals_146 = None
        empty_214 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_215 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_216 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_588 = torch.ops.aten.view.default(getitem_305, [512, -1, 512])
        view_589 = torch.ops.aten.view.default(view_588, [401408, 512]);  view_588 = None
        triton_kernel_wrapper_functional_proxy_140 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 314, constant_args_idx = 451, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_589, 'P_ptr': empty_214, 'S_ptr': empty_215, 'M_ptr': empty_216, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  empty_214 = empty_215 = empty_216 = None
        ...
        convolution_24 = torch.ops.aten.convolution.default(getitem_305, convert_element_type_25, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_103 = torch.ops.aten.add.Tensor(primals_147, 1)
        view_595 = torch.ops.aten.view.default(convolution_24, [512, 256, 784]);  convolution_24 = None
        triton_kernel_wrapper_functional_proxy_141 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 315, constant_args_idx = 452, grid = [(256, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_595, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 401408, 'HW': 784, 'stride_n': 200704, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_217 = torch.ops.aten.empty.memory_format([512, 256, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_70 = torch.ops.aten.permute.default(empty_217, [0, 1, 2]);  empty_217 = None
        empty_218 = torch.ops.aten.empty.memory_format([512, 256, 784], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_71 = torch.ops.aten.permute.default(empty_218, [0, 1, 2]);  empty_218 = None
        triton_kernel_wrapper_functional_proxy_142 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 316, constant_args_idx = 453, grid = [(256, 392, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_595, 'MEAN': div_72, 'INVSTD': rsqrt_24, 'GAMMA': primals_148, 'BETA': primals_149, 'Y': permute_70, 'X_hat': permute_71, 'M': 401408, 'HW': 784, 'stride_n': 200704, 'stride_c': 784, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_595 = div_72 = primals_149 = permute_70 = permute_71 = None
        ...
        empty_219 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_220 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_221 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_599 = torch.ops.aten.view.default(getitem_314, [512, -1, 512]);  getitem_314 = None
        view_600 = torch.ops.aten.view.default(view_599, [200704, 512]);  view_599 = None
        triton_kernel_wrapper_functional_proxy_143 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 317, constant_args_idx = 454, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_600, 'P_ptr': empty_219, 'S_ptr': empty_220, 'M_ptr': empty_221, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_600 = empty_219 = empty_220 = empty_221 = None
        ...
        full_default_144 = torch.ops.aten.full.default([512, 256, 28, 28], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_606 = torch.ops.aten.view.default(getitem_313, [512, 256, 28, 28]);  getitem_313 = None
        empty_222 = torch.ops.aten.empty.memory_format([512, 256, 28, 28], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_72 = torch.ops.aten.permute.default(empty_222, [0, 1, 2, 3]);  empty_222 = None
        triton_kernel_wrapper_functional_proxy_144 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 455, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_606, 'Y_ptr': permute_72, 'Mask_prt': full_default_144, 'n_elts': 102760448, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_606 = permute_72 = full_default_144 = None
        ...
        view_609 = torch.ops.aten.view.default(getitem_319, [512, -1, 512]);  getitem_319 = None
        view_610 = torch.ops.aten.view.default(view_609, [200704, 512]);  view_609 = None
        triton_kernel_wrapper_functional_proxy_145 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 456, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_610, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_610 = None
        getitem_320 = triton_kernel_wrapper_functional_proxy_145['P_ptr'];  triton_kernel_wrapper_functional_proxy_145 = None
        convert_element_type_26 = torch.ops.prims.convert_element_type.default(primals_152, torch.bfloat16);  primals_152 = None
        empty_223 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_224 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_225 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_613 = torch.ops.aten.view.default(getitem_318, [512, -1, 512])
        view_614 = torch.ops.aten.view.default(view_613, [200704, 512]);  view_613 = None
        triton_kernel_wrapper_functional_proxy_146 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 318, constant_args_idx = 457, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_614, 'P_ptr': empty_223, 'S_ptr': empty_224, 'M_ptr': empty_225, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_614 = empty_223 = empty_224 = empty_225 = None
        ...
        convolution_25 = torch.ops.aten.convolution.default(getitem_318, convert_element_type_26, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1);  getitem_318 = None
        add_107 = torch.ops.aten.add.Tensor(primals_153, 1)
        view_620 = torch.ops.aten.view.default(convolution_25, [512, 256, 196]);  convolution_25 = None
        triton_kernel_wrapper_functional_proxy_147 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 319, constant_args_idx = 458, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_620, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        full_default_148 = torch.ops.aten.full.default([], 100352.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_149 = torch.ops.aten.full.default([], 1.0000100135803223, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_226 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_73 = torch.ops.aten.permute.default(empty_226, [0, 1, 2]);  empty_226 = None
        empty_227 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_74 = torch.ops.aten.permute.default(empty_227, [0, 1, 2]);  empty_227 = None
        triton_kernel_wrapper_functional_proxy_148 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 320, constant_args_idx = 459, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_620, 'MEAN': div_75, 'INVSTD': rsqrt_25, 'GAMMA': primals_154, 'BETA': primals_155, 'Y': permute_73, 'X_hat': permute_74, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_620 = div_75 = primals_155 = permute_73 = permute_74 = None
        ...
        empty_228 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_229 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_230 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_624 = torch.ops.aten.view.default(getitem_327, [512, -1, 512]);  getitem_327 = None
        view_625 = torch.ops.aten.view.default(view_624, [50176, 512]);  view_624 = None
        triton_kernel_wrapper_functional_proxy_149 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 321, constant_args_idx = 460, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_625, 'P_ptr': empty_228, 'S_ptr': empty_229, 'M_ptr': empty_230, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_625 = empty_228 = empty_229 = empty_230 = None
        ...
        full_default_150 = torch.ops.aten.full.default([512, 256, 14, 14], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_631 = torch.ops.aten.view.default(getitem_326, [512, 256, 14, 14]);  getitem_326 = None
        empty_231 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_75 = torch.ops.aten.permute.default(empty_231, [0, 1, 2, 3]);  empty_231 = None
        triton_kernel_wrapper_functional_proxy_150 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 461, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_631, 'Y_ptr': permute_75, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_631 = permute_75 = None
        ...
        full_default_151 = torch.ops.aten.full.default([50176, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_634 = torch.ops.aten.view.default(getitem_332, [512, -1, 512]);  getitem_332 = None
        view_635 = torch.ops.aten.view.default(view_634, [50176, 512]);  view_634 = None
        triton_kernel_wrapper_functional_proxy_151 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 462, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_635, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_635 = None
        getitem_333 = triton_kernel_wrapper_functional_proxy_151['P_ptr'];  triton_kernel_wrapper_functional_proxy_151 = None
        convert_element_type_27 = torch.ops.prims.convert_element_type.default(primals_158, torch.bfloat16);  primals_158 = None
        empty_232 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_233 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_234 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_638 = torch.ops.aten.view.default(getitem_331, [512, -1, 512])
        view_639 = torch.ops.aten.view.default(view_638, [50176, 512]);  view_638 = None
        triton_kernel_wrapper_functional_proxy_152 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 322, constant_args_idx = 463, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_639, 'P_ptr': empty_232, 'S_ptr': empty_233, 'M_ptr': empty_234, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_639 = empty_232 = empty_233 = empty_234 = None
        ...
        convolution_26 = torch.ops.aten.convolution.default(getitem_331, convert_element_type_27, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_331 = None
        add_111 = torch.ops.aten.add.Tensor(primals_159, 1)
        view_645 = torch.ops.aten.view.default(convolution_26, [512, 1024, 196]);  convolution_26 = None
        ...
        empty_235 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_76 = torch.ops.aten.permute.default(empty_235, [0, 1, 2]);  empty_235 = None
        empty_236 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_77 = torch.ops.aten.permute.default(empty_236, [0, 1, 2]);  empty_236 = None
        triton_kernel_wrapper_functional_proxy_154 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 324, constant_args_idx = 465, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_645, 'MEAN': div_78, 'INVSTD': rsqrt_26, 'GAMMA': primals_160, 'BETA': primals_161, 'Y': permute_76, 'X_hat': permute_77, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_645 = div_78 = primals_161 = permute_76 = permute_77 = None
        ...
        empty_237 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_238 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_239 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_649 = torch.ops.aten.view.default(getitem_340, [512, -1, 512]);  getitem_340 = None
        view_650 = torch.ops.aten.view.default(view_649, [200704, 512]);  view_649 = None
        ...
        convert_element_type_28 = torch.ops.prims.convert_element_type.default(primals_164, torch.bfloat16);  primals_164 = None
        empty_240 = torch.ops.aten.empty.memory_format([401408, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_241 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_242 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy_156 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 326, constant_args_idx = 467, grid = [(401408, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_589, 'P_ptr': empty_240, 'S_ptr': empty_241, 'M_ptr': empty_242, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_589 = empty_240 = empty_241 = empty_242 = None
        ...
        convolution_27 = torch.ops.aten.convolution.default(getitem_305, convert_element_type_28, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1);  getitem_305 = None
        add_115 = torch.ops.aten.add.Tensor(primals_165, 1)
        view_665 = torch.ops.aten.view.default(convolution_27, [512, 1024, 196]);  convolution_27 = None
        ...
        empty_243 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_78 = torch.ops.aten.permute.default(empty_243, [0, 1, 2]);  empty_243 = None
        empty_244 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_79 = torch.ops.aten.permute.default(empty_244, [0, 1, 2]);  empty_244 = None
        triton_kernel_wrapper_functional_proxy_158 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 328, constant_args_idx = 469, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_665, 'MEAN': div_81, 'INVSTD': rsqrt_27, 'GAMMA': primals_166, 'BETA': primals_167, 'Y': permute_78, 'X_hat': permute_79, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_665 = div_81 = primals_167 = permute_78 = permute_79 = None
        ...
        empty_245 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_246 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_247 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_669 = torch.ops.aten.view.default(getitem_350, [512, -1, 512]);  getitem_350 = None
        view_670 = torch.ops.aten.view.default(view_669, [200704, 512]);  view_669 = None
        ...
        view_676 = torch.ops.aten.view.default(getitem_339, [512, 1024, 14, 14]);  getitem_339 = None
        view_677 = torch.ops.aten.view.default(getitem_349, [512, 1024, 14, 14]);  getitem_349 = None
        add_119 = torch.ops.aten.add.Tensor(view_676, view_677);  view_676 = view_677 = None
        full_default_160 = torch.ops.aten.full.default([512, 1024, 14, 14], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        empty_248 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_680 = torch.ops.aten.view.default(getitem_355, [512, -1, 512]);  getitem_355 = None
        view_681 = torch.ops.aten.view.default(view_680, [200704, 512]);  view_680 = None
        triton_kernel_wrapper_functional_proxy_161 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 472, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_681, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_681 = None
        getitem_356 = triton_kernel_wrapper_functional_proxy_161['P_ptr'];  triton_kernel_wrapper_functional_proxy_161 = None
        convert_element_type_29 = torch.ops.prims.convert_element_type.default(primals_170, torch.bfloat16);  primals_170 = None
        empty_249 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_250 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_251 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_684 = torch.ops.aten.view.default(getitem_354, [512, -1, 512])
        view_685 = torch.ops.aten.view.default(view_684, [200704, 512]);  view_684 = None
        triton_kernel_wrapper_functional_proxy_162 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 330, constant_args_idx = 473, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_685, 'P_ptr': empty_249, 'S_ptr': empty_250, 'M_ptr': empty_251, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_685 = empty_249 = empty_250 = empty_251 = None
        ...
        convolution_28 = torch.ops.aten.convolution.default(getitem_354, convert_element_type_29, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_120 = torch.ops.aten.add.Tensor(primals_171, 1)
        view_691 = torch.ops.aten.view.default(convolution_28, [512, 256, 196]);  convolution_28 = None
        triton_kernel_wrapper_functional_proxy_163 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 331, constant_args_idx = 474, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_691, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_252 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_81 = torch.ops.aten.permute.default(empty_252, [0, 1, 2]);  empty_252 = None
        empty_253 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_82 = torch.ops.aten.permute.default(empty_253, [0, 1, 2]);  empty_253 = None
        triton_kernel_wrapper_functional_proxy_164 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 332, constant_args_idx = 475, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_691, 'MEAN': div_84, 'INVSTD': rsqrt_28, 'GAMMA': primals_172, 'BETA': primals_173, 'Y': permute_81, 'X_hat': permute_82, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_691 = div_84 = primals_173 = permute_81 = permute_82 = None
        ...
        empty_254 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_255 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_256 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_695 = torch.ops.aten.view.default(getitem_363, [512, -1, 512]);  getitem_363 = None
        view_696 = torch.ops.aten.view.default(view_695, [50176, 512]);  view_695 = None
        triton_kernel_wrapper_functional_proxy_165 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 333, constant_args_idx = 476, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_696, 'P_ptr': empty_254, 'S_ptr': empty_255, 'M_ptr': empty_256, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_696 = empty_254 = empty_255 = empty_256 = None
        ...
        view_702 = torch.ops.aten.view.default(getitem_362, [512, 256, 14, 14]);  getitem_362 = None
        empty_257 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_83 = torch.ops.aten.permute.default(empty_257, [0, 1, 2, 3]);  empty_257 = None
        triton_kernel_wrapper_functional_proxy_166 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 477, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_702, 'Y_ptr': permute_83, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_702 = permute_83 = None
        ...
        view_705 = torch.ops.aten.view.default(getitem_368, [512, -1, 512]);  getitem_368 = None
        view_706 = torch.ops.aten.view.default(view_705, [50176, 512]);  view_705 = None
        triton_kernel_wrapper_functional_proxy_167 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 478, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_706, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_706 = None
        getitem_369 = triton_kernel_wrapper_functional_proxy_167['P_ptr'];  triton_kernel_wrapper_functional_proxy_167 = None
        convert_element_type_30 = torch.ops.prims.convert_element_type.default(primals_176, torch.bfloat16);  primals_176 = None
        empty_258 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_259 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_260 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_709 = torch.ops.aten.view.default(getitem_367, [512, -1, 512])
        view_710 = torch.ops.aten.view.default(view_709, [50176, 512]);  view_709 = None
        triton_kernel_wrapper_functional_proxy_168 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 334, constant_args_idx = 479, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_710, 'P_ptr': empty_258, 'S_ptr': empty_259, 'M_ptr': empty_260, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_710 = empty_258 = empty_259 = empty_260 = None
        ...
        convolution_29 = torch.ops.aten.convolution.default(getitem_367, convert_element_type_30, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_367 = None
        add_124 = torch.ops.aten.add.Tensor(primals_177, 1)
        view_716 = torch.ops.aten.view.default(convolution_29, [512, 256, 196]);  convolution_29 = None
        triton_kernel_wrapper_functional_proxy_169 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 335, constant_args_idx = 480, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_716, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_263 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_264 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_265 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_720 = torch.ops.aten.view.default(getitem_376, [512, -1, 512]);  getitem_376 = None
        view_721 = torch.ops.aten.view.default(view_720, [50176, 512]);  view_720 = None
        ...
        view_727 = torch.ops.aten.view.default(getitem_375, [512, 256, 14, 14]);  getitem_375 = None
        empty_266 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_86 = torch.ops.aten.permute.default(empty_266, [0, 1, 2, 3]);  empty_266 = None
        triton_kernel_wrapper_functional_proxy_172 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 483, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_727, 'Y_ptr': permute_86, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_727 = permute_86 = None
        ...
        view_730 = torch.ops.aten.view.default(getitem_381, [512, -1, 512]);  getitem_381 = None
        view_731 = torch.ops.aten.view.default(view_730, [50176, 512]);  view_730 = None
        triton_kernel_wrapper_functional_proxy_173 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 484, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_731, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_731 = None
        getitem_382 = triton_kernel_wrapper_functional_proxy_173['P_ptr'];  triton_kernel_wrapper_functional_proxy_173 = None
        convert_element_type_31 = torch.ops.prims.convert_element_type.default(primals_182, torch.bfloat16);  primals_182 = None
        empty_267 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_268 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_269 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_734 = torch.ops.aten.view.default(getitem_380, [512, -1, 512])
        view_735 = torch.ops.aten.view.default(view_734, [50176, 512]);  view_734 = None
        triton_kernel_wrapper_functional_proxy_174 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 338, constant_args_idx = 485, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_735, 'P_ptr': empty_267, 'S_ptr': empty_268, 'M_ptr': empty_269, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_735 = empty_267 = empty_268 = empty_269 = None
        ...
        convolution_30 = torch.ops.aten.convolution.default(getitem_380, convert_element_type_31, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_380 = None
        add_128 = torch.ops.aten.add.Tensor(primals_183, 1)
        view_741 = torch.ops.aten.view.default(convolution_30, [512, 1024, 196]);  convolution_30 = None
        ...
        empty_270 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_87 = torch.ops.aten.permute.default(empty_270, [0, 1, 2]);  empty_270 = None
        empty_271 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_88 = torch.ops.aten.permute.default(empty_271, [0, 1, 2]);  empty_271 = None
        triton_kernel_wrapper_functional_proxy_176 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 340, constant_args_idx = 487, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_741, 'MEAN': div_90, 'INVSTD': rsqrt_30, 'GAMMA': primals_184, 'BETA': primals_185, 'Y': permute_87, 'X_hat': permute_88, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_741 = div_90 = primals_185 = permute_87 = permute_88 = None
        ...
        empty_272 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_273 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_274 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_745 = torch.ops.aten.view.default(getitem_389, [512, -1, 512]);  getitem_389 = None
        view_746 = torch.ops.aten.view.default(view_745, [200704, 512]);  view_745 = None
        triton_kernel_wrapper_functional_proxy_177 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 341, constant_args_idx = 488, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_746, 'P_ptr': empty_272, 'S_ptr': empty_273, 'M_ptr': empty_274, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_746 = empty_272 = empty_273 = empty_274 = None
        ...
        view_752 = torch.ops.aten.view.default(getitem_388, [512, 1024, 14, 14]);  getitem_388 = None
        add_132 = torch.ops.aten.add.Tensor(view_752, getitem_354);  view_752 = getitem_354 = None
        empty_275 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_755 = torch.ops.aten.view.default(getitem_394, [512, -1, 512]);  getitem_394 = None
        view_756 = torch.ops.aten.view.default(view_755, [200704, 512]);  view_755 = None
        triton_kernel_wrapper_functional_proxy_179 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 490, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_756, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_756 = None
        getitem_395 = triton_kernel_wrapper_functional_proxy_179['P_ptr'];  triton_kernel_wrapper_functional_proxy_179 = None
        convert_element_type_32 = torch.ops.prims.convert_element_type.default(primals_188, torch.bfloat16);  primals_188 = None
        empty_276 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_277 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_278 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_759 = torch.ops.aten.view.default(getitem_393, [512, -1, 512])
        view_760 = torch.ops.aten.view.default(view_759, [200704, 512]);  view_759 = None
        triton_kernel_wrapper_functional_proxy_180 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 342, constant_args_idx = 491, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_760, 'P_ptr': empty_276, 'S_ptr': empty_277, 'M_ptr': empty_278, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_760 = empty_276 = empty_277 = empty_278 = None
        ...
        convolution_31 = torch.ops.aten.convolution.default(getitem_393, convert_element_type_32, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_133 = torch.ops.aten.add.Tensor(primals_189, 1)
        view_766 = torch.ops.aten.view.default(convolution_31, [512, 256, 196]);  convolution_31 = None
        triton_kernel_wrapper_functional_proxy_181 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 343, constant_args_idx = 492, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_766, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_279 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_90 = torch.ops.aten.permute.default(empty_279, [0, 1, 2]);  empty_279 = None
        empty_280 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_91 = torch.ops.aten.permute.default(empty_280, [0, 1, 2]);  empty_280 = None
        triton_kernel_wrapper_functional_proxy_182 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 344, constant_args_idx = 493, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_766, 'MEAN': div_93, 'INVSTD': rsqrt_31, 'GAMMA': primals_190, 'BETA': primals_191, 'Y': permute_90, 'X_hat': permute_91, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_766 = div_93 = primals_191 = permute_90 = permute_91 = None
        ...
        empty_281 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_282 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_283 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_770 = torch.ops.aten.view.default(getitem_402, [512, -1, 512]);  getitem_402 = None
        view_771 = torch.ops.aten.view.default(view_770, [50176, 512]);  view_770 = None
        triton_kernel_wrapper_functional_proxy_183 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 345, constant_args_idx = 494, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_771, 'P_ptr': empty_281, 'S_ptr': empty_282, 'M_ptr': empty_283, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_771 = empty_281 = empty_282 = empty_283 = None
        ...
        view_777 = torch.ops.aten.view.default(getitem_401, [512, 256, 14, 14]);  getitem_401 = None
        empty_284 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_92 = torch.ops.aten.permute.default(empty_284, [0, 1, 2, 3]);  empty_284 = None
        triton_kernel_wrapper_functional_proxy_184 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 495, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_777, 'Y_ptr': permute_92, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_777 = permute_92 = None
        ...
        view_780 = torch.ops.aten.view.default(getitem_407, [512, -1, 512]);  getitem_407 = None
        view_781 = torch.ops.aten.view.default(view_780, [50176, 512]);  view_780 = None
        triton_kernel_wrapper_functional_proxy_185 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 496, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_781, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_781 = None
        getitem_408 = triton_kernel_wrapper_functional_proxy_185['P_ptr'];  triton_kernel_wrapper_functional_proxy_185 = None
        convert_element_type_33 = torch.ops.prims.convert_element_type.default(primals_194, torch.bfloat16);  primals_194 = None
        empty_285 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_286 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_287 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_784 = torch.ops.aten.view.default(getitem_406, [512, -1, 512])
        view_785 = torch.ops.aten.view.default(view_784, [50176, 512]);  view_784 = None
        triton_kernel_wrapper_functional_proxy_186 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 346, constant_args_idx = 497, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_785, 'P_ptr': empty_285, 'S_ptr': empty_286, 'M_ptr': empty_287, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_785 = empty_285 = empty_286 = empty_287 = None
        ...
        convolution_32 = torch.ops.aten.convolution.default(getitem_406, convert_element_type_33, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_406 = None
        add_137 = torch.ops.aten.add.Tensor(primals_195, 1)
        view_791 = torch.ops.aten.view.default(convolution_32, [512, 256, 196]);  convolution_32 = None
        triton_kernel_wrapper_functional_proxy_187 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 347, constant_args_idx = 498, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_791, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_288 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_93 = torch.ops.aten.permute.default(empty_288, [0, 1, 2]);  empty_288 = None
        empty_289 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_94 = torch.ops.aten.permute.default(empty_289, [0, 1, 2]);  empty_289 = None
        triton_kernel_wrapper_functional_proxy_188 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 348, constant_args_idx = 499, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_791, 'MEAN': div_96, 'INVSTD': rsqrt_32, 'GAMMA': primals_196, 'BETA': primals_197, 'Y': permute_93, 'X_hat': permute_94, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_791 = div_96 = primals_197 = permute_93 = permute_94 = None
        ...
        empty_290 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_291 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_292 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_795 = torch.ops.aten.view.default(getitem_415, [512, -1, 512]);  getitem_415 = None
        view_796 = torch.ops.aten.view.default(view_795, [50176, 512]);  view_795 = None
        triton_kernel_wrapper_functional_proxy_189 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 349, constant_args_idx = 500, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_796, 'P_ptr': empty_290, 'S_ptr': empty_291, 'M_ptr': empty_292, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_796 = empty_290 = empty_291 = empty_292 = None
        ...
        view_802 = torch.ops.aten.view.default(getitem_414, [512, 256, 14, 14]);  getitem_414 = None
        empty_293 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_95 = torch.ops.aten.permute.default(empty_293, [0, 1, 2, 3]);  empty_293 = None
        triton_kernel_wrapper_functional_proxy_190 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 501, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_802, 'Y_ptr': permute_95, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_802 = permute_95 = None
        ...
        view_805 = torch.ops.aten.view.default(getitem_420, [512, -1, 512]);  getitem_420 = None
        view_806 = torch.ops.aten.view.default(view_805, [50176, 512]);  view_805 = None
        triton_kernel_wrapper_functional_proxy_191 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 502, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_806, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_806 = None
        getitem_421 = triton_kernel_wrapper_functional_proxy_191['P_ptr'];  triton_kernel_wrapper_functional_proxy_191 = None
        convert_element_type_34 = torch.ops.prims.convert_element_type.default(primals_200, torch.bfloat16);  primals_200 = None
        empty_294 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_295 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_296 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_809 = torch.ops.aten.view.default(getitem_419, [512, -1, 512])
        view_810 = torch.ops.aten.view.default(view_809, [50176, 512]);  view_809 = None
        triton_kernel_wrapper_functional_proxy_192 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 350, constant_args_idx = 503, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_810, 'P_ptr': empty_294, 'S_ptr': empty_295, 'M_ptr': empty_296, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_810 = empty_294 = empty_295 = empty_296 = None
        ...
        convolution_33 = torch.ops.aten.convolution.default(getitem_419, convert_element_type_34, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_419 = None
        add_141 = torch.ops.aten.add.Tensor(primals_201, 1)
        view_816 = torch.ops.aten.view.default(convolution_33, [512, 1024, 196]);  convolution_33 = None
        ...
        empty_297 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_96 = torch.ops.aten.permute.default(empty_297, [0, 1, 2]);  empty_297 = None
        empty_298 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_97 = torch.ops.aten.permute.default(empty_298, [0, 1, 2]);  empty_298 = None
        triton_kernel_wrapper_functional_proxy_194 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 352, constant_args_idx = 505, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_816, 'MEAN': div_99, 'INVSTD': rsqrt_33, 'GAMMA': primals_202, 'BETA': primals_203, 'Y': permute_96, 'X_hat': permute_97, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_816 = div_99 = primals_203 = permute_96 = permute_97 = None
        ...
        empty_299 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_300 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_301 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_820 = torch.ops.aten.view.default(getitem_428, [512, -1, 512]);  getitem_428 = None
        view_821 = torch.ops.aten.view.default(view_820, [200704, 512]);  view_820 = None
        ...
        view_827 = torch.ops.aten.view.default(getitem_427, [512, 1024, 14, 14]);  getitem_427 = None
        add_145 = torch.ops.aten.add.Tensor(view_827, getitem_393);  view_827 = getitem_393 = None
        empty_302 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_830 = torch.ops.aten.view.default(getitem_433, [512, -1, 512]);  getitem_433 = None
        view_831 = torch.ops.aten.view.default(view_830, [200704, 512]);  view_830 = None
        triton_kernel_wrapper_functional_proxy_197 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 508, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_831, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_831 = None
        getitem_434 = triton_kernel_wrapper_functional_proxy_197['P_ptr'];  triton_kernel_wrapper_functional_proxy_197 = None
        convert_element_type_35 = torch.ops.prims.convert_element_type.default(primals_206, torch.bfloat16);  primals_206 = None
        empty_303 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_304 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_305 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_834 = torch.ops.aten.view.default(getitem_432, [512, -1, 512])
        view_835 = torch.ops.aten.view.default(view_834, [200704, 512]);  view_834 = None
        ...
        convolution_34 = torch.ops.aten.convolution.default(getitem_432, convert_element_type_35, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_146 = torch.ops.aten.add.Tensor(primals_207, 1)
        view_841 = torch.ops.aten.view.default(convolution_34, [512, 256, 196]);  convolution_34 = None
        triton_kernel_wrapper_functional_proxy_199 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 355, constant_args_idx = 510, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_841, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_306 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_99 = torch.ops.aten.permute.default(empty_306, [0, 1, 2]);  empty_306 = None
        empty_307 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_100 = torch.ops.aten.permute.default(empty_307, [0, 1, 2]);  empty_307 = None
        triton_kernel_wrapper_functional_proxy_200 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 356, constant_args_idx = 511, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_841, 'MEAN': div_102, 'INVSTD': rsqrt_34, 'GAMMA': primals_208, 'BETA': primals_209, 'Y': permute_99, 'X_hat': permute_100, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_841 = div_102 = primals_209 = permute_99 = permute_100 = None
        ...
        empty_308 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_309 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_310 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_845 = torch.ops.aten.view.default(getitem_441, [512, -1, 512]);  getitem_441 = None
        view_846 = torch.ops.aten.view.default(view_845, [50176, 512]);  view_845 = None
        ...
        view_852 = torch.ops.aten.view.default(getitem_440, [512, 256, 14, 14]);  getitem_440 = None
        empty_311 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_101 = torch.ops.aten.permute.default(empty_311, [0, 1, 2, 3]);  empty_311 = None
        triton_kernel_wrapper_functional_proxy_202 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 513, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_852, 'Y_ptr': permute_101, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_852 = permute_101 = None
        ...
        view_855 = torch.ops.aten.view.default(getitem_446, [512, -1, 512]);  getitem_446 = None
        view_856 = torch.ops.aten.view.default(view_855, [50176, 512]);  view_855 = None
        triton_kernel_wrapper_functional_proxy_203 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 514, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_856, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_856 = None
        getitem_447 = triton_kernel_wrapper_functional_proxy_203['P_ptr'];  triton_kernel_wrapper_functional_proxy_203 = None
        convert_element_type_36 = torch.ops.prims.convert_element_type.default(primals_212, torch.bfloat16);  primals_212 = None
        empty_312 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_313 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_314 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_859 = torch.ops.aten.view.default(getitem_445, [512, -1, 512])
        view_860 = torch.ops.aten.view.default(view_859, [50176, 512]);  view_859 = None
        triton_kernel_wrapper_functional_proxy_204 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 358, constant_args_idx = 515, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_860, 'P_ptr': empty_312, 'S_ptr': empty_313, 'M_ptr': empty_314, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_860 = empty_312 = empty_313 = empty_314 = None
        ...
        convolution_35 = torch.ops.aten.convolution.default(getitem_445, convert_element_type_36, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_445 = None
        add_150 = torch.ops.aten.add.Tensor(primals_213, 1)
        view_866 = torch.ops.aten.view.default(convolution_35, [512, 256, 196]);  convolution_35 = None
        triton_kernel_wrapper_functional_proxy_205 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 359, constant_args_idx = 516, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_866, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_315 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_102 = torch.ops.aten.permute.default(empty_315, [0, 1, 2]);  empty_315 = None
        empty_316 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_103 = torch.ops.aten.permute.default(empty_316, [0, 1, 2]);  empty_316 = None
        triton_kernel_wrapper_functional_proxy_206 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 360, constant_args_idx = 517, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_866, 'MEAN': div_105, 'INVSTD': rsqrt_35, 'GAMMA': primals_214, 'BETA': primals_215, 'Y': permute_102, 'X_hat': permute_103, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_866 = div_105 = primals_215 = permute_102 = permute_103 = None
        ...
        empty_317 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_318 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_319 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_870 = torch.ops.aten.view.default(getitem_454, [512, -1, 512]);  getitem_454 = None
        view_871 = torch.ops.aten.view.default(view_870, [50176, 512]);  view_870 = None
        triton_kernel_wrapper_functional_proxy_207 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 361, constant_args_idx = 518, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_871, 'P_ptr': empty_317, 'S_ptr': empty_318, 'M_ptr': empty_319, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_871 = empty_317 = empty_318 = empty_319 = None
        ...
        view_877 = torch.ops.aten.view.default(getitem_453, [512, 256, 14, 14]);  getitem_453 = None
        empty_320 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_104 = torch.ops.aten.permute.default(empty_320, [0, 1, 2, 3]);  empty_320 = None
        triton_kernel_wrapper_functional_proxy_208 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 519, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_877, 'Y_ptr': permute_104, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_877 = permute_104 = None
        ...
        view_880 = torch.ops.aten.view.default(getitem_459, [512, -1, 512]);  getitem_459 = None
        view_881 = torch.ops.aten.view.default(view_880, [50176, 512]);  view_880 = None
        triton_kernel_wrapper_functional_proxy_209 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 520, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_881, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_881 = None
        getitem_460 = triton_kernel_wrapper_functional_proxy_209['P_ptr'];  triton_kernel_wrapper_functional_proxy_209 = None
        convert_element_type_37 = torch.ops.prims.convert_element_type.default(primals_218, torch.bfloat16);  primals_218 = None
        empty_321 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_322 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_323 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_884 = torch.ops.aten.view.default(getitem_458, [512, -1, 512])
        view_885 = torch.ops.aten.view.default(view_884, [50176, 512]);  view_884 = None
        triton_kernel_wrapper_functional_proxy_210 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 362, constant_args_idx = 521, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_885, 'P_ptr': empty_321, 'S_ptr': empty_322, 'M_ptr': empty_323, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_885 = empty_321 = empty_322 = empty_323 = None
        ...
        convolution_36 = torch.ops.aten.convolution.default(getitem_458, convert_element_type_37, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_458 = None
        add_154 = torch.ops.aten.add.Tensor(primals_219, 1)
        view_891 = torch.ops.aten.view.default(convolution_36, [512, 1024, 196]);  convolution_36 = None
        ...
        empty_324 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_105 = torch.ops.aten.permute.default(empty_324, [0, 1, 2]);  empty_324 = None
        empty_325 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_106 = torch.ops.aten.permute.default(empty_325, [0, 1, 2]);  empty_325 = None
        triton_kernel_wrapper_functional_proxy_212 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 364, constant_args_idx = 523, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_891, 'MEAN': div_108, 'INVSTD': rsqrt_36, 'GAMMA': primals_220, 'BETA': primals_221, 'Y': permute_105, 'X_hat': permute_106, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_891 = div_108 = primals_221 = permute_105 = permute_106 = None
        ...
        empty_326 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_327 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_328 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_895 = torch.ops.aten.view.default(getitem_467, [512, -1, 512]);  getitem_467 = None
        view_896 = torch.ops.aten.view.default(view_895, [200704, 512]);  view_895 = None
        triton_kernel_wrapper_functional_proxy_213 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 365, constant_args_idx = 524, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_896, 'P_ptr': empty_326, 'S_ptr': empty_327, 'M_ptr': empty_328, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_896 = empty_326 = empty_327 = empty_328 = None
        ...
        view_902 = torch.ops.aten.view.default(getitem_466, [512, 1024, 14, 14]);  getitem_466 = None
        add_158 = torch.ops.aten.add.Tensor(view_902, getitem_432);  view_902 = getitem_432 = None
        empty_329 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_905 = torch.ops.aten.view.default(getitem_472, [512, -1, 512]);  getitem_472 = None
        view_906 = torch.ops.aten.view.default(view_905, [200704, 512]);  view_905 = None
        triton_kernel_wrapper_functional_proxy_215 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 526, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_906, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_906 = None
        getitem_473 = triton_kernel_wrapper_functional_proxy_215['P_ptr'];  triton_kernel_wrapper_functional_proxy_215 = None
        convert_element_type_38 = torch.ops.prims.convert_element_type.default(primals_224, torch.bfloat16);  primals_224 = None
        empty_330 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_331 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_332 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_909 = torch.ops.aten.view.default(getitem_471, [512, -1, 512])
        view_910 = torch.ops.aten.view.default(view_909, [200704, 512]);  view_909 = None
        triton_kernel_wrapper_functional_proxy_216 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 366, constant_args_idx = 527, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_910, 'P_ptr': empty_330, 'S_ptr': empty_331, 'M_ptr': empty_332, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_910 = empty_330 = empty_331 = empty_332 = None
        ...
        convolution_37 = torch.ops.aten.convolution.default(getitem_471, convert_element_type_38, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_159 = torch.ops.aten.add.Tensor(primals_225, 1)
        view_916 = torch.ops.aten.view.default(convolution_37, [512, 256, 196]);  convolution_37 = None
        triton_kernel_wrapper_functional_proxy_217 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 367, constant_args_idx = 528, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_916, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_333 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_108 = torch.ops.aten.permute.default(empty_333, [0, 1, 2]);  empty_333 = None
        empty_334 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_109 = torch.ops.aten.permute.default(empty_334, [0, 1, 2]);  empty_334 = None
        triton_kernel_wrapper_functional_proxy_218 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 368, constant_args_idx = 529, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_916, 'MEAN': div_111, 'INVSTD': rsqrt_37, 'GAMMA': primals_226, 'BETA': primals_227, 'Y': permute_108, 'X_hat': permute_109, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_916 = div_111 = primals_227 = permute_108 = permute_109 = None
        ...
        empty_335 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_336 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_337 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_920 = torch.ops.aten.view.default(getitem_480, [512, -1, 512]);  getitem_480 = None
        view_921 = torch.ops.aten.view.default(view_920, [50176, 512]);  view_920 = None
        ...
        view_927 = torch.ops.aten.view.default(getitem_479, [512, 256, 14, 14]);  getitem_479 = None
        empty_338 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_110 = torch.ops.aten.permute.default(empty_338, [0, 1, 2, 3]);  empty_338 = None
        triton_kernel_wrapper_functional_proxy_220 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 531, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_927, 'Y_ptr': permute_110, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_927 = permute_110 = None
        ...
        view_930 = torch.ops.aten.view.default(getitem_485, [512, -1, 512]);  getitem_485 = None
        view_931 = torch.ops.aten.view.default(view_930, [50176, 512]);  view_930 = None
        triton_kernel_wrapper_functional_proxy_221 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 532, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_931, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_931 = None
        getitem_486 = triton_kernel_wrapper_functional_proxy_221['P_ptr'];  triton_kernel_wrapper_functional_proxy_221 = None
        convert_element_type_39 = torch.ops.prims.convert_element_type.default(primals_230, torch.bfloat16);  primals_230 = None
        empty_339 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_340 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_341 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_934 = torch.ops.aten.view.default(getitem_484, [512, -1, 512])
        view_935 = torch.ops.aten.view.default(view_934, [50176, 512]);  view_934 = None
        ...
        convolution_38 = torch.ops.aten.convolution.default(getitem_484, convert_element_type_39, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_484 = None
        add_163 = torch.ops.aten.add.Tensor(primals_231, 1)
        view_941 = torch.ops.aten.view.default(convolution_38, [512, 256, 196]);  convolution_38 = None
        triton_kernel_wrapper_functional_proxy_223 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 371, constant_args_idx = 534, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_941, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_342 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_111 = torch.ops.aten.permute.default(empty_342, [0, 1, 2]);  empty_342 = None
        empty_343 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_112 = torch.ops.aten.permute.default(empty_343, [0, 1, 2]);  empty_343 = None
        triton_kernel_wrapper_functional_proxy_224 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 372, constant_args_idx = 535, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_941, 'MEAN': div_114, 'INVSTD': rsqrt_38, 'GAMMA': primals_232, 'BETA': primals_233, 'Y': permute_111, 'X_hat': permute_112, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_941 = div_114 = primals_233 = permute_111 = permute_112 = None
        ...
        empty_344 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_345 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_346 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_945 = torch.ops.aten.view.default(getitem_493, [512, -1, 512]);  getitem_493 = None
        view_946 = torch.ops.aten.view.default(view_945, [50176, 512]);  view_945 = None
        ...
        view_952 = torch.ops.aten.view.default(getitem_492, [512, 256, 14, 14]);  getitem_492 = None
        empty_347 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_113 = torch.ops.aten.permute.default(empty_347, [0, 1, 2, 3]);  empty_347 = None
        triton_kernel_wrapper_functional_proxy_226 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 537, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_952, 'Y_ptr': permute_113, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_952 = permute_113 = None
        ...
        view_955 = torch.ops.aten.view.default(getitem_498, [512, -1, 512]);  getitem_498 = None
        view_956 = torch.ops.aten.view.default(view_955, [50176, 512]);  view_955 = None
        triton_kernel_wrapper_functional_proxy_227 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 538, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_956, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_956 = None
        getitem_499 = triton_kernel_wrapper_functional_proxy_227['P_ptr'];  triton_kernel_wrapper_functional_proxy_227 = None
        convert_element_type_40 = torch.ops.prims.convert_element_type.default(primals_236, torch.bfloat16);  primals_236 = None
        empty_348 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_349 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_350 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_959 = torch.ops.aten.view.default(getitem_497, [512, -1, 512])
        view_960 = torch.ops.aten.view.default(view_959, [50176, 512]);  view_959 = None
        triton_kernel_wrapper_functional_proxy_228 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 374, constant_args_idx = 539, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_960, 'P_ptr': empty_348, 'S_ptr': empty_349, 'M_ptr': empty_350, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_960 = empty_348 = empty_349 = empty_350 = None
        ...
        convolution_39 = torch.ops.aten.convolution.default(getitem_497, convert_element_type_40, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_497 = None
        add_167 = torch.ops.aten.add.Tensor(primals_237, 1)
        view_966 = torch.ops.aten.view.default(convolution_39, [512, 1024, 196]);  convolution_39 = None
        ...
        empty_351 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_114 = torch.ops.aten.permute.default(empty_351, [0, 1, 2]);  empty_351 = None
        empty_352 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_115 = torch.ops.aten.permute.default(empty_352, [0, 1, 2]);  empty_352 = None
        triton_kernel_wrapper_functional_proxy_230 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 376, constant_args_idx = 541, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_966, 'MEAN': div_117, 'INVSTD': rsqrt_39, 'GAMMA': primals_238, 'BETA': primals_239, 'Y': permute_114, 'X_hat': permute_115, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_966 = div_117 = primals_239 = permute_114 = permute_115 = None
        ...
        empty_353 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_354 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_355 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_970 = torch.ops.aten.view.default(getitem_506, [512, -1, 512]);  getitem_506 = None
        view_971 = torch.ops.aten.view.default(view_970, [200704, 512]);  view_970 = None
        triton_kernel_wrapper_functional_proxy_231 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 377, constant_args_idx = 542, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_971, 'P_ptr': empty_353, 'S_ptr': empty_354, 'M_ptr': empty_355, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_971 = empty_353 = empty_354 = empty_355 = None
        ...
        view_977 = torch.ops.aten.view.default(getitem_505, [512, 1024, 14, 14]);  getitem_505 = None
        add_171 = torch.ops.aten.add.Tensor(view_977, getitem_471);  view_977 = getitem_471 = None
        empty_356 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_980 = torch.ops.aten.view.default(getitem_511, [512, -1, 512]);  getitem_511 = None
        view_981 = torch.ops.aten.view.default(view_980, [200704, 512]);  view_980 = None
        ...
        convert_element_type_41 = torch.ops.prims.convert_element_type.default(primals_242, torch.bfloat16);  primals_242 = None
        empty_357 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_358 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_359 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_984 = torch.ops.aten.view.default(getitem_510, [512, -1, 512])
        view_985 = torch.ops.aten.view.default(view_984, [200704, 512]);  view_984 = None
        ...
        convolution_40 = torch.ops.aten.convolution.default(getitem_510, convert_element_type_41, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_172 = torch.ops.aten.add.Tensor(primals_243, 1)
        view_991 = torch.ops.aten.view.default(convolution_40, [512, 256, 196]);  convolution_40 = None
        triton_kernel_wrapper_functional_proxy_235 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 379, constant_args_idx = 546, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_991, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_360 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_117 = torch.ops.aten.permute.default(empty_360, [0, 1, 2]);  empty_360 = None
        empty_361 = torch.ops.aten.empty.memory_format([512, 256, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_118 = torch.ops.aten.permute.default(empty_361, [0, 1, 2]);  empty_361 = None
        triton_kernel_wrapper_functional_proxy_236 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 380, constant_args_idx = 547, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_991, 'MEAN': div_120, 'INVSTD': rsqrt_40, 'GAMMA': primals_244, 'BETA': primals_245, 'Y': permute_117, 'X_hat': permute_118, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_991 = div_120 = primals_245 = permute_117 = permute_118 = None
        ...
        empty_362 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_363 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_364 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_995 = torch.ops.aten.view.default(getitem_519, [512, -1, 512]);  getitem_519 = None
        view_996 = torch.ops.aten.view.default(view_995, [50176, 512]);  view_995 = None
        ...
        view_1002 = torch.ops.aten.view.default(getitem_518, [512, 256, 14, 14]);  getitem_518 = None
        empty_365 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_119 = torch.ops.aten.permute.default(empty_365, [0, 1, 2, 3]);  empty_365 = None
        triton_kernel_wrapper_functional_proxy_238 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 549, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1002, 'Y_ptr': permute_119, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1002 = permute_119 = None
        ...
        view_1005 = torch.ops.aten.view.default(getitem_524, [512, -1, 512]);  getitem_524 = None
        view_1006 = torch.ops.aten.view.default(view_1005, [50176, 512]);  view_1005 = None
        triton_kernel_wrapper_functional_proxy_239 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 550, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1006, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1006 = None
        getitem_525 = triton_kernel_wrapper_functional_proxy_239['P_ptr'];  triton_kernel_wrapper_functional_proxy_239 = None
        convert_element_type_42 = torch.ops.prims.convert_element_type.default(primals_248, torch.bfloat16);  primals_248 = None
        empty_366 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_367 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_368 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1009 = torch.ops.aten.view.default(getitem_523, [512, -1, 512])
        view_1010 = torch.ops.aten.view.default(view_1009, [50176, 512]);  view_1009 = None
        ...
        convolution_41 = torch.ops.aten.convolution.default(getitem_523, convert_element_type_42, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_523 = None
        add_176 = torch.ops.aten.add.Tensor(primals_249, 1)
        view_1016 = torch.ops.aten.view.default(convolution_41, [512, 256, 196]);  convolution_41 = None
        triton_kernel_wrapper_functional_proxy_241 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 383, constant_args_idx = 552, grid = [(256, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1016, 'SUM': full_default_18, 'SUMSQ': full_default_18, 'M': 100352, 'HW': 196, 'stride_n': 50176, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ']);  full_default_18 = None
        ...
        empty_371 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_372 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_373 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1020 = torch.ops.aten.view.default(getitem_532, [512, -1, 512]);  getitem_532 = None
        view_1021 = torch.ops.aten.view.default(view_1020, [50176, 512]);  view_1020 = None
        triton_kernel_wrapper_functional_proxy_243 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 385, constant_args_idx = 554, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1021, 'P_ptr': empty_371, 'S_ptr': empty_372, 'M_ptr': empty_373, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1021 = empty_371 = empty_372 = empty_373 = None
        ...
        view_1027 = torch.ops.aten.view.default(getitem_531, [512, 256, 14, 14]);  getitem_531 = None
        empty_374 = torch.ops.aten.empty.memory_format([512, 256, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_122 = torch.ops.aten.permute.default(empty_374, [0, 1, 2, 3]);  empty_374 = None
        triton_kernel_wrapper_functional_proxy_244 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 555, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1027, 'Y_ptr': permute_122, 'Mask_prt': full_default_150, 'n_elts': 25690112, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1027 = permute_122 = full_default_150 = None
        ...
        view_1030 = torch.ops.aten.view.default(getitem_537, [512, -1, 512]);  getitem_537 = None
        view_1031 = torch.ops.aten.view.default(view_1030, [50176, 512]);  view_1030 = None
        triton_kernel_wrapper_functional_proxy_245 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 556, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1031, 'P_ptr': full_default_151, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1031 = full_default_151 = None
        getitem_538 = triton_kernel_wrapper_functional_proxy_245['P_ptr'];  triton_kernel_wrapper_functional_proxy_245 = None
        convert_element_type_43 = torch.ops.prims.convert_element_type.default(primals_254, torch.bfloat16);  primals_254 = None
        empty_375 = torch.ops.aten.empty.memory_format([50176, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_376 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_377 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1034 = torch.ops.aten.view.default(getitem_536, [512, -1, 512])
        view_1035 = torch.ops.aten.view.default(view_1034, [50176, 512]);  view_1034 = None
        triton_kernel_wrapper_functional_proxy_246 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 386, constant_args_idx = 557, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1035, 'P_ptr': empty_375, 'S_ptr': empty_376, 'M_ptr': empty_377, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1035 = empty_375 = empty_376 = empty_377 = None
        ...
        convolution_42 = torch.ops.aten.convolution.default(getitem_536, convert_element_type_43, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_536 = None
        add_180 = torch.ops.aten.add.Tensor(primals_255, 1)
        view_1041 = torch.ops.aten.view.default(convolution_42, [512, 1024, 196]);  convolution_42 = None
        ...
        empty_378 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_123 = torch.ops.aten.permute.default(empty_378, [0, 1, 2]);  empty_378 = None
        empty_379 = torch.ops.aten.empty.memory_format([512, 1024, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_124 = torch.ops.aten.permute.default(empty_379, [0, 1, 2]);  empty_379 = None
        triton_kernel_wrapper_functional_proxy_248 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 388, constant_args_idx = 559, grid = [(1024, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1041, 'MEAN': div_126, 'INVSTD': rsqrt_42, 'GAMMA': primals_256, 'BETA': primals_257, 'Y': permute_123, 'X_hat': permute_124, 'M': 100352, 'HW': 196, 'stride_n': 200704, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1041 = div_126 = primals_257 = permute_123 = permute_124 = None
        ...
        empty_380 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_381 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_382 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1045 = torch.ops.aten.view.default(getitem_545, [512, -1, 512]);  getitem_545 = None
        view_1046 = torch.ops.aten.view.default(view_1045, [200704, 512]);  view_1045 = None
        triton_kernel_wrapper_functional_proxy_249 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 389, constant_args_idx = 560, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1046, 'P_ptr': empty_380, 'S_ptr': empty_381, 'M_ptr': empty_382, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1046 = empty_380 = empty_381 = empty_382 = None
        ...
        view_1052 = torch.ops.aten.view.default(getitem_544, [512, 1024, 14, 14]);  getitem_544 = None
        add_184 = torch.ops.aten.add.Tensor(view_1052, getitem_510);  view_1052 = getitem_510 = None
        empty_383 = torch.ops.aten.empty.memory_format([512, 1024, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1055 = torch.ops.aten.view.default(getitem_550, [512, -1, 512]);  getitem_550 = None
        view_1056 = torch.ops.aten.view.default(view_1055, [200704, 512]);  view_1055 = None
        triton_kernel_wrapper_functional_proxy_251 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 562, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1056, 'P_ptr': full_default_11, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1056 = full_default_11 = None
        getitem_551 = triton_kernel_wrapper_functional_proxy_251['P_ptr'];  triton_kernel_wrapper_functional_proxy_251 = None
        convert_element_type_44 = torch.ops.prims.convert_element_type.default(primals_260, torch.bfloat16);  primals_260 = None
        empty_384 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_385 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_386 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1059 = torch.ops.aten.view.default(getitem_549, [512, -1, 512])
        view_1060 = torch.ops.aten.view.default(view_1059, [200704, 512]);  view_1059 = None
        triton_kernel_wrapper_functional_proxy_252 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 390, constant_args_idx = 563, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1060, 'P_ptr': empty_384, 'S_ptr': empty_385, 'M_ptr': empty_386, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  empty_384 = empty_385 = empty_386 = None
        ...
        convolution_43 = torch.ops.aten.convolution.default(getitem_549, convert_element_type_44, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_185 = torch.ops.aten.add.Tensor(primals_261, 1)
        view_1066 = torch.ops.aten.view.default(convolution_43, [512, 512, 196]);  convolution_43 = None
        triton_kernel_wrapper_functional_proxy_253 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 391, constant_args_idx = 564, grid = [(512, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1066, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 100352, 'HW': 196, 'stride_n': 100352, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_387 = torch.ops.aten.empty.memory_format([512, 512, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_126 = torch.ops.aten.permute.default(empty_387, [0, 1, 2]);  empty_387 = None
        empty_388 = torch.ops.aten.empty.memory_format([512, 512, 196], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_127 = torch.ops.aten.permute.default(empty_388, [0, 1, 2]);  empty_388 = None
        triton_kernel_wrapper_functional_proxy_254 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 392, constant_args_idx = 565, grid = [(512, 98, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1066, 'MEAN': div_129, 'INVSTD': rsqrt_43, 'GAMMA': primals_262, 'BETA': primals_263, 'Y': permute_126, 'X_hat': permute_127, 'M': 100352, 'HW': 196, 'stride_n': 100352, 'stride_c': 196, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1066 = div_129 = primals_263 = permute_126 = permute_127 = None
        ...
        empty_389 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_390 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_391 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1070 = torch.ops.aten.view.default(getitem_558, [512, -1, 512]);  getitem_558 = None
        view_1071 = torch.ops.aten.view.default(view_1070, [100352, 512]);  view_1070 = None
        triton_kernel_wrapper_functional_proxy_255 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 393, constant_args_idx = 566, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1071, 'P_ptr': empty_389, 'S_ptr': empty_390, 'M_ptr': empty_391, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1071 = empty_389 = empty_390 = empty_391 = None
        ...
        full_default_256 = torch.ops.aten.full.default([512, 512, 14, 14], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_1077 = torch.ops.aten.view.default(getitem_557, [512, 512, 14, 14]);  getitem_557 = None
        empty_392 = torch.ops.aten.empty.memory_format([512, 512, 14, 14], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_128 = torch.ops.aten.permute.default(empty_392, [0, 1, 2, 3]);  empty_392 = None
        triton_kernel_wrapper_functional_proxy_256 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 567, grid = [(50176, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1077, 'Y_ptr': permute_128, 'Mask_prt': full_default_256, 'n_elts': 51380224, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1077 = permute_128 = full_default_256 = None
        ...
        view_1080 = torch.ops.aten.view.default(getitem_563, [512, -1, 512]);  getitem_563 = None
        view_1081 = torch.ops.aten.view.default(view_1080, [100352, 512]);  view_1080 = None
        triton_kernel_wrapper_functional_proxy_257 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 568, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1081, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1081 = None
        getitem_564 = triton_kernel_wrapper_functional_proxy_257['P_ptr'];  triton_kernel_wrapper_functional_proxy_257 = None
        convert_element_type_45 = torch.ops.prims.convert_element_type.default(primals_266, torch.bfloat16);  primals_266 = None
        empty_393 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_394 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_395 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1084 = torch.ops.aten.view.default(getitem_562, [512, -1, 512])
        view_1085 = torch.ops.aten.view.default(view_1084, [100352, 512]);  view_1084 = None
        triton_kernel_wrapper_functional_proxy_258 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 394, constant_args_idx = 569, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1085, 'P_ptr': empty_393, 'S_ptr': empty_394, 'M_ptr': empty_395, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1085 = empty_393 = empty_394 = empty_395 = None
        ...
        convolution_44 = torch.ops.aten.convolution.default(getitem_562, convert_element_type_45, None, [2, 2], [1, 1], [1, 1], False, [0, 0], 1);  getitem_562 = None
        add_189 = torch.ops.aten.add.Tensor(primals_267, 1)
        view_1091 = torch.ops.aten.view.default(convolution_44, [512, 512, 49]);  convolution_44 = None
        triton_kernel_wrapper_functional_proxy_259 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 395, constant_args_idx = 570, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1091, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        full_default_260 = torch.ops.aten.full.default([], 25088.0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        full_default_261 = torch.ops.aten.full.default([], 1.00003981590271, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        empty_396 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_129 = torch.ops.aten.permute.default(empty_396, [0, 1, 2]);  empty_396 = None
        empty_397 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_130 = torch.ops.aten.permute.default(empty_397, [0, 1, 2]);  empty_397 = None
        triton_kernel_wrapper_functional_proxy_260 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 396, constant_args_idx = 571, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1091, 'MEAN': div_132, 'INVSTD': rsqrt_44, 'GAMMA': primals_268, 'BETA': primals_269, 'Y': permute_129, 'X_hat': permute_130, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1091 = div_132 = primals_269 = permute_129 = permute_130 = None
        ...
        empty_398 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_399 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_400 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1095 = torch.ops.aten.view.default(getitem_571, [512, -1, 512]);  getitem_571 = None
        view_1096 = torch.ops.aten.view.default(view_1095, [25088, 512]);  view_1095 = None
        triton_kernel_wrapper_functional_proxy_261 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 397, constant_args_idx = 572, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1096, 'P_ptr': empty_398, 'S_ptr': empty_399, 'M_ptr': empty_400, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1096 = empty_398 = empty_399 = empty_400 = None
        ...
        full_default_262 = torch.ops.aten.full.default([512, 512, 7, 7], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_1102 = torch.ops.aten.view.default(getitem_570, [512, 512, 7, 7]);  getitem_570 = None
        empty_401 = torch.ops.aten.empty.memory_format([512, 512, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_131 = torch.ops.aten.permute.default(empty_401, [0, 1, 2, 3]);  empty_401 = None
        triton_kernel_wrapper_functional_proxy_262 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 573, grid = [(12544, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1102, 'Y_ptr': permute_131, 'Mask_prt': full_default_262, 'n_elts': 12845056, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1102 = permute_131 = None
        ...
        full_default_263 = torch.ops.aten.full.default([25088, 16], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_1105 = torch.ops.aten.view.default(getitem_576, [512, -1, 512]);  getitem_576 = None
        view_1106 = torch.ops.aten.view.default(view_1105, [25088, 512]);  view_1105 = None
        triton_kernel_wrapper_functional_proxy_263 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 574, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1106, 'P_ptr': full_default_263, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1106 = None
        getitem_577 = triton_kernel_wrapper_functional_proxy_263['P_ptr'];  triton_kernel_wrapper_functional_proxy_263 = None
        convert_element_type_46 = torch.ops.prims.convert_element_type.default(primals_272, torch.bfloat16);  primals_272 = None
        empty_402 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_403 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_404 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1109 = torch.ops.aten.view.default(getitem_575, [512, -1, 512])
        view_1110 = torch.ops.aten.view.default(view_1109, [25088, 512]);  view_1109 = None
        triton_kernel_wrapper_functional_proxy_264 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 398, constant_args_idx = 575, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1110, 'P_ptr': empty_402, 'S_ptr': empty_403, 'M_ptr': empty_404, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1110 = empty_402 = empty_403 = empty_404 = None
        ...
        convolution_45 = torch.ops.aten.convolution.default(getitem_575, convert_element_type_46, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_575 = None
        add_193 = torch.ops.aten.add.Tensor(primals_273, 1)
        view_1116 = torch.ops.aten.view.default(convolution_45, [512, 2048, 49]);  convolution_45 = None
        ...
        empty_407 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_408 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_409 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1120 = torch.ops.aten.view.default(getitem_584, [512, -1, 512]);  getitem_584 = None
        view_1121 = torch.ops.aten.view.default(view_1120, [100352, 512]);  view_1120 = None
        triton_kernel_wrapper_functional_proxy_267 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 401, constant_args_idx = 578, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1121, 'P_ptr': empty_407, 'S_ptr': empty_408, 'M_ptr': empty_409, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1121 = empty_407 = empty_408 = empty_409 = None
        ...
        convert_element_type_47 = torch.ops.prims.convert_element_type.default(primals_278, torch.bfloat16);  primals_278 = None
        empty_410 = torch.ops.aten.empty.memory_format([200704, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_411 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_412 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy_268 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 402, constant_args_idx = 579, grid = [(200704, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1060, 'P_ptr': empty_410, 'S_ptr': empty_411, 'M_ptr': empty_412, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1060 = empty_410 = empty_411 = empty_412 = None
        ...
        convolution_46 = torch.ops.aten.convolution.default(getitem_549, convert_element_type_47, None, [2, 2], [0, 0], [1, 1], False, [0, 0], 1);  getitem_549 = None
        add_197 = torch.ops.aten.add.Tensor(primals_279, 1)
        view_1136 = torch.ops.aten.view.default(convolution_46, [512, 2048, 49]);  convolution_46 = None
        ...
        empty_413 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_134 = torch.ops.aten.permute.default(empty_413, [0, 1, 2]);  empty_413 = None
        empty_414 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_135 = torch.ops.aten.permute.default(empty_414, [0, 1, 2]);  empty_414 = None
        triton_kernel_wrapper_functional_proxy_270 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 404, constant_args_idx = 581, grid = [(2048, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1136, 'MEAN': div_138, 'INVSTD': rsqrt_46, 'GAMMA': primals_280, 'BETA': primals_281, 'Y': permute_134, 'X_hat': permute_135, 'M': 25088, 'HW': 49, 'stride_n': 100352, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1136 = div_138 = primals_281 = permute_134 = permute_135 = None
        ...
        empty_415 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_416 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_417 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1140 = torch.ops.aten.view.default(getitem_594, [512, -1, 512]);  getitem_594 = None
        view_1141 = torch.ops.aten.view.default(view_1140, [100352, 512]);  view_1140 = None
        triton_kernel_wrapper_functional_proxy_271 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 405, constant_args_idx = 582, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1141, 'P_ptr': empty_415, 'S_ptr': empty_416, 'M_ptr': empty_417, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1141 = empty_415 = empty_416 = empty_417 = None
        ...
        view_1147 = torch.ops.aten.view.default(getitem_583, [512, 2048, 7, 7]);  getitem_583 = None
        view_1148 = torch.ops.aten.view.default(getitem_593, [512, 2048, 7, 7]);  getitem_593 = None
        add_201 = torch.ops.aten.add.Tensor(view_1147, view_1148);  view_1147 = view_1148 = None
        full_default_272 = torch.ops.aten.full.default([512, 2048, 7, 7], 0, dtype = torch.int8, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        empty_418 = torch.ops.aten.empty.memory_format([512, 2048, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1151 = torch.ops.aten.view.default(getitem_599, [512, -1, 512]);  getitem_599 = None
        view_1152 = torch.ops.aten.view.default(view_1151, [100352, 512]);  view_1151 = None
        triton_kernel_wrapper_functional_proxy_273 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 584, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1152, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1152 = None
        getitem_600 = triton_kernel_wrapper_functional_proxy_273['P_ptr'];  triton_kernel_wrapper_functional_proxy_273 = None
        convert_element_type_48 = torch.ops.prims.convert_element_type.default(primals_284, torch.bfloat16);  primals_284 = None
        empty_419 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_420 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_421 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1155 = torch.ops.aten.view.default(getitem_598, [512, -1, 512])
        view_1156 = torch.ops.aten.view.default(view_1155, [100352, 512]);  view_1155 = None
        triton_kernel_wrapper_functional_proxy_274 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 406, constant_args_idx = 585, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1156, 'P_ptr': empty_419, 'S_ptr': empty_420, 'M_ptr': empty_421, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1156 = empty_419 = empty_420 = empty_421 = None
        ...
        convolution_47 = torch.ops.aten.convolution.default(getitem_598, convert_element_type_48, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_202 = torch.ops.aten.add.Tensor(primals_285, 1)
        view_1162 = torch.ops.aten.view.default(convolution_47, [512, 512, 49]);  convolution_47 = None
        triton_kernel_wrapper_functional_proxy_275 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 407, constant_args_idx = 586, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1162, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_422 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_137 = torch.ops.aten.permute.default(empty_422, [0, 1, 2]);  empty_422 = None
        empty_423 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_138 = torch.ops.aten.permute.default(empty_423, [0, 1, 2]);  empty_423 = None
        triton_kernel_wrapper_functional_proxy_276 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 408, constant_args_idx = 587, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1162, 'MEAN': div_141, 'INVSTD': rsqrt_47, 'GAMMA': primals_286, 'BETA': primals_287, 'Y': permute_137, 'X_hat': permute_138, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1162 = div_141 = primals_287 = permute_137 = permute_138 = None
        ...
        empty_424 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_425 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_426 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1166 = torch.ops.aten.view.default(getitem_607, [512, -1, 512]);  getitem_607 = None
        view_1167 = torch.ops.aten.view.default(view_1166, [25088, 512]);  view_1166 = None
        ...
        view_1173 = torch.ops.aten.view.default(getitem_606, [512, 512, 7, 7]);  getitem_606 = None
        empty_427 = torch.ops.aten.empty.memory_format([512, 512, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_139 = torch.ops.aten.permute.default(empty_427, [0, 1, 2, 3]);  empty_427 = None
        triton_kernel_wrapper_functional_proxy_278 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 589, grid = [(12544, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1173, 'Y_ptr': permute_139, 'Mask_prt': full_default_262, 'n_elts': 12845056, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1173 = permute_139 = None
        ...
        view_1176 = torch.ops.aten.view.default(getitem_612, [512, -1, 512]);  getitem_612 = None
        view_1177 = torch.ops.aten.view.default(view_1176, [25088, 512]);  view_1176 = None
        triton_kernel_wrapper_functional_proxy_279 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 590, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1177, 'P_ptr': full_default_263, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1177 = None
        getitem_613 = triton_kernel_wrapper_functional_proxy_279['P_ptr'];  triton_kernel_wrapper_functional_proxy_279 = None
        convert_element_type_49 = torch.ops.prims.convert_element_type.default(primals_290, torch.bfloat16);  primals_290 = None
        empty_428 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_429 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_430 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1180 = torch.ops.aten.view.default(getitem_611, [512, -1, 512])
        view_1181 = torch.ops.aten.view.default(view_1180, [25088, 512]);  view_1180 = None
        triton_kernel_wrapper_functional_proxy_280 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 410, constant_args_idx = 591, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1181, 'P_ptr': empty_428, 'S_ptr': empty_429, 'M_ptr': empty_430, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1181 = empty_428 = empty_429 = empty_430 = None
        ...
        convolution_48 = torch.ops.aten.convolution.default(getitem_611, convert_element_type_49, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_611 = None
        add_206 = torch.ops.aten.add.Tensor(primals_291, 1)
        view_1187 = torch.ops.aten.view.default(convolution_48, [512, 512, 49]);  convolution_48 = None
        triton_kernel_wrapper_functional_proxy_281 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 411, constant_args_idx = 592, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1187, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_431 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_140 = torch.ops.aten.permute.default(empty_431, [0, 1, 2]);  empty_431 = None
        empty_432 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_141 = torch.ops.aten.permute.default(empty_432, [0, 1, 2]);  empty_432 = None
        triton_kernel_wrapper_functional_proxy_282 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 412, constant_args_idx = 593, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1187, 'MEAN': div_144, 'INVSTD': rsqrt_48, 'GAMMA': primals_292, 'BETA': primals_293, 'Y': permute_140, 'X_hat': permute_141, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1187 = div_144 = primals_293 = permute_140 = permute_141 = None
        ...
        empty_433 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_434 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_435 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1191 = torch.ops.aten.view.default(getitem_620, [512, -1, 512]);  getitem_620 = None
        view_1192 = torch.ops.aten.view.default(view_1191, [25088, 512]);  view_1191 = None
        triton_kernel_wrapper_functional_proxy_283 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 413, constant_args_idx = 594, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1192, 'P_ptr': empty_433, 'S_ptr': empty_434, 'M_ptr': empty_435, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1192 = empty_433 = empty_434 = empty_435 = None
        ...
        view_1198 = torch.ops.aten.view.default(getitem_619, [512, 512, 7, 7]);  getitem_619 = None
        empty_436 = torch.ops.aten.empty.memory_format([512, 512, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_142 = torch.ops.aten.permute.default(empty_436, [0, 1, 2, 3]);  empty_436 = None
        triton_kernel_wrapper_functional_proxy_284 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 595, grid = [(12544, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1198, 'Y_ptr': permute_142, 'Mask_prt': full_default_262, 'n_elts': 12845056, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1198 = permute_142 = None
        ...
        view_1201 = torch.ops.aten.view.default(getitem_625, [512, -1, 512]);  getitem_625 = None
        view_1202 = torch.ops.aten.view.default(view_1201, [25088, 512]);  view_1201 = None
        triton_kernel_wrapper_functional_proxy_285 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 596, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1202, 'P_ptr': full_default_263, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1202 = None
        getitem_626 = triton_kernel_wrapper_functional_proxy_285['P_ptr'];  triton_kernel_wrapper_functional_proxy_285 = None
        convert_element_type_50 = torch.ops.prims.convert_element_type.default(primals_296, torch.bfloat16);  primals_296 = None
        empty_437 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_438 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_439 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1205 = torch.ops.aten.view.default(getitem_624, [512, -1, 512])
        view_1206 = torch.ops.aten.view.default(view_1205, [25088, 512]);  view_1205 = None
        triton_kernel_wrapper_functional_proxy_286 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 414, constant_args_idx = 597, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1206, 'P_ptr': empty_437, 'S_ptr': empty_438, 'M_ptr': empty_439, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1206 = empty_437 = empty_438 = empty_439 = None
        ...
        convolution_49 = torch.ops.aten.convolution.default(getitem_624, convert_element_type_50, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_624 = None
        add_210 = torch.ops.aten.add.Tensor(primals_297, 1)
        view_1212 = torch.ops.aten.view.default(convolution_49, [512, 2048, 49]);  convolution_49 = None
        ...
        empty_440 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_143 = torch.ops.aten.permute.default(empty_440, [0, 1, 2]);  empty_440 = None
        empty_441 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_144 = torch.ops.aten.permute.default(empty_441, [0, 1, 2]);  empty_441 = None
        triton_kernel_wrapper_functional_proxy_288 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 416, constant_args_idx = 599, grid = [(2048, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1212, 'MEAN': div_147, 'INVSTD': rsqrt_49, 'GAMMA': primals_298, 'BETA': primals_299, 'Y': permute_143, 'X_hat': permute_144, 'M': 25088, 'HW': 49, 'stride_n': 100352, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1212 = div_147 = primals_299 = permute_143 = permute_144 = None
        ...
        empty_442 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_443 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_444 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1216 = torch.ops.aten.view.default(getitem_633, [512, -1, 512]);  getitem_633 = None
        view_1217 = torch.ops.aten.view.default(view_1216, [100352, 512]);  view_1216 = None
        triton_kernel_wrapper_functional_proxy_289 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 417, constant_args_idx = 600, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1217, 'P_ptr': empty_442, 'S_ptr': empty_443, 'M_ptr': empty_444, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1217 = empty_442 = empty_443 = empty_444 = None
        ...
        view_1223 = torch.ops.aten.view.default(getitem_632, [512, 2048, 7, 7]);  getitem_632 = None
        add_214 = torch.ops.aten.add.Tensor(view_1223, getitem_598);  view_1223 = getitem_598 = None
        empty_445 = torch.ops.aten.empty.memory_format([512, 2048, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1226 = torch.ops.aten.view.default(getitem_638, [512, -1, 512]);  getitem_638 = None
        view_1227 = torch.ops.aten.view.default(view_1226, [100352, 512]);  view_1226 = None
        triton_kernel_wrapper_functional_proxy_291 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 602, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1227, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1227 = None
        getitem_639 = triton_kernel_wrapper_functional_proxy_291['P_ptr'];  triton_kernel_wrapper_functional_proxy_291 = None
        convert_element_type_51 = torch.ops.prims.convert_element_type.default(primals_302, torch.bfloat16);  primals_302 = None
        empty_446 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_447 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_448 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1230 = torch.ops.aten.view.default(getitem_637, [512, -1, 512])
        view_1231 = torch.ops.aten.view.default(view_1230, [100352, 512]);  view_1230 = None
        triton_kernel_wrapper_functional_proxy_292 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 418, constant_args_idx = 603, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1231, 'P_ptr': empty_446, 'S_ptr': empty_447, 'M_ptr': empty_448, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1231 = empty_446 = empty_447 = empty_448 = None
        ...
        convolution_50 = torch.ops.aten.convolution.default(getitem_637, convert_element_type_51, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1)
        add_215 = torch.ops.aten.add.Tensor(primals_303, 1)
        view_1237 = torch.ops.aten.view.default(convolution_50, [512, 512, 49]);  convolution_50 = None
        triton_kernel_wrapper_functional_proxy_293 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 419, constant_args_idx = 604, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1237, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ'])
        ...
        empty_449 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_146 = torch.ops.aten.permute.default(empty_449, [0, 1, 2]);  empty_449 = None
        empty_450 = torch.ops.aten.empty.memory_format([512, 512, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_147 = torch.ops.aten.permute.default(empty_450, [0, 1, 2]);  empty_450 = None
        triton_kernel_wrapper_functional_proxy_294 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 420, constant_args_idx = 605, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1237, 'MEAN': div_150, 'INVSTD': rsqrt_50, 'GAMMA': primals_304, 'BETA': primals_305, 'Y': permute_146, 'X_hat': permute_147, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1237 = div_150 = primals_305 = permute_146 = permute_147 = None
        ...
        empty_451 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_452 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_453 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1241 = torch.ops.aten.view.default(getitem_646, [512, -1, 512]);  getitem_646 = None
        view_1242 = torch.ops.aten.view.default(view_1241, [25088, 512]);  view_1241 = None
        ...
        view_1248 = torch.ops.aten.view.default(getitem_645, [512, 512, 7, 7]);  getitem_645 = None
        empty_454 = torch.ops.aten.empty.memory_format([512, 512, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_148 = torch.ops.aten.permute.default(empty_454, [0, 1, 2, 3]);  empty_454 = None
        triton_kernel_wrapper_functional_proxy_296 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 607, grid = [(12544, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1248, 'Y_ptr': permute_148, 'Mask_prt': full_default_262, 'n_elts': 12845056, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1248 = permute_148 = None
        ...
        view_1251 = torch.ops.aten.view.default(getitem_651, [512, -1, 512]);  getitem_651 = None
        view_1252 = torch.ops.aten.view.default(view_1251, [25088, 512]);  view_1251 = None
        triton_kernel_wrapper_functional_proxy_297 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 608, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1252, 'P_ptr': full_default_263, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1252 = None
        getitem_652 = triton_kernel_wrapper_functional_proxy_297['P_ptr'];  triton_kernel_wrapper_functional_proxy_297 = None
        convert_element_type_52 = torch.ops.prims.convert_element_type.default(primals_308, torch.bfloat16);  primals_308 = None
        empty_455 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_456 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_457 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1255 = torch.ops.aten.view.default(getitem_650, [512, -1, 512])
        view_1256 = torch.ops.aten.view.default(view_1255, [25088, 512]);  view_1255 = None
        triton_kernel_wrapper_functional_proxy_298 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 422, constant_args_idx = 609, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1256, 'P_ptr': empty_455, 'S_ptr': empty_456, 'M_ptr': empty_457, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1256 = empty_455 = empty_456 = empty_457 = None
        ...
        convolution_51 = torch.ops.aten.convolution.default(getitem_650, convert_element_type_52, None, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  getitem_650 = None
        add_219 = torch.ops.aten.add.Tensor(primals_309, 1)
        view_1262 = torch.ops.aten.view.default(convolution_51, [512, 512, 49]);  convolution_51 = None
        triton_kernel_wrapper_functional_proxy_299 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 423, constant_args_idx = 610, grid = [(512, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1262, 'SUM': full_default_76, 'SUMSQ': full_default_76, 'M': 25088, 'HW': 49, 'stride_n': 25088, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['SUM', 'SUMSQ']);  full_default_76 = None
        ...
        empty_460 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_461 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_462 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1266 = torch.ops.aten.view.default(getitem_659, [512, -1, 512]);  getitem_659 = None
        view_1267 = torch.ops.aten.view.default(view_1266, [25088, 512]);  view_1266 = None
        ...
        view_1273 = torch.ops.aten.view.default(getitem_658, [512, 512, 7, 7]);  getitem_658 = None
        empty_463 = torch.ops.aten.empty.memory_format([512, 512, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_151 = torch.ops.aten.permute.default(empty_463, [0, 1, 2, 3]);  empty_463 = None
        triton_kernel_wrapper_functional_proxy_302 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 7, constant_args_idx = 613, grid = [(12544, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1273, 'Y_ptr': permute_151, 'Mask_prt': full_default_262, 'n_elts': 12845056, 'BLOCK_SIZE': 1024}, tensors_to_clone = ['Y_ptr', 'Mask_prt']);  view_1273 = permute_151 = full_default_262 = None
        ...
        view_1276 = torch.ops.aten.view.default(getitem_664, [512, -1, 512]);  getitem_664 = None
        view_1277 = torch.ops.aten.view.default(view_1276, [25088, 512]);  view_1276 = None
        triton_kernel_wrapper_functional_proxy_303 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 614, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1277, 'P_ptr': full_default_263, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1277 = full_default_263 = None
        getitem_665 = triton_kernel_wrapper_functional_proxy_303['P_ptr'];  triton_kernel_wrapper_functional_proxy_303 = None
        convert_element_type_53 = torch.ops.prims.convert_element_type.default(primals_314, torch.bfloat16);  primals_314 = None
        empty_464 = torch.ops.aten.empty.memory_format([25088, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_465 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_466 = torch.ops.aten.empty.memory_format([25088], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1280 = torch.ops.aten.view.default(getitem_663, [512, -1, 512])
        view_1281 = torch.ops.aten.view.default(view_1280, [25088, 512]);  view_1280 = None
        triton_kernel_wrapper_functional_proxy_304 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 426, constant_args_idx = 615, grid = [(25088, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1281, 'P_ptr': empty_464, 'S_ptr': empty_465, 'M_ptr': empty_466, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1281 = empty_464 = empty_465 = empty_466 = None
        ...
        convolution_52 = torch.ops.aten.convolution.default(getitem_663, convert_element_type_53, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  getitem_663 = None
        add_223 = torch.ops.aten.add.Tensor(primals_315, 1)
        view_1287 = torch.ops.aten.view.default(convolution_52, [512, 2048, 49]);  convolution_52 = None
        ...
        empty_467 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_152 = torch.ops.aten.permute.default(empty_467, [0, 1, 2]);  empty_467 = None
        empty_468 = torch.ops.aten.empty.memory_format([512, 2048, 49], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        permute_153 = torch.ops.aten.permute.default(empty_468, [0, 1, 2]);  empty_468 = None
        triton_kernel_wrapper_functional_proxy_306 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 428, constant_args_idx = 617, grid = [(2048, 25, 1)], tma_descriptor_metadata = {}, kwargs = {'X': view_1287, 'MEAN': div_156, 'INVSTD': rsqrt_52, 'GAMMA': primals_316, 'BETA': primals_317, 'Y': permute_152, 'X_hat': permute_153, 'M': 25088, 'HW': 49, 'stride_n': 100352, 'stride_c': 49, 'BLOCK_M': 1024}, tensors_to_clone = ['Y', 'X_hat']);  view_1287 = div_156 = primals_317 = permute_152 = permute_153 = None
        ...
        empty_469 = torch.ops.aten.empty.memory_format([100352, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_470 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_471 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1291 = torch.ops.aten.view.default(getitem_672, [512, -1, 512]);  getitem_672 = None
        view_1292 = torch.ops.aten.view.default(view_1291, [100352, 512]);  view_1291 = None
        triton_kernel_wrapper_functional_proxy_307 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 429, constant_args_idx = 618, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1292, 'P_ptr': empty_469, 'S_ptr': empty_470, 'M_ptr': empty_471, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1292 = empty_469 = empty_470 = empty_471 = None
        ...
        view_1298 = torch.ops.aten.view.default(getitem_671, [512, 2048, 7, 7]);  getitem_671 = None
        add_227 = torch.ops.aten.add.Tensor(view_1298, getitem_637);  view_1298 = getitem_637 = None
        empty_472 = torch.ops.aten.empty.memory_format([512, 2048, 7, 7], dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1301 = torch.ops.aten.view.default(getitem_677, [512, -1, 512]);  getitem_677 = None
        view_1302 = torch.ops.aten.view.default(view_1301, [100352, 512]);  view_1301 = None
        triton_kernel_wrapper_functional_proxy_309 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 8, constant_args_idx = 620, grid = [(100352, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1302, 'P_ptr': full_default_75, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 1, 'VPW': 32, 'NWORDS': 16}, tensors_to_clone = ['P_ptr']);  view_1302 = full_default_75 = None
        ...
        view_1303 = torch.ops.aten.view.default(mean, [512, 2048]);  mean = None
        view_1304 = torch.ops.aten.view.default(view_1303, [512, -1, 512])
        view_1305 = torch.ops.aten.view.default(view_1304, [2048, 512]);  view_1304 = None
        empty_473 = torch.ops.aten.empty.memory_format([2048, 32], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_474 = torch.ops.aten.empty.memory_format([2048], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_475 = torch.ops.aten.empty.memory_format([2048], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        triton_kernel_wrapper_functional_proxy_310 = torch.ops.higher_order.triton_kernel_wrapper_functional(kernel_idx = 430, constant_args_idx = 621, grid = [(2048, 1, 1)], tma_descriptor_metadata = {}, kwargs = {'X_ptr': view_1305, 'P_ptr': empty_473, 'S_ptr': empty_474, 'M_ptr': empty_475, 'stride_x0': 512, 'stride_x1': 1, 'stride_p0': 32, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 32, 'QMAX': 3}, tensors_to_clone = ['P_ptr', 'S_ptr', 'M_ptr']);  view_1305 = empty_473 = empty_474 = empty_475 = None
        ...
        convert_element_type_54 = torch.ops.prims.convert_element_type.default(primals_320, torch.bfloat16);  primals_320 = None
        permute_155 = torch.ops.aten.permute.default(convert_element_type_54, [1, 0])
...
def load_args(reader):
    ...
    buf1 = reader.storage(None, 308281344, device=device(type='cuda', index=0))
    reader.tensor(buf1, (512, 3, 224, 224), is_leaf=True)  # primals_2
