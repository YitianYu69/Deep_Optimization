...
# kernel path: /tmp/torchinductor_yyu496/eh/cehwutxvnvwgg2wegg2gkkifogj2iw7gywtxvj66lf7tzckneyxg.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
#    => triton_kernel_wrapper_mutation_310
# Graph fragment:
#   %triton_kernel_wrapper_mutation_310 : [num_users=0] = call_function[target=torch.ops.higher_order.triton_kernel_wrapper_mutation](args = (), kwargs = {kernel_idx: 218, constant_args_idx: 311, grid: [(301056, 1, 1)], tma_descriptor_metadata: {}, kwargs: {X_ptr: %view_3, P_ptr: %empty, S_ptr: %empty_1, M_ptr: %empty_2, stride_x0: 256, stride_x1: 1, stride_p0: 16, stride_p1: 1, BITS: 2, VPW: 16, NWORDS: 16, QMAX: 3}})
...
def triton_poi_fused_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x1 = xindex // 256
    x2 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 256*x1 + 150528*((x0 + 256*((x1 % 588))) // 150528)), None)
    tmp1 = tmp0.to(tl.float32)
    tl.store(out_ptr0 + (x2), tmp1, None)
''', device_str='cuda')


# Original path: /home/hice1/yyu496/kaggle/CW/ACT5/act_triton_kernel.py:11
...
@triton_heuristics.user_autotune(
    ...
    triton_meta={'signature': {'X_ptr': '*bf16', 'P_ptr': '*i32', 'S_ptr': '*bf16', 'M_ptr': '*bf16', 'stride_x0': 'constexpr', 'stride_x1': 'constexpr', 'stride_p0': 'constexpr', 'stride_p1': 'constexpr', 'BITS': 'constexpr', 'VPW': 'constexpr', 'NWORDS': 'constexpr', 'QMAX': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {'stride_x0': 256, 'stride_x1': 1, 'stride_p0': 16, 'stride_p1': 1, 'BITS': 2, 'VPW': 16, 'NWORDS': 16, 'QMAX': 3}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    filename=__file__,
    custom_kernel=True,
)
@triton.jit
...
# Original path: /home/hice1/yyu496/kaggle/CW/ACT5/ops.py:450
...
# Original path: /home/hice1/yyu496/kaggle/CW/ACT5/ops.py:476
...
# Original path: /home/hice1/yyu496/kaggle/CW/ACT5/ops.py:920
...
#   relu => full_default_5
# Graph fragment:
#   %full_default_5 : [num_users=5] = call_function[target=torch.ops.aten.full.default](args = ([1605632, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# Original path: /home/hice1/yyu496/kaggle/CW/ACT5/act_triton_kernel.py:143
...
# Graph fragment:
#   %full_default_11 : [num_users=14] = call_function[target=torch.ops.aten.full.default](args = ([401408, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# Graph fragment:
#   %full_default_69 : [num_users=6] = call_function[target=torch.ops.aten.full.default](args = ([802816, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# Graph fragment:
#   %full_default_75 : [num_users=12] = call_function[target=torch.ops.aten.full.default](args = ([200704, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# Graph fragment:
#   %full_default_151 : [num_users=12] = call_function[target=torch.ops.aten.full.default](args = ([100352, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# Graph fragment:
#   %full_default_263 : [num_users=6] = call_function[target=torch.ops.aten.full.default](args = ([50176, 8], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %view_1613 : [num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mean, [512, 2048]), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty_strided_cuda((301056, 16), (16, 1), torch.int32)
        buf1 = empty_strided_cuda((301056, ), (1, ), torch.bfloat16)
        buf2 = empty_strided_cuda((301056, ), (1, ), torch.bfloat16)
        buf3 = empty_strided_cuda((301056, 256), (256, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_0.run(primals_2, buf3, 77070336, stream=stream0)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(buf3, buf0, buf1, buf2, 256, 1, 16, 1, 2, 16, 16, 3, 301056, 1, 1, stream=stream0)
        ...
        del primals_5
        buf23 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf24 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf25 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf18, (1605632, 256), (256, 1), 0), buf23, buf24, buf25, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        buf35 = empty_strided_cuda((1605632, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [relu], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf32, (1605632, 256), (256, 1), 0), reinterpret_tensor(buf36, (1605632, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 1605632, 1, 1, stream=stream0)
        ...
        del primals_8
        buf41 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf42 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf43 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf38, (401408, 256), (256, 1), 0), buf41, buf42, buf43, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf57
        del primals_11
        buf61 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf62 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf63 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf56, (401408, 256), (256, 1), 0), buf61, buf62, buf63, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        buf72 = empty_strided_cuda((401408, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [layer1_0_relu], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf69, (401408, 256), (256, 1), 0), reinterpret_tensor(buf73, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_14
        buf76 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf77 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf78 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf68, (401408, 256), (256, 1), 0), buf76, buf77, buf78, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf92
        del primals_17
        buf96 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf97 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf98 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf91, (401408, 256), (256, 1), 0), buf96, buf97, buf98, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf103, (401408, 256), (256, 1), 0), reinterpret_tensor(buf106, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_20
        buf109 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf110 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf111 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf102, (401408, 256), (256, 1), 0), buf109, buf110, buf111, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_23
        buf130 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf131 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf132 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf125, (1605632, 256), (256, 1), 0), buf130, buf131, buf132, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        del primals_26
        buf137 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf138 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf139 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf38, (401408, 256), (256, 1), 0), buf137, buf138, buf139, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_29
        buf157 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf158 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf159 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf152, (1605632, 256), (256, 1), 0), buf157, buf158, buf159, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf165, (1605632, 256), (256, 1), 0), reinterpret_tensor(buf169, (1605632, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 1605632, 1, 1, stream=stream0)
        ...
        del primals_32
        buf172 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf173 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf174 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf164, (1605632, 256), (256, 1), 0), buf172, buf173, buf174, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        del buf188
        del primals_35
        buf192 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf193 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf194 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf187, (401408, 256), (256, 1), 0), buf192, buf193, buf194, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf199, (401408, 256), (256, 1), 0), reinterpret_tensor(buf202, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_38
        buf205 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf206 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf207 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf198, (401408, 256), (256, 1), 0), buf205, buf206, buf207, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf221
        del primals_41
        buf225 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf226 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf227 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf220, (401408, 256), (256, 1), 0), buf225, buf226, buf227, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf232, (401408, 256), (256, 1), 0), reinterpret_tensor(buf235, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_44
        buf238 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf239 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf240 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf231, (401408, 256), (256, 1), 0), buf238, buf239, buf240, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_47
        buf258 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf259 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf260 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf253, (1605632, 256), (256, 1), 0), buf258, buf259, buf260, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf265, (1605632, 256), (256, 1), 0), reinterpret_tensor(buf269, (1605632, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 1605632, 1, 1, stream=stream0)
        ...
        del primals_50
        buf272 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf273 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf274 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf264, (1605632, 256), (256, 1), 0), buf272, buf273, buf274, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        del buf288
        del primals_53
        buf292 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf293 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf294 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf287, (401408, 256), (256, 1), 0), buf292, buf293, buf294, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf299, (401408, 256), (256, 1), 0), reinterpret_tensor(buf302, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_56
        buf305 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf306 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf307 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf298, (401408, 256), (256, 1), 0), buf305, buf306, buf307, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf321
        del primals_59
        buf324 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf325 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf326 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf319, (401408, 256), (256, 1), 0), buf324, buf325, buf326, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf67, (401408, 256), (256, 1), 0), reinterpret_tensor(buf333, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_62
        buf336 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf337 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf338 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf330, (401408, 256), (256, 1), 0), buf336, buf337, buf338, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_65
        buf356 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf357 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf358 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf351, (1605632, 256), (256, 1), 0), buf356, buf357, buf358, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf163, (1605632, 256), (256, 1), 0), buf35, 256, 1, 8, 1, 1, 32, 8, 1605632, 1, 1, stream=stream0)
        del buf163
        ...
        del primals_68
        buf368 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf369 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf370 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf362, (1605632, 256), (256, 1), 0), buf368, buf369, buf370, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        del buf385
        del primals_71
        buf389 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf390 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf391 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf384, (802816, 256), (256, 1), 0), buf389, buf390, buf391, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        buf399 = empty_strided_cuda((802816, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [layer2_0_relu], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf396, (802816, 256), (256, 1), 0), reinterpret_tensor(buf400, (802816, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 802816, 1, 1, stream=stream0)
        ...
        del primals_74
        buf403 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf404 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf405 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf395, (802816, 256), (256, 1), 0), buf403, buf404, buf405, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del buf419
        del primals_77
        buf423 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf424 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf425 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf418, (200704, 256), (256, 1), 0), buf423, buf424, buf425, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        buf434 = empty_strided_cuda((200704, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [layer2_0_relu_1], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf431, (200704, 256), (256, 1), 0), reinterpret_tensor(buf435, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_80
        buf438 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf439 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf440 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf430, (200704, 256), (256, 1), 0), buf438, buf439, buf440, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del primals_83
        buf459 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf460 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf461 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf454, (802816, 256), (256, 1), 0), buf459, buf460, buf461, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del primals_86
        buf466 = empty_strided_cuda((1605632, 16), (16, 1), torch.int32)
        buf467 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        buf468 = empty_strided_cuda((1605632, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf362, (1605632, 256), (256, 1), 0), buf466, buf467, buf468, 256, 1, 16, 1, 2, 16, 16, 3, 1605632, 1, 1, stream=stream0)
        ...
        del primals_89
        buf486 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf487 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf488 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf481, (802816, 256), (256, 1), 0), buf486, buf487, buf488, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf494, (802816, 256), (256, 1), 0), reinterpret_tensor(buf498, (802816, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 802816, 1, 1, stream=stream0)
        ...
        del primals_92
        buf501 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf502 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf503 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf493, (802816, 256), (256, 1), 0), buf501, buf502, buf503, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del buf517
        del primals_95
        buf521 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf522 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf523 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf516, (200704, 256), (256, 1), 0), buf521, buf522, buf523, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf528, (200704, 256), (256, 1), 0), reinterpret_tensor(buf531, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_98
        buf534 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf535 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf536 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf527, (200704, 256), (256, 1), 0), buf534, buf535, buf536, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf550
        del primals_101
        buf554 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf555 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf556 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf549, (200704, 256), (256, 1), 0), buf554, buf555, buf556, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf561, (200704, 256), (256, 1), 0), reinterpret_tensor(buf564, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_104
        buf567 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf568 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf569 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf560, (200704, 256), (256, 1), 0), buf567, buf568, buf569, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del primals_107
        buf587 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf588 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf589 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf582, (802816, 256), (256, 1), 0), buf587, buf588, buf589, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf594, (802816, 256), (256, 1), 0), reinterpret_tensor(buf598, (802816, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 802816, 1, 1, stream=stream0)
        ...
        del primals_110
        buf601 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf602 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf603 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf593, (802816, 256), (256, 1), 0), buf601, buf602, buf603, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del buf617
        del primals_113
        buf621 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf622 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf623 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf616, (200704, 256), (256, 1), 0), buf621, buf622, buf623, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf628, (200704, 256), (256, 1), 0), reinterpret_tensor(buf631, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_116
        buf634 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf635 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf636 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf627, (200704, 256), (256, 1), 0), buf634, buf635, buf636, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf650
        del primals_119
        buf654 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf655 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf656 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf649, (200704, 256), (256, 1), 0), buf654, buf655, buf656, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf661, (200704, 256), (256, 1), 0), reinterpret_tensor(buf664, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_122
        buf667 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf668 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf669 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf660, (200704, 256), (256, 1), 0), buf667, buf668, buf669, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del primals_125
        buf687 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf688 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf689 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf682, (802816, 256), (256, 1), 0), buf687, buf688, buf689, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf694, (802816, 256), (256, 1), 0), reinterpret_tensor(buf698, (802816, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 802816, 1, 1, stream=stream0)
        ...
        del primals_128
        buf701 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf702 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf703 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf693, (802816, 256), (256, 1), 0), buf701, buf702, buf703, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del buf717
        del primals_131
        buf721 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf722 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf723 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf716, (200704, 256), (256, 1), 0), buf721, buf722, buf723, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf728, (200704, 256), (256, 1), 0), reinterpret_tensor(buf731, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_134
        buf734 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf735 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf736 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf727, (200704, 256), (256, 1), 0), buf734, buf735, buf736, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf750
        del primals_137
        buf753 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf754 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf755 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf748, (200704, 256), (256, 1), 0), buf753, buf754, buf755, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf429, (200704, 256), (256, 1), 0), reinterpret_tensor(buf762, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_140
        buf765 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf766 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf767 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf759, (200704, 256), (256, 1), 0), buf765, buf766, buf767, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del primals_143
        buf785 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf786 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf787 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf780, (802816, 256), (256, 1), 0), buf785, buf786, buf787, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf492, (802816, 256), (256, 1), 0), buf399, 256, 1, 8, 1, 1, 32, 8, 802816, 1, 1, stream=stream0)
        del buf492
        ...
        del primals_146
        buf797 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf798 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf799 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf791, (802816, 256), (256, 1), 0), buf797, buf798, buf799, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del buf813
        del primals_149
        buf817 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf818 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf819 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf812, (401408, 256), (256, 1), 0), buf817, buf818, buf819, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf824, (401408, 256), (256, 1), 0), reinterpret_tensor(buf827, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_152
        buf830 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf831 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf832 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf823, (401408, 256), (256, 1), 0), buf830, buf831, buf832, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf846
        del primals_155
        buf850 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf851 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf852 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf845, (100352, 256), (256, 1), 0), buf850, buf851, buf852, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        buf861 = empty_strided_cuda((100352, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [layer3_0_relu_1], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf858, (100352, 256), (256, 1), 0), reinterpret_tensor(buf862, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_158
        buf865 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf866 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf867 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf857, (100352, 256), (256, 1), 0), buf865, buf866, buf867, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del primals_161
        buf886 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf887 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf888 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf881, (401408, 256), (256, 1), 0), buf886, buf887, buf888, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_164
        buf893 = empty_strided_cuda((802816, 16), (16, 1), torch.int32)
        buf894 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        buf895 = empty_strided_cuda((802816, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf791, (802816, 256), (256, 1), 0), buf893, buf894, buf895, 256, 1, 16, 1, 2, 16, 16, 3, 802816, 1, 1, stream=stream0)
        ...
        del primals_167
        buf913 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf914 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf915 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf908, (401408, 256), (256, 1), 0), buf913, buf914, buf915, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf921, (401408, 256), (256, 1), 0), reinterpret_tensor(buf925, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_170
        buf928 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf929 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf930 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf920, (401408, 256), (256, 1), 0), buf928, buf929, buf930, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf944
        del primals_173
        buf948 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf949 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf950 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf943, (100352, 256), (256, 1), 0), buf948, buf949, buf950, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf955, (100352, 256), (256, 1), 0), reinterpret_tensor(buf958, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_176
        buf961 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf962 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf963 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf954, (100352, 256), (256, 1), 0), buf961, buf962, buf963, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf977
        del primals_179
        buf981 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf982 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf983 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf976, (100352, 256), (256, 1), 0), buf981, buf982, buf983, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf988, (100352, 256), (256, 1), 0), reinterpret_tensor(buf991, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_182
        buf994 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf995 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf996 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf987, (100352, 256), (256, 1), 0), buf994, buf995, buf996, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del primals_185
        buf1014 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1015 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1016 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1009, (401408, 256), (256, 1), 0), buf1014, buf1015, buf1016, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1021, (401408, 256), (256, 1), 0), reinterpret_tensor(buf1025, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_188
        buf1028 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1029 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1030 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1020, (401408, 256), (256, 1), 0), buf1028, buf1029, buf1030, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf1044
        del primals_191
        buf1048 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1049 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1050 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1043, (100352, 256), (256, 1), 0), buf1048, buf1049, buf1050, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1055, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1058, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_194
        buf1061 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1062 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1063 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1054, (100352, 256), (256, 1), 0), buf1061, buf1062, buf1063, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf1077
        del primals_197
        buf1081 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1082 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1083 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1076, (100352, 256), (256, 1), 0), buf1081, buf1082, buf1083, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1088, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1091, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_200
        buf1094 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1095 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1096 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1087, (100352, 256), (256, 1), 0), buf1094, buf1095, buf1096, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del primals_203
        buf1114 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1115 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1116 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1109, (401408, 256), (256, 1), 0), buf1114, buf1115, buf1116, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1121, (401408, 256), (256, 1), 0), reinterpret_tensor(buf1125, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_206
        buf1128 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1129 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1130 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1120, (401408, 256), (256, 1), 0), buf1128, buf1129, buf1130, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf1144
        del primals_209
        buf1148 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1149 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1150 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1143, (100352, 256), (256, 1), 0), buf1148, buf1149, buf1150, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1155, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1158, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_212
        buf1161 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1162 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1163 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1154, (100352, 256), (256, 1), 0), buf1161, buf1162, buf1163, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf1177
        del primals_215
        buf1181 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1182 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1183 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1176, (100352, 256), (256, 1), 0), buf1181, buf1182, buf1183, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1188, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1191, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_218
        buf1194 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1195 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1196 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1187, (100352, 256), (256, 1), 0), buf1194, buf1195, buf1196, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del primals_221
        buf1214 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1215 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1216 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1209, (401408, 256), (256, 1), 0), buf1214, buf1215, buf1216, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1221, (401408, 256), (256, 1), 0), reinterpret_tensor(buf1225, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_224
        buf1228 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1229 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1230 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1220, (401408, 256), (256, 1), 0), buf1228, buf1229, buf1230, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf1244
        del primals_227
        buf1248 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1249 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1250 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1243, (100352, 256), (256, 1), 0), buf1248, buf1249, buf1250, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1255, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1258, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_230
        buf1261 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1262 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1263 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1254, (100352, 256), (256, 1), 0), buf1261, buf1262, buf1263, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf1277
        del primals_233
        buf1281 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1282 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1283 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1276, (100352, 256), (256, 1), 0), buf1281, buf1282, buf1283, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1288, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1291, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_236
        buf1294 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1295 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1296 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1287, (100352, 256), (256, 1), 0), buf1294, buf1295, buf1296, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del primals_239
        buf1314 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1315 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1316 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1309, (401408, 256), (256, 1), 0), buf1314, buf1315, buf1316, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1321, (401408, 256), (256, 1), 0), reinterpret_tensor(buf1325, (401408, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        ...
        del primals_242
        buf1328 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1329 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1330 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1320, (401408, 256), (256, 1), 0), buf1328, buf1329, buf1330, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf1344
        del primals_245
        buf1348 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1349 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1350 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1343, (100352, 256), (256, 1), 0), buf1348, buf1349, buf1350, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1355, (100352, 256), (256, 1), 0), reinterpret_tensor(buf1358, (100352, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        ...
        del primals_248
        buf1361 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1362 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1363 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1354, (100352, 256), (256, 1), 0), buf1361, buf1362, buf1363, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf1377
        del primals_251
        buf1380 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1381 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1382 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1375, (100352, 256), (256, 1), 0), buf1380, buf1381, buf1382, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf856, (100352, 256), (256, 1), 0), buf861, 256, 1, 8, 1, 1, 32, 8, 100352, 1, 1, stream=stream0)
        del buf856
        ...
        del primals_254
        buf1391 = empty_strided_cuda((100352, 16), (16, 1), torch.int32)
        buf1392 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        buf1393 = empty_strided_cuda((100352, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1386, (100352, 256), (256, 1), 0), buf1391, buf1392, buf1393, 256, 1, 16, 1, 2, 16, 16, 3, 100352, 1, 1, stream=stream0)
        ...
        del buf1407
        del primals_257
        buf1410 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1411 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1412 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1405, (401408, 256), (256, 1), 0), buf1410, buf1411, buf1412, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf919, (401408, 256), (256, 1), 0), buf72, 256, 1, 8, 1, 1, 32, 8, 401408, 1, 1, stream=stream0)
        del buf919
        ...
        del primals_260
        buf1422 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1423 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1424 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1416, (401408, 256), (256, 1), 0), buf1422, buf1423, buf1424, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del buf1438
        del primals_263
        buf1442 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1443 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1444 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1437, (200704, 256), (256, 1), 0), buf1442, buf1443, buf1444, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1449, (200704, 256), (256, 1), 0), reinterpret_tensor(buf1452, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_266
        buf1455 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1456 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1457 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1448, (200704, 256), (256, 1), 0), buf1455, buf1456, buf1457, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf1471
        del primals_269
        buf1475 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1476 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1477 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1470, (50176, 256), (256, 1), 0), buf1475, buf1476, buf1477, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        buf1486 = empty_strided_cuda((50176, 8), (8, 1), torch.int32)
        # Topologically Sorted Source Nodes: [layer4_0_relu_1], Original ATen: [aten.zeros]
        stream0 = get_raw_stream(0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1483, (50176, 256), (256, 1), 0), reinterpret_tensor(buf1487, (50176, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 50176, 1, 1, stream=stream0)
        ...
        del primals_272
        buf1490 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1491 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1492 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1482, (50176, 256), (256, 1), 0), buf1490, buf1491, buf1492, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        del primals_275
        buf1511 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1512 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1513 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1506, (200704, 256), (256, 1), 0), buf1511, buf1512, buf1513, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del primals_278
        buf1518 = empty_strided_cuda((401408, 16), (16, 1), torch.int32)
        buf1519 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        buf1520 = empty_strided_cuda((401408, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1416, (401408, 256), (256, 1), 0), buf1518, buf1519, buf1520, 256, 1, 16, 1, 2, 16, 16, 3, 401408, 1, 1, stream=stream0)
        ...
        del primals_281
        buf1538 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1539 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1540 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1533, (200704, 256), (256, 1), 0), buf1538, buf1539, buf1540, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1546, (200704, 256), (256, 1), 0), reinterpret_tensor(buf1550, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_284
        buf1553 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1554 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1555 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1545, (200704, 256), (256, 1), 0), buf1553, buf1554, buf1555, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf1569
        del primals_287
        buf1573 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1574 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1575 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1568, (50176, 256), (256, 1), 0), buf1573, buf1574, buf1575, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1580, (50176, 256), (256, 1), 0), reinterpret_tensor(buf1583, (50176, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 50176, 1, 1, stream=stream0)
        ...
        del primals_290
        buf1586 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1587 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1588 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1579, (50176, 256), (256, 1), 0), buf1586, buf1587, buf1588, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        del buf1602
        del primals_293
        buf1606 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1607 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1608 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1601, (50176, 256), (256, 1), 0), buf1606, buf1607, buf1608, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1613, (50176, 256), (256, 1), 0), reinterpret_tensor(buf1616, (50176, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 50176, 1, 1, stream=stream0)
        ...
        del primals_296
        buf1619 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1620 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1621 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1612, (50176, 256), (256, 1), 0), buf1619, buf1620, buf1621, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        del primals_299
        buf1639 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1640 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1641 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1634, (200704, 256), (256, 1), 0), buf1639, buf1640, buf1641, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1646, (200704, 256), (256, 1), 0), reinterpret_tensor(buf1650, (200704, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        ...
        del primals_302
        buf1653 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1654 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1655 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1645, (200704, 256), (256, 1), 0), buf1653, buf1654, buf1655, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        del buf1669
        del primals_305
        buf1673 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1674 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1675 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1668, (50176, 256), (256, 1), 0), buf1673, buf1674, buf1675, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1680, (50176, 256), (256, 1), 0), reinterpret_tensor(buf1683, (50176, 8), (8, 1), 0), 256, 1, 8, 1, 1, 32, 8, 50176, 1, 1, stream=stream0)
        ...
        del primals_308
        buf1686 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1687 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1688 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1679, (50176, 256), (256, 1), 0), buf1686, buf1687, buf1688, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        del buf1702
        del primals_311
        buf1705 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1706 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1707 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1700, (50176, 256), (256, 1), 0), buf1705, buf1706, buf1707, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1481, (50176, 256), (256, 1), 0), buf1486, 256, 1, 8, 1, 1, 32, 8, 50176, 1, 1, stream=stream0)
        del buf1481
        ...
        del primals_314
        buf1716 = empty_strided_cuda((50176, 16), (16, 1), torch.int32)
        buf1717 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        buf1718 = empty_strided_cuda((50176, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1711, (50176, 256), (256, 1), 0), buf1716, buf1717, buf1718, 256, 1, 16, 1, 2, 16, 16, 3, 50176, 1, 1, stream=stream0)
        ...
        del buf1732
        del primals_317
        buf1735 = empty_strided_cuda((200704, 16), (16, 1), torch.int32)
        buf1736 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        buf1737 = empty_strided_cuda((200704, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1730, (200704, 256), (256, 1), 0), buf1735, buf1736, buf1737, 256, 1, 16, 1, 2, 16, 16, 3, 200704, 1, 1, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        pack_kernel_4.run(reinterpret_tensor(buf1544, (200704, 256), (256, 1), 0), buf434, 256, 1, 8, 1, 1, 32, 8, 200704, 1, 1, stream=stream0)
        del buf1544
        ...
        del buf1741
        buf1748 = empty_strided_cuda((4096, 16), (16, 1), torch.int32)
        buf1749 = empty_strided_cuda((4096, ), (1, ), torch.bfloat16)
        buf1750 = empty_strided_cuda((4096, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        quant_pack_kernel_0.run(reinterpret_tensor(buf1747, (4096, 256), (256, 1), 0), buf1748, buf1749, buf1750, 256, 1, 16, 1, 2, 16, 16, 3, 4096, 1, 1, stream=stream0)
        ...
        del primals_318
        del primals_319
    return (buf1755, primals_4, primals_10, primals_16, primals_22, primals_28, primals_34, primals_40, primals_46, primals_52, primals_58, primals_64, primals_70, primals_76, primals_82, primals_88, primals_94, primals_100, primals_106, primals_112, primals_118, primals_124, primals_130, primals_136, primals_142, primals_148, primals_154, primals_160, primals_166, primals_172, primals_178, primals_184, primals_190, primals_196, primals_202, primals_208, primals_214, primals_220, primals_226, primals_232, primals_238, primals_244, primals_250, primals_256, primals_262, primals_268, primals_274, primals_280, primals_286, primals_292, primals_298, primals_304, primals_310, primals_316, buf0, buf1, buf2, buf16, buf23, buf24, buf25, buf31, reinterpret_tensor(buf36, (1605632, 8), (8, 1), 0), buf39, buf40, buf41, buf42, buf43, buf54, buf61, buf62, buf63, reinterpret_tensor(buf73, (401408, 8), (8, 1), 0), buf75, buf76, buf77, buf78, buf89, buf96, buf97, buf98, reinterpret_tensor(buf106, (401408, 8), (8, 1), 0), buf108, buf109, buf110, buf111, buf123, buf130, buf131, buf132, buf136, buf137, buf138, buf139, buf150, buf157, buf158, buf159, reinterpret_tensor(buf169, (1605632, 8), (8, 1), 0), buf171, buf172, buf173, buf174, buf185, buf192, buf193, buf194, reinterpret_tensor(buf202, (401408, 8), (8, 1), 0), buf204, buf205, buf206, buf207, buf218, buf225, buf226, buf227, reinterpret_tensor(buf235, (401408, 8), (8, 1), 0), buf237, buf238, buf239, buf240, buf251, buf258, buf259, buf260, reinterpret_tensor(buf269, (1605632, 8), (8, 1), 0), buf271, buf272, buf273, buf274, buf285, buf292, buf293, buf294, reinterpret_tensor(buf302, (401408, 8), (8, 1), 0), buf304, buf305, buf306, buf307, buf317, buf324, buf325, buf326, reinterpret_tensor(buf333, (401408, 8), (8, 1), 0), buf335, buf336, buf337, buf338, buf349, buf356, buf357, buf358, buf35, buf367, buf368, buf369, buf370, buf382, buf389, buf390, buf391, reinterpret_tensor(buf400, (802816, 8), (8, 1), 0), buf402, buf403, buf404, buf405, buf416, buf423, buf424, buf425, reinterpret_tensor(buf435, (200704, 8), (8, 1), 0), buf437, buf438, buf439, buf440, buf452, buf459, buf460, buf461, buf465, buf466, buf467, buf468, buf479, buf486, buf487, buf488, reinterpret_tensor(buf498, (802816, 8), (8, 1), 0), buf500, buf501, buf502, buf503, buf514, buf521, buf522, buf523, reinterpret_tensor(buf531, (200704, 8), (8, 1), 0), buf533, buf534, buf535, buf536, buf547, buf554, buf555, buf556, reinterpret_tensor(buf564, (200704, 8), (8, 1), 0), buf566, buf567, buf568, buf569, buf580, buf587, buf588, buf589, reinterpret_tensor(buf598, (802816, 8), (8, 1), 0), buf600, buf601, buf602, buf603, buf614, buf621, buf622, buf623, reinterpret_tensor(buf631, (200704, 8), (8, 1), 0), buf633, buf634, buf635, buf636, buf647, buf654, buf655, buf656, reinterpret_tensor(buf664, (200704, 8), (8, 1), 0), buf666, buf667, buf668, buf669, buf680, buf687, buf688, buf689, reinterpret_tensor(buf698, (802816, 8), (8, 1), 0), buf700, buf701, buf702, buf703, buf714, buf721, buf722, buf723, reinterpret_tensor(buf731, (200704, 8), (8, 1), 0), buf733, buf734, buf735, buf736, buf746, buf753, buf754, buf755, reinterpret_tensor(buf762, (200704, 8), (8, 1), 0), buf764, buf765, buf766, buf767, buf778, buf785, buf786, buf787, buf399, buf796, buf797, buf798, buf799, buf810, buf817, buf818, buf819, reinterpret_tensor(buf827, (401408, 8), (8, 1), 0), buf829, buf830, buf831, buf832, buf843, buf850, buf851, buf852, reinterpret_tensor(buf862, (100352, 8), (8, 1), 0), buf864, buf865, buf866, buf867, buf879, buf886, buf887, buf888, buf892, buf893, buf894, buf895, buf906, buf913, buf914, buf915, reinterpret_tensor(buf925, (401408, 8), (8, 1), 0), buf927, buf928, buf929, buf930, buf941, buf948, buf949, buf950, reinterpret_tensor(buf958, (100352, 8), (8, 1), 0), buf960, buf961, buf962, buf963, buf974, buf981, buf982, buf983, reinterpret_tensor(buf991, (100352, 8), (8, 1), 0), buf993, buf994, buf995, buf996, buf1007, buf1014, buf1015, buf1016, reinterpret_tensor(buf1025, (401408, 8), (8, 1), 0), buf1027, buf1028, buf1029, buf1030, buf1041, buf1048, buf1049, buf1050, reinterpret_tensor(buf1058, (100352, 8), (8, 1), 0), buf1060, buf1061, buf1062, buf1063, buf1074, buf1081, buf1082, buf1083, reinterpret_tensor(buf1091, (100352, 8), (8, 1), 0), buf1093, buf1094, buf1095, buf1096, buf1107, buf1114, buf1115, buf1116, reinterpret_tensor(buf1125, (401408, 8), (8, 1), 0), buf1127, buf1128, buf1129, buf1130, buf1141, buf1148, buf1149, buf1150, reinterpret_tensor(buf1158, (100352, 8), (8, 1), 0), buf1160, buf1161, buf1162, buf1163, buf1174, buf1181, buf1182, buf1183, reinterpret_tensor(buf1191, (100352, 8), (8, 1), 0), buf1193, buf1194, buf1195, buf1196, buf1207, buf1214, buf1215, buf1216, reinterpret_tensor(buf1225, (401408, 8), (8, 1), 0), buf1227, buf1228, buf1229, buf1230, buf1241, buf1248, buf1249, buf1250, reinterpret_tensor(buf1258, (100352, 8), (8, 1), 0), buf1260, buf1261, buf1262, buf1263, buf1274, buf1281, buf1282, buf1283, reinterpret_tensor(buf1291, (100352, 8), (8, 1), 0), buf1293, buf1294, buf1295, buf1296, buf1307, buf1314, buf1315, buf1316, reinterpret_tensor(buf1325, (401408, 8), (8, 1), 0), buf1327, buf1328, buf1329, buf1330, buf1341, buf1348, buf1349, buf1350, reinterpret_tensor(buf1358, (100352, 8), (8, 1), 0), buf1360, buf1361, buf1362, buf1363, buf1373, buf1380, buf1381, buf1382, buf861, buf1390, buf1391, buf1392, buf1393, buf1403, buf1410, buf1411, buf1412, buf72, buf1421, buf1422, buf1423, buf1424, buf1435, buf1442, buf1443, buf1444, reinterpret_tensor(buf1452, (200704, 8), (8, 1), 0), buf1454, buf1455, buf1456, buf1457, buf1468, buf1475, buf1476, buf1477, reinterpret_tensor(buf1487, (50176, 8), (8, 1), 0), buf1489, buf1490, buf1491, buf1492, buf1504, buf1511, buf1512, buf1513, buf1517, buf1518, buf1519, buf1520, buf1531, buf1538, buf1539, buf1540, reinterpret_tensor(buf1550, (200704, 8), (8, 1), 0), buf1552, buf1553, buf1554, buf1555, buf1566, buf1573, buf1574, buf1575, reinterpret_tensor(buf1583, (50176, 8), (8, 1), 0), buf1585, buf1586, buf1587, buf1588, buf1599, buf1606, buf1607, buf1608, reinterpret_tensor(buf1616, (50176, 8), (8, 1), 0), buf1618, buf1619, buf1620, buf1621, buf1632, buf1639, buf1640, buf1641, reinterpret_tensor(buf1650, (200704, 8), (8, 1), 0), buf1652, buf1653, buf1654, buf1655, buf1666, buf1673, buf1674, buf1675, reinterpret_tensor(buf1683, (50176, 8), (8, 1), 0), buf1685, buf1686, buf1687, buf1688, buf1698, buf1705, buf1706, buf1707, buf1486, buf1715, buf1716, buf1717, buf1718, buf1728, buf1735, buf1736, buf1737, buf434, buf1748, buf1749, buf1750, buf1754, )
