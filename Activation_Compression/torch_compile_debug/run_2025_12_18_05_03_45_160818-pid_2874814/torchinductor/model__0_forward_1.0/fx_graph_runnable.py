...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207, primals_208, primals_209, primals_210, primals_211, primals_212, primals_213, primals_214, primals_215, primals_216, primals_217, primals_218, primals_219, primals_220, primals_221, primals_222, primals_223, primals_224, primals_225, primals_226, primals_227, primals_228, primals_229, primals_230, primals_231, primals_232, primals_233, primals_234, primals_235, primals_236, primals_237, primals_238, primals_239, primals_240, primals_241, primals_242, primals_243, primals_244, primals_245, primals_246, primals_247, primals_248, primals_249, primals_250, primals_251, primals_252, primals_253, primals_254, primals_255, primals_256, primals_257, primals_258, primals_259, primals_260, primals_261, primals_262, primals_263, primals_264, primals_265, primals_266, primals_267, primals_268, primals_269, primals_270, primals_271, primals_272, primals_273, primals_274, primals_275, primals_276, primals_277, primals_278, primals_279, primals_280, primals_281, primals_282, primals_283, primals_284, primals_285, primals_286, primals_287, primals_288, primals_289, primals_290, primals_291, primals_292, primals_293, primals_294, primals_295, primals_296, primals_297, primals_298, primals_299, primals_300, primals_301, primals_302, primals_303, primals_304, primals_305, primals_306, primals_307, primals_308, primals_309, primals_310, primals_311, primals_312, primals_313, primals_314, primals_315, primals_316, primals_317, primals_318, primals_319, primals_320):
        ...
        view_2 = torch.ops.aten.view.default(convert_element_type, [512, -1, 256])
        view_3 = torch.ops.aten.view.default(view_2, [301056, 256]);  view_2 = None
        empty = torch.ops.aten.empty.memory_format([301056, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_1 = torch.ops.aten.empty.memory_format([301056], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_2 = torch.ops.aten.empty.memory_format([301056], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_9 = torch.ops.aten.view.default(convolution, [512, 64, 12544]);  convolution = None
        ...
        empty_5 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_6 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_7 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_15 = torch.ops.aten.view.default(getitem_6, [512, -1, 256]);  getitem_6 = None
        view_16 = torch.ops.aten.view.default(view_15, [1605632, 256]);  view_15 = None
        ...
        view_22 = torch.ops.aten.view.default(getitem_5, [512, 64, 112, 112]);  getitem_5 = None
        ...
        full_default_5 = torch.ops.aten.full.default([1605632, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_27 = torch.ops.aten.view.default(getitem_11, [512, -1, 256]);  getitem_11 = None
        view_28 = torch.ops.aten.view.default(view_27, [1605632, 256]);  view_27 = None
        ...
        view_31 = torch.ops.aten.view.default(getitem_13, [512, -1, 256])
        view_32 = torch.ops.aten.view.default(view_31, [401408, 256]);  view_31 = None
        empty_9 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_10 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_11 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_38 = torch.ops.aten.view.default(convolution_1, [512, 64, 3136]);  convolution_1 = None
        ...
        empty_14 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_15 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_16 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_44 = torch.ops.aten.view.default(getitem_21, [512, -1, 256]);  getitem_21 = None
        view_45 = torch.ops.aten.view.default(view_44, [401408, 256]);  view_44 = None
        ...
        view_51 = torch.ops.aten.view.default(getitem_20, [512, 64, 56, 56]);  getitem_20 = None
        ...
        full_default_11 = torch.ops.aten.full.default([401408, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_56 = torch.ops.aten.view.default(getitem_26, [512, -1, 256]);  getitem_26 = None
        view_57 = torch.ops.aten.view.default(view_56, [401408, 256]);  view_56 = None
        ...
        empty_18 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_19 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_20 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_62 = torch.ops.aten.view.default(getitem_25, [512, -1, 256])
        view_63 = torch.ops.aten.view.default(view_62, [401408, 256]);  view_62 = None
        ...
        view_69 = torch.ops.aten.view.default(convolution_2, [512, 64, 3136]);  convolution_2 = None
        ...
        empty_23 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_24 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_25 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_75 = torch.ops.aten.view.default(getitem_34, [512, -1, 256]);  getitem_34 = None
        view_76 = torch.ops.aten.view.default(view_75, [401408, 256]);  view_75 = None
        ...
        view_82 = torch.ops.aten.view.default(getitem_33, [512, 64, 56, 56]);  getitem_33 = None
        ...
        view_87 = torch.ops.aten.view.default(getitem_39, [512, -1, 256]);  getitem_39 = None
        view_88 = torch.ops.aten.view.default(view_87, [401408, 256]);  view_87 = None
        ...
        empty_27 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_28 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_29 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_93 = torch.ops.aten.view.default(getitem_38, [512, -1, 256])
        view_94 = torch.ops.aten.view.default(view_93, [401408, 256]);  view_93 = None
        ...
        view_100 = torch.ops.aten.view.default(convolution_3, [512, 256, 3136]);  convolution_3 = None
        ...
        empty_32 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_33 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_34 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_106 = torch.ops.aten.view.default(getitem_47, [512, -1, 256]);  getitem_47 = None
        view_107 = torch.ops.aten.view.default(view_106, [1605632, 256]);  view_106 = None
        ...
        empty_35 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_36 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_37 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_122 = torch.ops.aten.view.default(convolution_4, [512, 256, 3136]);  convolution_4 = None
        ...
        empty_40 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_41 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_42 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_128 = torch.ops.aten.view.default(getitem_57, [512, -1, 256]);  getitem_57 = None
        view_129 = torch.ops.aten.view.default(view_128, [1605632, 256]);  view_128 = None
        ...
        view_135 = torch.ops.aten.view.default(getitem_46, [512, 256, 56, 56]);  getitem_46 = None
        view_136 = torch.ops.aten.view.default(getitem_56, [512, 256, 56, 56]);  getitem_56 = None
        add_20 = torch.ops.aten.add.Tensor(view_135, view_136);  view_135 = view_136 = None
        ...
        view_141 = torch.ops.aten.view.default(getitem_62, [512, -1, 256]);  getitem_62 = None
        view_142 = torch.ops.aten.view.default(view_141, [1605632, 256]);  view_141 = None
        ...
        empty_44 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_45 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_46 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_147 = torch.ops.aten.view.default(getitem_61, [512, -1, 256])
        view_148 = torch.ops.aten.view.default(view_147, [1605632, 256]);  view_147 = None
        ...
        view_154 = torch.ops.aten.view.default(convolution_5, [512, 64, 3136]);  convolution_5 = None
        ...
        empty_49 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_50 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_51 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_160 = torch.ops.aten.view.default(getitem_70, [512, -1, 256]);  getitem_70 = None
        view_161 = torch.ops.aten.view.default(view_160, [401408, 256]);  view_160 = None
        ...
        view_167 = torch.ops.aten.view.default(getitem_69, [512, 64, 56, 56]);  getitem_69 = None
        ...
        view_172 = torch.ops.aten.view.default(getitem_75, [512, -1, 256]);  getitem_75 = None
        view_173 = torch.ops.aten.view.default(view_172, [401408, 256]);  view_172 = None
        ...
        empty_53 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_54 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_55 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_178 = torch.ops.aten.view.default(getitem_74, [512, -1, 256])
        view_179 = torch.ops.aten.view.default(view_178, [401408, 256]);  view_178 = None
        ...
        view_185 = torch.ops.aten.view.default(convolution_6, [512, 64, 3136]);  convolution_6 = None
        ...
        empty_58 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_59 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_60 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_191 = torch.ops.aten.view.default(getitem_83, [512, -1, 256]);  getitem_83 = None
        view_192 = torch.ops.aten.view.default(view_191, [401408, 256]);  view_191 = None
        ...
        view_198 = torch.ops.aten.view.default(getitem_82, [512, 64, 56, 56]);  getitem_82 = None
        ...
        view_203 = torch.ops.aten.view.default(getitem_88, [512, -1, 256]);  getitem_88 = None
        view_204 = torch.ops.aten.view.default(view_203, [401408, 256]);  view_203 = None
        ...
        empty_62 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_63 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_64 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_209 = torch.ops.aten.view.default(getitem_87, [512, -1, 256])
        view_210 = torch.ops.aten.view.default(view_209, [401408, 256]);  view_209 = None
        ...
        view_216 = torch.ops.aten.view.default(convolution_7, [512, 256, 3136]);  convolution_7 = None
        ...
        empty_67 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_68 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_69 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_222 = torch.ops.aten.view.default(getitem_96, [512, -1, 256]);  getitem_96 = None
        view_223 = torch.ops.aten.view.default(view_222, [1605632, 256]);  view_222 = None
        ...
        view_229 = torch.ops.aten.view.default(getitem_95, [512, 256, 56, 56]);  getitem_95 = None
        add_33 = torch.ops.aten.add.Tensor(view_229, getitem_61);  view_229 = getitem_61 = None
        ...
        view_234 = torch.ops.aten.view.default(getitem_101, [512, -1, 256]);  getitem_101 = None
        view_235 = torch.ops.aten.view.default(view_234, [1605632, 256]);  view_234 = None
        ...
        empty_71 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_72 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_73 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_240 = torch.ops.aten.view.default(getitem_100, [512, -1, 256])
        view_241 = torch.ops.aten.view.default(view_240, [1605632, 256]);  view_240 = None
        ...
        view_247 = torch.ops.aten.view.default(convolution_8, [512, 64, 3136]);  convolution_8 = None
        ...
        empty_76 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_77 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_78 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_253 = torch.ops.aten.view.default(getitem_109, [512, -1, 256]);  getitem_109 = None
        view_254 = torch.ops.aten.view.default(view_253, [401408, 256]);  view_253 = None
        ...
        view_260 = torch.ops.aten.view.default(getitem_108, [512, 64, 56, 56]);  getitem_108 = None
        ...
        view_265 = torch.ops.aten.view.default(getitem_114, [512, -1, 256]);  getitem_114 = None
        view_266 = torch.ops.aten.view.default(view_265, [401408, 256]);  view_265 = None
        ...
        empty_80 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_81 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_82 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_271 = torch.ops.aten.view.default(getitem_113, [512, -1, 256])
        view_272 = torch.ops.aten.view.default(view_271, [401408, 256]);  view_271 = None
        ...
        view_278 = torch.ops.aten.view.default(convolution_9, [512, 64, 3136]);  convolution_9 = None
        ...
        empty_85 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_86 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_87 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_284 = torch.ops.aten.view.default(getitem_122, [512, -1, 256]);  getitem_122 = None
        view_285 = torch.ops.aten.view.default(view_284, [401408, 256]);  view_284 = None
        ...
        view_291 = torch.ops.aten.view.default(getitem_121, [512, 64, 56, 56]);  getitem_121 = None
        ...
        view_296 = torch.ops.aten.view.default(getitem_127, [512, -1, 256]);  getitem_127 = None
        view_297 = torch.ops.aten.view.default(view_296, [401408, 256]);  view_296 = None
        ...
        empty_89 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_90 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_91 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_302 = torch.ops.aten.view.default(getitem_126, [512, -1, 256])
        view_303 = torch.ops.aten.view.default(view_302, [401408, 256]);  view_302 = None
        ...
        view_309 = torch.ops.aten.view.default(convolution_10, [512, 256, 3136]);  convolution_10 = None
        ...
        empty_94 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_95 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_96 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_315 = torch.ops.aten.view.default(getitem_135, [512, -1, 256]);  getitem_135 = None
        view_316 = torch.ops.aten.view.default(view_315, [1605632, 256]);  view_315 = None
        ...
        view_322 = torch.ops.aten.view.default(getitem_134, [512, 256, 56, 56]);  getitem_134 = None
        add_46 = torch.ops.aten.add.Tensor(view_322, getitem_100);  view_322 = getitem_100 = None
        ...
        view_327 = torch.ops.aten.view.default(getitem_140, [512, -1, 256]);  getitem_140 = None
        view_328 = torch.ops.aten.view.default(view_327, [1605632, 256]);  view_327 = None
        ...
        empty_98 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_99 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_100 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_333 = torch.ops.aten.view.default(getitem_139, [512, -1, 256])
        view_334 = torch.ops.aten.view.default(view_333, [1605632, 256]);  view_333 = None
        ...
        view_340 = torch.ops.aten.view.default(convolution_11, [512, 128, 3136]);  convolution_11 = None
        ...
        empty_103 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_104 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_105 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_346 = torch.ops.aten.view.default(getitem_148, [512, -1, 256]);  getitem_148 = None
        view_347 = torch.ops.aten.view.default(view_346, [802816, 256]);  view_346 = None
        ...
        view_353 = torch.ops.aten.view.default(getitem_147, [512, 128, 56, 56]);  getitem_147 = None
        ...
        full_default_69 = torch.ops.aten.full.default([802816, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_358 = torch.ops.aten.view.default(getitem_153, [512, -1, 256]);  getitem_153 = None
        view_359 = torch.ops.aten.view.default(view_358, [802816, 256]);  view_358 = None
        ...
        empty_107 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_108 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_109 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_364 = torch.ops.aten.view.default(getitem_152, [512, -1, 256])
        view_365 = torch.ops.aten.view.default(view_364, [802816, 256]);  view_364 = None
        ...
        view_371 = torch.ops.aten.view.default(convolution_12, [512, 128, 784]);  convolution_12 = None
        ...
        empty_112 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_113 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_114 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_377 = torch.ops.aten.view.default(getitem_161, [512, -1, 256]);  getitem_161 = None
        view_378 = torch.ops.aten.view.default(view_377, [200704, 256]);  view_377 = None
        ...
        view_384 = torch.ops.aten.view.default(getitem_160, [512, 128, 28, 28]);  getitem_160 = None
        ...
        full_default_75 = torch.ops.aten.full.default([200704, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_389 = torch.ops.aten.view.default(getitem_166, [512, -1, 256]);  getitem_166 = None
        view_390 = torch.ops.aten.view.default(view_389, [200704, 256]);  view_389 = None
        ...
        empty_116 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_117 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_118 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_395 = torch.ops.aten.view.default(getitem_165, [512, -1, 256])
        view_396 = torch.ops.aten.view.default(view_395, [200704, 256]);  view_395 = None
        ...
        view_402 = torch.ops.aten.view.default(convolution_13, [512, 512, 784]);  convolution_13 = None
        ...
        empty_121 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_122 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_123 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_408 = torch.ops.aten.view.default(getitem_174, [512, -1, 256]);  getitem_174 = None
        view_409 = torch.ops.aten.view.default(view_408, [802816, 256]);  view_408 = None
        ...
        empty_124 = torch.ops.aten.empty.memory_format([1605632, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_125 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_126 = torch.ops.aten.empty.memory_format([1605632], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_426 = torch.ops.aten.view.default(convolution_14, [512, 512, 784]);  convolution_14 = None
        ...
        empty_129 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_130 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_131 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_432 = torch.ops.aten.view.default(getitem_184, [512, -1, 256]);  getitem_184 = None
        view_433 = torch.ops.aten.view.default(view_432, [802816, 256]);  view_432 = None
        ...
        view_439 = torch.ops.aten.view.default(getitem_173, [512, 512, 28, 28]);  getitem_173 = None
        view_440 = torch.ops.aten.view.default(getitem_183, [512, 512, 28, 28]);  getitem_183 = None
        add_63 = torch.ops.aten.add.Tensor(view_439, view_440);  view_439 = view_440 = None
        ...
        view_445 = torch.ops.aten.view.default(getitem_189, [512, -1, 256]);  getitem_189 = None
        view_446 = torch.ops.aten.view.default(view_445, [802816, 256]);  view_445 = None
        ...
        empty_133 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_134 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_135 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_451 = torch.ops.aten.view.default(getitem_188, [512, -1, 256])
        view_452 = torch.ops.aten.view.default(view_451, [802816, 256]);  view_451 = None
        ...
        view_458 = torch.ops.aten.view.default(convolution_15, [512, 128, 784]);  convolution_15 = None
        ...
        empty_138 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_139 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_140 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_464 = torch.ops.aten.view.default(getitem_197, [512, -1, 256]);  getitem_197 = None
        view_465 = torch.ops.aten.view.default(view_464, [200704, 256]);  view_464 = None
        ...
        view_471 = torch.ops.aten.view.default(getitem_196, [512, 128, 28, 28]);  getitem_196 = None
        ...
        view_476 = torch.ops.aten.view.default(getitem_202, [512, -1, 256]);  getitem_202 = None
        view_477 = torch.ops.aten.view.default(view_476, [200704, 256]);  view_476 = None
        ...
        empty_142 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_143 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_144 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_482 = torch.ops.aten.view.default(getitem_201, [512, -1, 256])
        view_483 = torch.ops.aten.view.default(view_482, [200704, 256]);  view_482 = None
        ...
        view_489 = torch.ops.aten.view.default(convolution_16, [512, 128, 784]);  convolution_16 = None
        ...
        empty_147 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_148 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_149 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_495 = torch.ops.aten.view.default(getitem_210, [512, -1, 256]);  getitem_210 = None
        view_496 = torch.ops.aten.view.default(view_495, [200704, 256]);  view_495 = None
        ...
        view_502 = torch.ops.aten.view.default(getitem_209, [512, 128, 28, 28]);  getitem_209 = None
        ...
        view_507 = torch.ops.aten.view.default(getitem_215, [512, -1, 256]);  getitem_215 = None
        view_508 = torch.ops.aten.view.default(view_507, [200704, 256]);  view_507 = None
        ...
        empty_151 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_152 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_153 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_513 = torch.ops.aten.view.default(getitem_214, [512, -1, 256])
        view_514 = torch.ops.aten.view.default(view_513, [200704, 256]);  view_513 = None
        ...
        view_520 = torch.ops.aten.view.default(convolution_17, [512, 512, 784]);  convolution_17 = None
        ...
        empty_156 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_157 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_158 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_526 = torch.ops.aten.view.default(getitem_223, [512, -1, 256]);  getitem_223 = None
        view_527 = torch.ops.aten.view.default(view_526, [802816, 256]);  view_526 = None
        ...
        view_533 = torch.ops.aten.view.default(getitem_222, [512, 512, 28, 28]);  getitem_222 = None
        add_76 = torch.ops.aten.add.Tensor(view_533, getitem_188);  view_533 = getitem_188 = None
        ...
        view_538 = torch.ops.aten.view.default(getitem_228, [512, -1, 256]);  getitem_228 = None
        view_539 = torch.ops.aten.view.default(view_538, [802816, 256]);  view_538 = None
        ...
        empty_160 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_161 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_162 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_544 = torch.ops.aten.view.default(getitem_227, [512, -1, 256])
        view_545 = torch.ops.aten.view.default(view_544, [802816, 256]);  view_544 = None
        ...
        view_551 = torch.ops.aten.view.default(convolution_18, [512, 128, 784]);  convolution_18 = None
        ...
        empty_165 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_166 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_167 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_557 = torch.ops.aten.view.default(getitem_236, [512, -1, 256]);  getitem_236 = None
        view_558 = torch.ops.aten.view.default(view_557, [200704, 256]);  view_557 = None
        ...
        view_564 = torch.ops.aten.view.default(getitem_235, [512, 128, 28, 28]);  getitem_235 = None
        ...
        view_569 = torch.ops.aten.view.default(getitem_241, [512, -1, 256]);  getitem_241 = None
        view_570 = torch.ops.aten.view.default(view_569, [200704, 256]);  view_569 = None
        ...
        empty_169 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_170 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_171 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_575 = torch.ops.aten.view.default(getitem_240, [512, -1, 256])
        view_576 = torch.ops.aten.view.default(view_575, [200704, 256]);  view_575 = None
        ...
        view_582 = torch.ops.aten.view.default(convolution_19, [512, 128, 784]);  convolution_19 = None
        ...
        empty_174 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_175 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_176 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_588 = torch.ops.aten.view.default(getitem_249, [512, -1, 256]);  getitem_249 = None
        view_589 = torch.ops.aten.view.default(view_588, [200704, 256]);  view_588 = None
        ...
        view_595 = torch.ops.aten.view.default(getitem_248, [512, 128, 28, 28]);  getitem_248 = None
        ...
        view_600 = torch.ops.aten.view.default(getitem_254, [512, -1, 256]);  getitem_254 = None
        view_601 = torch.ops.aten.view.default(view_600, [200704, 256]);  view_600 = None
        ...
        empty_178 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_179 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_180 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_606 = torch.ops.aten.view.default(getitem_253, [512, -1, 256])
        view_607 = torch.ops.aten.view.default(view_606, [200704, 256]);  view_606 = None
        ...
        view_613 = torch.ops.aten.view.default(convolution_20, [512, 512, 784]);  convolution_20 = None
        ...
        empty_183 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_184 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_185 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_619 = torch.ops.aten.view.default(getitem_262, [512, -1, 256]);  getitem_262 = None
        view_620 = torch.ops.aten.view.default(view_619, [802816, 256]);  view_619 = None
        ...
        view_626 = torch.ops.aten.view.default(getitem_261, [512, 512, 28, 28]);  getitem_261 = None
        add_89 = torch.ops.aten.add.Tensor(view_626, getitem_227);  view_626 = getitem_227 = None
        ...
        view_631 = torch.ops.aten.view.default(getitem_267, [512, -1, 256]);  getitem_267 = None
        view_632 = torch.ops.aten.view.default(view_631, [802816, 256]);  view_631 = None
        ...
        empty_187 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_188 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_189 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_637 = torch.ops.aten.view.default(getitem_266, [512, -1, 256])
        view_638 = torch.ops.aten.view.default(view_637, [802816, 256]);  view_637 = None
        ...
        view_644 = torch.ops.aten.view.default(convolution_21, [512, 128, 784]);  convolution_21 = None
        ...
        empty_192 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_193 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_194 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_650 = torch.ops.aten.view.default(getitem_275, [512, -1, 256]);  getitem_275 = None
        view_651 = torch.ops.aten.view.default(view_650, [200704, 256]);  view_650 = None
        ...
        view_657 = torch.ops.aten.view.default(getitem_274, [512, 128, 28, 28]);  getitem_274 = None
        ...
        view_662 = torch.ops.aten.view.default(getitem_280, [512, -1, 256]);  getitem_280 = None
        view_663 = torch.ops.aten.view.default(view_662, [200704, 256]);  view_662 = None
        ...
        empty_196 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_197 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_198 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_668 = torch.ops.aten.view.default(getitem_279, [512, -1, 256])
        view_669 = torch.ops.aten.view.default(view_668, [200704, 256]);  view_668 = None
        ...
        view_675 = torch.ops.aten.view.default(convolution_22, [512, 128, 784]);  convolution_22 = None
        ...
        empty_201 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_202 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_203 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_681 = torch.ops.aten.view.default(getitem_288, [512, -1, 256]);  getitem_288 = None
        view_682 = torch.ops.aten.view.default(view_681, [200704, 256]);  view_681 = None
        ...
        view_688 = torch.ops.aten.view.default(getitem_287, [512, 128, 28, 28]);  getitem_287 = None
        ...
        view_693 = torch.ops.aten.view.default(getitem_293, [512, -1, 256]);  getitem_293 = None
        view_694 = torch.ops.aten.view.default(view_693, [200704, 256]);  view_693 = None
        ...
        empty_205 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_206 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_207 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_699 = torch.ops.aten.view.default(getitem_292, [512, -1, 256])
        view_700 = torch.ops.aten.view.default(view_699, [200704, 256]);  view_699 = None
        ...
        view_706 = torch.ops.aten.view.default(convolution_23, [512, 512, 784]);  convolution_23 = None
        ...
        empty_210 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_211 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_212 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_712 = torch.ops.aten.view.default(getitem_301, [512, -1, 256]);  getitem_301 = None
        view_713 = torch.ops.aten.view.default(view_712, [802816, 256]);  view_712 = None
        ...
        view_719 = torch.ops.aten.view.default(getitem_300, [512, 512, 28, 28]);  getitem_300 = None
        add_102 = torch.ops.aten.add.Tensor(view_719, getitem_266);  view_719 = getitem_266 = None
        ...
        view_724 = torch.ops.aten.view.default(getitem_306, [512, -1, 256]);  getitem_306 = None
        view_725 = torch.ops.aten.view.default(view_724, [802816, 256]);  view_724 = None
        ...
        empty_214 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_215 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_216 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_730 = torch.ops.aten.view.default(getitem_305, [512, -1, 256])
        view_731 = torch.ops.aten.view.default(view_730, [802816, 256]);  view_730 = None
        ...
        view_737 = torch.ops.aten.view.default(convolution_24, [512, 256, 784]);  convolution_24 = None
        ...
        empty_219 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_220 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_221 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_743 = torch.ops.aten.view.default(getitem_314, [512, -1, 256]);  getitem_314 = None
        view_744 = torch.ops.aten.view.default(view_743, [401408, 256]);  view_743 = None
        ...
        view_750 = torch.ops.aten.view.default(getitem_313, [512, 256, 28, 28]);  getitem_313 = None
        ...
        view_755 = torch.ops.aten.view.default(getitem_319, [512, -1, 256]);  getitem_319 = None
        view_756 = torch.ops.aten.view.default(view_755, [401408, 256]);  view_755 = None
        ...
        empty_223 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_224 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_225 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_761 = torch.ops.aten.view.default(getitem_318, [512, -1, 256])
        view_762 = torch.ops.aten.view.default(view_761, [401408, 256]);  view_761 = None
        ...
        view_768 = torch.ops.aten.view.default(convolution_25, [512, 256, 196]);  convolution_25 = None
        ...
        empty_228 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_229 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_230 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_774 = torch.ops.aten.view.default(getitem_327, [512, -1, 256]);  getitem_327 = None
        view_775 = torch.ops.aten.view.default(view_774, [100352, 256]);  view_774 = None
        ...
        view_781 = torch.ops.aten.view.default(getitem_326, [512, 256, 14, 14]);  getitem_326 = None
        ...
        full_default_151 = torch.ops.aten.full.default([100352, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_786 = torch.ops.aten.view.default(getitem_332, [512, -1, 256]);  getitem_332 = None
        view_787 = torch.ops.aten.view.default(view_786, [100352, 256]);  view_786 = None
        ...
        empty_232 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_233 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_234 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_792 = torch.ops.aten.view.default(getitem_331, [512, -1, 256])
        view_793 = torch.ops.aten.view.default(view_792, [100352, 256]);  view_792 = None
        ...
        view_799 = torch.ops.aten.view.default(convolution_26, [512, 1024, 196]);  convolution_26 = None
        ...
        empty_237 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_238 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_239 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_805 = torch.ops.aten.view.default(getitem_340, [512, -1, 256]);  getitem_340 = None
        view_806 = torch.ops.aten.view.default(view_805, [401408, 256]);  view_805 = None
        ...
        empty_240 = torch.ops.aten.empty.memory_format([802816, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_241 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_242 = torch.ops.aten.empty.memory_format([802816], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_823 = torch.ops.aten.view.default(convolution_27, [512, 1024, 196]);  convolution_27 = None
        ...
        empty_245 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_246 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_247 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_829 = torch.ops.aten.view.default(getitem_350, [512, -1, 256]);  getitem_350 = None
        view_830 = torch.ops.aten.view.default(view_829, [401408, 256]);  view_829 = None
        ...
        view_836 = torch.ops.aten.view.default(getitem_339, [512, 1024, 14, 14]);  getitem_339 = None
        view_837 = torch.ops.aten.view.default(getitem_349, [512, 1024, 14, 14]);  getitem_349 = None
        add_119 = torch.ops.aten.add.Tensor(view_836, view_837);  view_836 = view_837 = None
        ...
        view_842 = torch.ops.aten.view.default(getitem_355, [512, -1, 256]);  getitem_355 = None
        view_843 = torch.ops.aten.view.default(view_842, [401408, 256]);  view_842 = None
        ...
        empty_249 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_250 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_251 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_848 = torch.ops.aten.view.default(getitem_354, [512, -1, 256])
        view_849 = torch.ops.aten.view.default(view_848, [401408, 256]);  view_848 = None
        ...
        view_855 = torch.ops.aten.view.default(convolution_28, [512, 256, 196]);  convolution_28 = None
        ...
        empty_254 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_255 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_256 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_861 = torch.ops.aten.view.default(getitem_363, [512, -1, 256]);  getitem_363 = None
        view_862 = torch.ops.aten.view.default(view_861, [100352, 256]);  view_861 = None
        ...
        view_868 = torch.ops.aten.view.default(getitem_362, [512, 256, 14, 14]);  getitem_362 = None
        ...
        view_873 = torch.ops.aten.view.default(getitem_368, [512, -1, 256]);  getitem_368 = None
        view_874 = torch.ops.aten.view.default(view_873, [100352, 256]);  view_873 = None
        ...
        empty_258 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_259 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_260 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_879 = torch.ops.aten.view.default(getitem_367, [512, -1, 256])
        view_880 = torch.ops.aten.view.default(view_879, [100352, 256]);  view_879 = None
        ...
        view_886 = torch.ops.aten.view.default(convolution_29, [512, 256, 196]);  convolution_29 = None
        ...
        empty_263 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_264 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_265 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_892 = torch.ops.aten.view.default(getitem_376, [512, -1, 256]);  getitem_376 = None
        view_893 = torch.ops.aten.view.default(view_892, [100352, 256]);  view_892 = None
        ...
        view_899 = torch.ops.aten.view.default(getitem_375, [512, 256, 14, 14]);  getitem_375 = None
        ...
        view_904 = torch.ops.aten.view.default(getitem_381, [512, -1, 256]);  getitem_381 = None
        view_905 = torch.ops.aten.view.default(view_904, [100352, 256]);  view_904 = None
        ...
        empty_267 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_268 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_269 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_910 = torch.ops.aten.view.default(getitem_380, [512, -1, 256])
        view_911 = torch.ops.aten.view.default(view_910, [100352, 256]);  view_910 = None
        ...
        view_917 = torch.ops.aten.view.default(convolution_30, [512, 1024, 196]);  convolution_30 = None
        ...
        empty_272 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_273 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_274 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_923 = torch.ops.aten.view.default(getitem_389, [512, -1, 256]);  getitem_389 = None
        view_924 = torch.ops.aten.view.default(view_923, [401408, 256]);  view_923 = None
        ...
        view_930 = torch.ops.aten.view.default(getitem_388, [512, 1024, 14, 14]);  getitem_388 = None
        add_132 = torch.ops.aten.add.Tensor(view_930, getitem_354);  view_930 = getitem_354 = None
        ...
        view_935 = torch.ops.aten.view.default(getitem_394, [512, -1, 256]);  getitem_394 = None
        view_936 = torch.ops.aten.view.default(view_935, [401408, 256]);  view_935 = None
        ...
        empty_276 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_277 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_278 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_941 = torch.ops.aten.view.default(getitem_393, [512, -1, 256])
        view_942 = torch.ops.aten.view.default(view_941, [401408, 256]);  view_941 = None
        ...
        view_948 = torch.ops.aten.view.default(convolution_31, [512, 256, 196]);  convolution_31 = None
        ...
        empty_281 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_282 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_283 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_954 = torch.ops.aten.view.default(getitem_402, [512, -1, 256]);  getitem_402 = None
        view_955 = torch.ops.aten.view.default(view_954, [100352, 256]);  view_954 = None
        ...
        view_961 = torch.ops.aten.view.default(getitem_401, [512, 256, 14, 14]);  getitem_401 = None
        ...
        view_966 = torch.ops.aten.view.default(getitem_407, [512, -1, 256]);  getitem_407 = None
        view_967 = torch.ops.aten.view.default(view_966, [100352, 256]);  view_966 = None
        ...
        empty_285 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_286 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_287 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_972 = torch.ops.aten.view.default(getitem_406, [512, -1, 256])
        view_973 = torch.ops.aten.view.default(view_972, [100352, 256]);  view_972 = None
        ...
        view_979 = torch.ops.aten.view.default(convolution_32, [512, 256, 196]);  convolution_32 = None
        ...
        empty_290 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_291 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_292 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_985 = torch.ops.aten.view.default(getitem_415, [512, -1, 256]);  getitem_415 = None
        view_986 = torch.ops.aten.view.default(view_985, [100352, 256]);  view_985 = None
        ...
        view_992 = torch.ops.aten.view.default(getitem_414, [512, 256, 14, 14]);  getitem_414 = None
        ...
        view_997 = torch.ops.aten.view.default(getitem_420, [512, -1, 256]);  getitem_420 = None
        view_998 = torch.ops.aten.view.default(view_997, [100352, 256]);  view_997 = None
        ...
        empty_294 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_295 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_296 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1003 = torch.ops.aten.view.default(getitem_419, [512, -1, 256])
        view_1004 = torch.ops.aten.view.default(view_1003, [100352, 256]);  view_1003 = None
        ...
        view_1010 = torch.ops.aten.view.default(convolution_33, [512, 1024, 196]);  convolution_33 = None
        ...
        empty_299 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_300 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_301 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1016 = torch.ops.aten.view.default(getitem_428, [512, -1, 256]);  getitem_428 = None
        view_1017 = torch.ops.aten.view.default(view_1016, [401408, 256]);  view_1016 = None
        ...
        view_1023 = torch.ops.aten.view.default(getitem_427, [512, 1024, 14, 14]);  getitem_427 = None
        add_145 = torch.ops.aten.add.Tensor(view_1023, getitem_393);  view_1023 = getitem_393 = None
        ...
        view_1028 = torch.ops.aten.view.default(getitem_433, [512, -1, 256]);  getitem_433 = None
        view_1029 = torch.ops.aten.view.default(view_1028, [401408, 256]);  view_1028 = None
        ...
        empty_303 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_304 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_305 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1034 = torch.ops.aten.view.default(getitem_432, [512, -1, 256])
        view_1035 = torch.ops.aten.view.default(view_1034, [401408, 256]);  view_1034 = None
        ...
        view_1041 = torch.ops.aten.view.default(convolution_34, [512, 256, 196]);  convolution_34 = None
        ...
        empty_308 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_309 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_310 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1047 = torch.ops.aten.view.default(getitem_441, [512, -1, 256]);  getitem_441 = None
        view_1048 = torch.ops.aten.view.default(view_1047, [100352, 256]);  view_1047 = None
        ...
        view_1054 = torch.ops.aten.view.default(getitem_440, [512, 256, 14, 14]);  getitem_440 = None
        ...
        view_1059 = torch.ops.aten.view.default(getitem_446, [512, -1, 256]);  getitem_446 = None
        view_1060 = torch.ops.aten.view.default(view_1059, [100352, 256]);  view_1059 = None
        ...
        empty_312 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_313 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_314 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1065 = torch.ops.aten.view.default(getitem_445, [512, -1, 256])
        view_1066 = torch.ops.aten.view.default(view_1065, [100352, 256]);  view_1065 = None
        ...
        view_1072 = torch.ops.aten.view.default(convolution_35, [512, 256, 196]);  convolution_35 = None
        ...
        empty_317 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_318 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_319 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1078 = torch.ops.aten.view.default(getitem_454, [512, -1, 256]);  getitem_454 = None
        view_1079 = torch.ops.aten.view.default(view_1078, [100352, 256]);  view_1078 = None
        ...
        view_1085 = torch.ops.aten.view.default(getitem_453, [512, 256, 14, 14]);  getitem_453 = None
        ...
        view_1090 = torch.ops.aten.view.default(getitem_459, [512, -1, 256]);  getitem_459 = None
        view_1091 = torch.ops.aten.view.default(view_1090, [100352, 256]);  view_1090 = None
        ...
        empty_321 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_322 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_323 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1096 = torch.ops.aten.view.default(getitem_458, [512, -1, 256])
        view_1097 = torch.ops.aten.view.default(view_1096, [100352, 256]);  view_1096 = None
        ...
        view_1103 = torch.ops.aten.view.default(convolution_36, [512, 1024, 196]);  convolution_36 = None
        ...
        empty_326 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_327 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_328 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1109 = torch.ops.aten.view.default(getitem_467, [512, -1, 256]);  getitem_467 = None
        view_1110 = torch.ops.aten.view.default(view_1109, [401408, 256]);  view_1109 = None
        ...
        view_1116 = torch.ops.aten.view.default(getitem_466, [512, 1024, 14, 14]);  getitem_466 = None
        add_158 = torch.ops.aten.add.Tensor(view_1116, getitem_432);  view_1116 = getitem_432 = None
        ...
        view_1121 = torch.ops.aten.view.default(getitem_472, [512, -1, 256]);  getitem_472 = None
        view_1122 = torch.ops.aten.view.default(view_1121, [401408, 256]);  view_1121 = None
        ...
        empty_330 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_331 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_332 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1127 = torch.ops.aten.view.default(getitem_471, [512, -1, 256])
        view_1128 = torch.ops.aten.view.default(view_1127, [401408, 256]);  view_1127 = None
        ...
        view_1134 = torch.ops.aten.view.default(convolution_37, [512, 256, 196]);  convolution_37 = None
        ...
        empty_335 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_336 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_337 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1140 = torch.ops.aten.view.default(getitem_480, [512, -1, 256]);  getitem_480 = None
        view_1141 = torch.ops.aten.view.default(view_1140, [100352, 256]);  view_1140 = None
        ...
        view_1147 = torch.ops.aten.view.default(getitem_479, [512, 256, 14, 14]);  getitem_479 = None
        ...
        view_1152 = torch.ops.aten.view.default(getitem_485, [512, -1, 256]);  getitem_485 = None
        view_1153 = torch.ops.aten.view.default(view_1152, [100352, 256]);  view_1152 = None
        ...
        empty_339 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_340 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_341 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1158 = torch.ops.aten.view.default(getitem_484, [512, -1, 256])
        view_1159 = torch.ops.aten.view.default(view_1158, [100352, 256]);  view_1158 = None
        ...
        view_1165 = torch.ops.aten.view.default(convolution_38, [512, 256, 196]);  convolution_38 = None
        ...
        empty_344 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_345 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_346 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1171 = torch.ops.aten.view.default(getitem_493, [512, -1, 256]);  getitem_493 = None
        view_1172 = torch.ops.aten.view.default(view_1171, [100352, 256]);  view_1171 = None
        ...
        view_1178 = torch.ops.aten.view.default(getitem_492, [512, 256, 14, 14]);  getitem_492 = None
        ...
        view_1183 = torch.ops.aten.view.default(getitem_498, [512, -1, 256]);  getitem_498 = None
        view_1184 = torch.ops.aten.view.default(view_1183, [100352, 256]);  view_1183 = None
        ...
        empty_348 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_349 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_350 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1189 = torch.ops.aten.view.default(getitem_497, [512, -1, 256])
        view_1190 = torch.ops.aten.view.default(view_1189, [100352, 256]);  view_1189 = None
        ...
        view_1196 = torch.ops.aten.view.default(convolution_39, [512, 1024, 196]);  convolution_39 = None
        ...
        empty_353 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_354 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_355 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1202 = torch.ops.aten.view.default(getitem_506, [512, -1, 256]);  getitem_506 = None
        view_1203 = torch.ops.aten.view.default(view_1202, [401408, 256]);  view_1202 = None
        ...
        view_1209 = torch.ops.aten.view.default(getitem_505, [512, 1024, 14, 14]);  getitem_505 = None
        add_171 = torch.ops.aten.add.Tensor(view_1209, getitem_471);  view_1209 = getitem_471 = None
        ...
        view_1214 = torch.ops.aten.view.default(getitem_511, [512, -1, 256]);  getitem_511 = None
        view_1215 = torch.ops.aten.view.default(view_1214, [401408, 256]);  view_1214 = None
        ...
        empty_357 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_358 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_359 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1220 = torch.ops.aten.view.default(getitem_510, [512, -1, 256])
        view_1221 = torch.ops.aten.view.default(view_1220, [401408, 256]);  view_1220 = None
        ...
        view_1227 = torch.ops.aten.view.default(convolution_40, [512, 256, 196]);  convolution_40 = None
        ...
        empty_362 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_363 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_364 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1233 = torch.ops.aten.view.default(getitem_519, [512, -1, 256]);  getitem_519 = None
        view_1234 = torch.ops.aten.view.default(view_1233, [100352, 256]);  view_1233 = None
        ...
        view_1240 = torch.ops.aten.view.default(getitem_518, [512, 256, 14, 14]);  getitem_518 = None
        ...
        view_1245 = torch.ops.aten.view.default(getitem_524, [512, -1, 256]);  getitem_524 = None
        view_1246 = torch.ops.aten.view.default(view_1245, [100352, 256]);  view_1245 = None
        ...
        empty_366 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_367 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_368 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1251 = torch.ops.aten.view.default(getitem_523, [512, -1, 256])
        view_1252 = torch.ops.aten.view.default(view_1251, [100352, 256]);  view_1251 = None
        ...
        view_1258 = torch.ops.aten.view.default(convolution_41, [512, 256, 196]);  convolution_41 = None
        ...
        empty_371 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_372 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_373 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1264 = torch.ops.aten.view.default(getitem_532, [512, -1, 256]);  getitem_532 = None
        view_1265 = torch.ops.aten.view.default(view_1264, [100352, 256]);  view_1264 = None
        ...
        view_1271 = torch.ops.aten.view.default(getitem_531, [512, 256, 14, 14]);  getitem_531 = None
        ...
        view_1276 = torch.ops.aten.view.default(getitem_537, [512, -1, 256]);  getitem_537 = None
        view_1277 = torch.ops.aten.view.default(view_1276, [100352, 256]);  view_1276 = None
        ...
        empty_375 = torch.ops.aten.empty.memory_format([100352, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_376 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_377 = torch.ops.aten.empty.memory_format([100352], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1282 = torch.ops.aten.view.default(getitem_536, [512, -1, 256])
        view_1283 = torch.ops.aten.view.default(view_1282, [100352, 256]);  view_1282 = None
        ...
        view_1289 = torch.ops.aten.view.default(convolution_42, [512, 1024, 196]);  convolution_42 = None
        ...
        empty_380 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_381 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_382 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1295 = torch.ops.aten.view.default(getitem_545, [512, -1, 256]);  getitem_545 = None
        view_1296 = torch.ops.aten.view.default(view_1295, [401408, 256]);  view_1295 = None
        ...
        view_1302 = torch.ops.aten.view.default(getitem_544, [512, 1024, 14, 14]);  getitem_544 = None
        add_184 = torch.ops.aten.add.Tensor(view_1302, getitem_510);  view_1302 = getitem_510 = None
        ...
        view_1307 = torch.ops.aten.view.default(getitem_550, [512, -1, 256]);  getitem_550 = None
        view_1308 = torch.ops.aten.view.default(view_1307, [401408, 256]);  view_1307 = None
        ...
        empty_384 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_385 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_386 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1313 = torch.ops.aten.view.default(getitem_549, [512, -1, 256])
        view_1314 = torch.ops.aten.view.default(view_1313, [401408, 256]);  view_1313 = None
        ...
        view_1320 = torch.ops.aten.view.default(convolution_43, [512, 512, 196]);  convolution_43 = None
        ...
        empty_389 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_390 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_391 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1326 = torch.ops.aten.view.default(getitem_558, [512, -1, 256]);  getitem_558 = None
        view_1327 = torch.ops.aten.view.default(view_1326, [200704, 256]);  view_1326 = None
        ...
        view_1333 = torch.ops.aten.view.default(getitem_557, [512, 512, 14, 14]);  getitem_557 = None
        ...
        view_1338 = torch.ops.aten.view.default(getitem_563, [512, -1, 256]);  getitem_563 = None
        view_1339 = torch.ops.aten.view.default(view_1338, [200704, 256]);  view_1338 = None
        ...
        empty_393 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_394 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_395 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1344 = torch.ops.aten.view.default(getitem_562, [512, -1, 256])
        view_1345 = torch.ops.aten.view.default(view_1344, [200704, 256]);  view_1344 = None
        ...
        view_1351 = torch.ops.aten.view.default(convolution_44, [512, 512, 49]);  convolution_44 = None
        ...
        empty_398 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_399 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_400 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1357 = torch.ops.aten.view.default(getitem_571, [512, -1, 256]);  getitem_571 = None
        view_1358 = torch.ops.aten.view.default(view_1357, [50176, 256]);  view_1357 = None
        ...
        view_1364 = torch.ops.aten.view.default(getitem_570, [512, 512, 7, 7]);  getitem_570 = None
        ...
        full_default_263 = torch.ops.aten.full.default([50176, 8], 0, dtype = torch.int32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        view_1369 = torch.ops.aten.view.default(getitem_576, [512, -1, 256]);  getitem_576 = None
        view_1370 = torch.ops.aten.view.default(view_1369, [50176, 256]);  view_1369 = None
        ...
        empty_402 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_403 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_404 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1375 = torch.ops.aten.view.default(getitem_575, [512, -1, 256])
        view_1376 = torch.ops.aten.view.default(view_1375, [50176, 256]);  view_1375 = None
        ...
        view_1382 = torch.ops.aten.view.default(convolution_45, [512, 2048, 49]);  convolution_45 = None
        ...
        empty_407 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_408 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_409 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1388 = torch.ops.aten.view.default(getitem_584, [512, -1, 256]);  getitem_584 = None
        view_1389 = torch.ops.aten.view.default(view_1388, [200704, 256]);  view_1388 = None
        ...
        empty_410 = torch.ops.aten.empty.memory_format([401408, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_411 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_412 = torch.ops.aten.empty.memory_format([401408], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1406 = torch.ops.aten.view.default(convolution_46, [512, 2048, 49]);  convolution_46 = None
        ...
        empty_415 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_416 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_417 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1412 = torch.ops.aten.view.default(getitem_594, [512, -1, 256]);  getitem_594 = None
        view_1413 = torch.ops.aten.view.default(view_1412, [200704, 256]);  view_1412 = None
        ...
        view_1419 = torch.ops.aten.view.default(getitem_583, [512, 2048, 7, 7]);  getitem_583 = None
        view_1420 = torch.ops.aten.view.default(getitem_593, [512, 2048, 7, 7]);  getitem_593 = None
        add_201 = torch.ops.aten.add.Tensor(view_1419, view_1420);  view_1419 = view_1420 = None
        ...
        view_1425 = torch.ops.aten.view.default(getitem_599, [512, -1, 256]);  getitem_599 = None
        view_1426 = torch.ops.aten.view.default(view_1425, [200704, 256]);  view_1425 = None
        ...
        empty_419 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_420 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_421 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1431 = torch.ops.aten.view.default(getitem_598, [512, -1, 256])
        view_1432 = torch.ops.aten.view.default(view_1431, [200704, 256]);  view_1431 = None
        ...
        view_1438 = torch.ops.aten.view.default(convolution_47, [512, 512, 49]);  convolution_47 = None
        ...
        empty_424 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_425 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_426 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1444 = torch.ops.aten.view.default(getitem_607, [512, -1, 256]);  getitem_607 = None
        view_1445 = torch.ops.aten.view.default(view_1444, [50176, 256]);  view_1444 = None
        ...
        view_1451 = torch.ops.aten.view.default(getitem_606, [512, 512, 7, 7]);  getitem_606 = None
        ...
        view_1456 = torch.ops.aten.view.default(getitem_612, [512, -1, 256]);  getitem_612 = None
        view_1457 = torch.ops.aten.view.default(view_1456, [50176, 256]);  view_1456 = None
        ...
        empty_428 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_429 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_430 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1462 = torch.ops.aten.view.default(getitem_611, [512, -1, 256])
        view_1463 = torch.ops.aten.view.default(view_1462, [50176, 256]);  view_1462 = None
        ...
        view_1469 = torch.ops.aten.view.default(convolution_48, [512, 512, 49]);  convolution_48 = None
        ...
        empty_433 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_434 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_435 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1475 = torch.ops.aten.view.default(getitem_620, [512, -1, 256]);  getitem_620 = None
        view_1476 = torch.ops.aten.view.default(view_1475, [50176, 256]);  view_1475 = None
        ...
        view_1482 = torch.ops.aten.view.default(getitem_619, [512, 512, 7, 7]);  getitem_619 = None
        ...
        view_1487 = torch.ops.aten.view.default(getitem_625, [512, -1, 256]);  getitem_625 = None
        view_1488 = torch.ops.aten.view.default(view_1487, [50176, 256]);  view_1487 = None
        ...
        empty_437 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_438 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_439 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1493 = torch.ops.aten.view.default(getitem_624, [512, -1, 256])
        view_1494 = torch.ops.aten.view.default(view_1493, [50176, 256]);  view_1493 = None
        ...
        view_1500 = torch.ops.aten.view.default(convolution_49, [512, 2048, 49]);  convolution_49 = None
        ...
        empty_442 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_443 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_444 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1506 = torch.ops.aten.view.default(getitem_633, [512, -1, 256]);  getitem_633 = None
        view_1507 = torch.ops.aten.view.default(view_1506, [200704, 256]);  view_1506 = None
        ...
        view_1513 = torch.ops.aten.view.default(getitem_632, [512, 2048, 7, 7]);  getitem_632 = None
        add_214 = torch.ops.aten.add.Tensor(view_1513, getitem_598);  view_1513 = getitem_598 = None
        ...
        view_1518 = torch.ops.aten.view.default(getitem_638, [512, -1, 256]);  getitem_638 = None
        view_1519 = torch.ops.aten.view.default(view_1518, [200704, 256]);  view_1518 = None
        ...
        empty_446 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_447 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_448 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1524 = torch.ops.aten.view.default(getitem_637, [512, -1, 256])
        view_1525 = torch.ops.aten.view.default(view_1524, [200704, 256]);  view_1524 = None
        ...
        view_1531 = torch.ops.aten.view.default(convolution_50, [512, 512, 49]);  convolution_50 = None
        ...
        empty_451 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_452 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_453 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1537 = torch.ops.aten.view.default(getitem_646, [512, -1, 256]);  getitem_646 = None
        view_1538 = torch.ops.aten.view.default(view_1537, [50176, 256]);  view_1537 = None
        ...
        view_1544 = torch.ops.aten.view.default(getitem_645, [512, 512, 7, 7]);  getitem_645 = None
        ...
        view_1549 = torch.ops.aten.view.default(getitem_651, [512, -1, 256]);  getitem_651 = None
        view_1550 = torch.ops.aten.view.default(view_1549, [50176, 256]);  view_1549 = None
        ...
        empty_455 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_456 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_457 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1555 = torch.ops.aten.view.default(getitem_650, [512, -1, 256])
        view_1556 = torch.ops.aten.view.default(view_1555, [50176, 256]);  view_1555 = None
        ...
        view_1562 = torch.ops.aten.view.default(convolution_51, [512, 512, 49]);  convolution_51 = None
        ...
        empty_460 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_461 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_462 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1568 = torch.ops.aten.view.default(getitem_659, [512, -1, 256]);  getitem_659 = None
        view_1569 = torch.ops.aten.view.default(view_1568, [50176, 256]);  view_1568 = None
        ...
        view_1575 = torch.ops.aten.view.default(getitem_658, [512, 512, 7, 7]);  getitem_658 = None
        ...
        view_1580 = torch.ops.aten.view.default(getitem_664, [512, -1, 256]);  getitem_664 = None
        view_1581 = torch.ops.aten.view.default(view_1580, [50176, 256]);  view_1580 = None
        ...
        empty_464 = torch.ops.aten.empty.memory_format([50176, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_465 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_466 = torch.ops.aten.empty.memory_format([50176], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1586 = torch.ops.aten.view.default(getitem_663, [512, -1, 256])
        view_1587 = torch.ops.aten.view.default(view_1586, [50176, 256]);  view_1586 = None
        ...
        view_1593 = torch.ops.aten.view.default(convolution_52, [512, 2048, 49]);  convolution_52 = None
        ...
        empty_469 = torch.ops.aten.empty.memory_format([200704, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_470 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_471 = torch.ops.aten.empty.memory_format([200704], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        view_1599 = torch.ops.aten.view.default(getitem_672, [512, -1, 256]);  getitem_672 = None
        view_1600 = torch.ops.aten.view.default(view_1599, [200704, 256]);  view_1599 = None
        ...
        view_1606 = torch.ops.aten.view.default(getitem_671, [512, 2048, 7, 7]);  getitem_671 = None
        add_227 = torch.ops.aten.add.Tensor(view_1606, getitem_637);  view_1606 = getitem_637 = None
        ...
        view_1611 = torch.ops.aten.view.default(getitem_677, [512, -1, 256]);  getitem_677 = None
        view_1612 = torch.ops.aten.view.default(view_1611, [200704, 256]);  view_1611 = None
        ...
        view_1613 = torch.ops.aten.view.default(mean, [512, 2048]);  mean = None
        view_1616 = torch.ops.aten.view.default(view_1613, [512, -1, 256])
        view_1617 = torch.ops.aten.view.default(view_1616, [4096, 256]);  view_1616 = None
        empty_473 = torch.ops.aten.empty.memory_format([4096, 16], dtype = torch.int32, device = device(type='cuda', index=0), pin_memory = False)
        empty_474 = torch.ops.aten.empty.memory_format([4096], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        empty_475 = torch.ops.aten.empty.memory_format([4096], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        mm = torch.ops.aten.mm.default(view_1613, permute_155);  view_1613 = permute_155 = None
